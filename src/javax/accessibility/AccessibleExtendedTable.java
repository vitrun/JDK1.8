...
public interface AccessibleExtendedTable extends AccessibleTable {
   ...
   *
   * @param index the zero-based index in the table.  The index is the table cell offset from row ==
   * 0 and column == 0.
   ...
   * @return the zero-based index in the table if one exists; otherwise -1.  The index is  the table
