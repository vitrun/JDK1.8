...
public interface AccessibleStreamable {
   ...
   *
   * @return an array of DataFlavor objects for the MIME types this object supports.
   */
   ...
   * @return an ImputStream if an ImputStream for this DataFlavor exists. Otherwise, null is
   * returned.
   */
