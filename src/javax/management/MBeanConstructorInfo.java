...
public class MBeanConstructorInfo extends MBeanFeatureInfo implements Cloneable {
   ...
   * of the constructor.  This may be null with the same effect as a zero-length array.
   ...
   * of the constructor.  This may be null with the same effect as a zero-length array.
   * @param description A human readable description of the constructor.
   * @param descriptor The descriptor for the constructor.  This may be null which is equivalent to
   * an empty descriptor.
   * @since 1.6
   */
  public MBeanConstructorInfo(String name,
   ...
   * @return true if and only if <code>o</code> is an MBeanConstructorInfo such that its {@link
   * #getName()}, {@link #getDescription()}, {@link #getSignature()}, and {@link #getDescriptor()}
   * values are equal (not necessarily identical) to those of this MBeanConstructorInfo.  Two
