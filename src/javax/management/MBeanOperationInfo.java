...
public class MBeanOperationInfo extends MBeanFeatureInfo implements Cloneable {
  ...
  /**
   * @serial The impact of the method, one of <CODE>INFO</CODE>, <CODE>ACTION</CODE>,
   * <CODE>ACTION_INFO</CODE>, <CODE>UNKNOWN</CODE>
   */
   ...
   * @param description A human readable description of the operation.
   * @param signature <CODE>MBeanParameterInfo</CODE> objects describing the parameters(arguments)
   * of the method.  This may be null with the same effect as a zero-length array.
   * @param type The type of the method's return value.
   * @param impact The impact of the method, one of {@link #INFO}, {@link #ACTION}, {@link
   * #ACTION_INFO}, {@link #UNKNOWN}.
   */
   ...
   * @return true if and only if <code>o</code> is an MBeanOperationInfo such that its {@link
   * #getName()}, {@link #getReturnType()}, {@link #getDescription()}, {@link #getImpact()}, {@link
   * #getDescriptor()} and {@link #getSignature()} values are equal (not necessarily identical) to
   * those of this MBeanConstructorInfo.  Two signature arrays are equal if their elements are
   * pairwise equal.
   */
  @Override
