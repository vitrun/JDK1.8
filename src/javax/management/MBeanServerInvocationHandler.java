...
public class MBeanServerInvocationHandler implements InvocationHandler {
   ...
   * objectName, false)}.</p>
   *
   * @param connection the MBean server connection through which all methods of a proxy using this
   * handler will be forwarded.
   * @param objectName the name of the MBean within the MBean server to which methods will be
   * forwarded.
   */
   ...
   * @param objectName the name of the MBean within the MBean server to which methods will be
   * forwarded.
   * @param isMXBean if true, the proxy is for an {@link MXBean}, and appropriate mappings will be
   * applied to method parameters and return values.
   * @since 1.6
   */
  public MBeanServerInvocationHandler(MBeanServerConnection connection,
      ObjectName objectName,
