...
public class MBeanTrustPermission extends BasicPermission {
   ...
   *
   * @param name the name of the permission. It must be "register" or "*" for this permission.
   * @throws NullPointerException if <code>name</code> is <code>null</code>.
   * @throws IllegalArgumentException if <code>name</code> is neither "register" nor "*".
   */
   ...
   *
   * @param name the name of the permission. It must be "register" or "*" for this permission.
   * @param actions the actions for the permission.  It must be null or <code>""</code>.
   * @throws NullPointerException if <code>name</code> is <code>null</code>.
   * @throws IllegalArgumentException if <code>name</code> is neither "register" nor "*"; or if
