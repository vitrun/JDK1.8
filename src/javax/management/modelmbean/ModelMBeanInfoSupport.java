...
public class ModelMBeanInfoSupport extends MBeanInfo implements ModelMBeanInfo {
   ...
   * @serialField modelMBeanAttributes ModelMBeanAttributeInfo[] The array of {@link
   * ModelMBeanAttributeInfo} objects which have descriptors
   * @serialField modelMBeanConstructors MBeanConstructorInfo[] The array of {@link
   * ModelMBeanConstructorInfo} objects which have descriptors
   * @serialField modelMBeanNotifications MBeanNotificationInfo[] The array of {@link
   * ModelMBeanNotificationInfo} objects which have descriptors
   * @serialField modelMBeanOperations MBeanOperationInfo[] The array of {@link
   * ModelMBeanOperationInfo} objects which have descriptors
   */
  ...
  /**
   * @serial The array of {@link ModelMBeanAttributeInfo} objects which have descriptors
   */
  private MBeanAttributeInfo[] modelMBeanAttributes;

  /**
   * @serial The array of {@link ModelMBeanConstructorInfo} objects which have descriptors
   */
  private MBeanConstructorInfo[] modelMBeanConstructors;

  /**
   * @serial The array of {@link ModelMBeanNotificationInfo} objects which have descriptors
   */
  private MBeanNotificationInfo[] modelMBeanNotifications;

  /**
   * @serial The array of {@link ModelMBeanOperationInfo} objects which have descriptors
   */
   ...
   *
   * @param mbi the ModelMBeanInfo instance from which the ModelMBeanInfo being created is
   * initialized.
   */
   ...
   * @param description human readable description of the ModelMBean
   * @param attributes array of ModelMBeanAttributeInfo objects which have descriptors
   * @param constructors array of ModelMBeanConstructorInfo objects which have descriptors
   * @param operations array of ModelMBeanOperationInfo objects which have descriptors
   * @param notifications array of ModelMBeanNotificationInfo objects which have descriptors
   */
   ...
   * @param description human readable description of the ModelMBean
   * @param attributes array of ModelMBeanAttributeInfo objects which have descriptors
   * @param constructors array of ModelMBeanConstructorInfo objects which have descriptor
   * @param operations array of ModelMBeanOperationInfo objects which have descriptor
   * @param notifications array of ModelMBeanNotificationInfo objects which have descriptor
   * @param mbeandescriptor descriptor to be used as the MBeanDescriptor containing MBean wide
   * policy. If the descriptor is null, a default descriptor will be constructed. The default
   * descriptor is: name=className, descriptorType="mbean", displayName=className,
   * persistPolicy="never", log="F", visibility="1".  If the descriptor does not contain all of
   * these fields, the missing ones are added with these default values.
   * @throws RuntimeOperationsException Wraps an IllegalArgumentException for invalid descriptor
   * passed in parameter.  (see {@link #getMBeanDescriptor getMBeanDescriptor} for the definition of
   * a valid MBean descriptor.)
   */
   ...
   * @return Descriptor containing a descriptor for the ModelMBean with the same name. If no
   * descriptor is found, null is returned.
   * @throws MBeanException Wraps a distributed communication Exception.
   * @throws RuntimeOperationsException Wraps an IllegalArgumentException for null name.
   * @see #setDescriptor
   */
   ...
   * @return the constructor info for the named constructor, or null if there is none.
   * @throws MBeanException Wraps a distributed communication Exception.
   * @throws RuntimeOperationsException Wraps an IllegalArgumentException for a null constructor
   * name.
   */
   ...
   *
   * @param in Descriptor to be checked, or null which is equivalent to an empty Descriptor.
