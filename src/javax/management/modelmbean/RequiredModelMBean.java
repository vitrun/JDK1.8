...
public class RequiredModelMBean
   ...
   * @throws RuntimeOperationsException Wraps a {@link RuntimeException} during the construction of
   * the object.
   **/
   ...
   * MBeanServer.
   *
   * @param mbi The ModelMBeanInfo object to be used by the RequiredModelMBean. The given
   * ModelMBeanInfo is cloned and modified as specified by {@link #setModelMBeanInfo}
   * @throws MBeanException Wraps a distributed communication Exception.
   * @throws RuntimeOperationsException Wraps an {link java.lang.IllegalArgumentException}: The
   ...
   *
   * @param mbi The ModelMBeanInfo object to be used by the ModelMBean.
   * @throws MBeanException Wraps a distributed communication Exception.
   * @throws RuntimeOperationsException <ul><li>Wraps an {@link IllegalArgumentException} if the
   * MBeanInfo passed in parameter is null.</li> <li>Wraps an {@link IllegalStateException} if the
   * ModelMBean is currently registered in the MBeanServer.</li> </ul>
   **/
   ...
   * @param mr_type The type of reference for the managed resource. <br>Can be: "ObjectReference",
   * "Handle", "IOR", "EJBHandle", or "RMIReference". <br>In this implementation only
   * "ObjectReference" is supported.
   ...
   * @throws InvalidTargetObjectTypeException The managed resource type should be
   * "ObjectReference".
   * @throws RuntimeOperationsException Wraps a {@link RuntimeException} when setting the resource.
   **/
   ...
   * @throws InstanceNotFoundException Could not find or load this MBean from persistent storage
   */
  public void load()
      throws MBeanException, RuntimeOperationsException,
   ...
   *
   * @return An instance of ModelMBeanInfo allowing retrieval all attributes, operations, and
   * Notifications of this MBean.
   **/
   ...
   *
   * @param opName The name of the method to be invoked. The name can be the fully qualified method
   * name including the classname, or just the method name if the classname is defined in the
   * 'class' field of the operation descriptor.
   * @param opArgs An array containing the parameters to be set when the operation is invoked
   * @param sig An array containing the signature of the operation. The class objects will be loaded
   * using the same class loader as the one used for loading the MBean on which the operation was
   * invoked.
   * @return The object returned by the method, which represents the result of invoking the method
   * on the specified managed resource.
   * @throws MBeanException Wraps one of the following Exceptions: <UL> <LI> An Exception thrown by
   * the managed object's invoked method.</LI> <LI> {@link ServiceNotFoundException}: No
   * ModelMBeanOperationInfo or no descriptor defined for the specified operation or the managed
   * resource is null.</LI> <LI> {@link InvalidTargetObjectTypeException}: The 'targetType' field
   * value is not 'objectReference'.</LI> </UL>
   * @throws ReflectionException Wraps an {@link java.lang.Exception} thrown while trying to invoke
   * the method.
   * @throws RuntimeOperationsException Wraps an {@link IllegalArgumentException} Method name is
   * null.
   **/
    /*
   ...
   *
   * @param attrName A String specifying the name of the attribute to be retrieved. It must match
   * the name of a ModelMBeanAttributeInfo.
   * @return The value of the retrieved attribute from the descriptor 'value' field or from the
   * invocation of the operation in the 'getMethod' field of the descriptor.
   * @throws AttributeNotFoundException The specified attribute is not accessible in the MBean. The
   * following cases may result in an AttributeNotFoundException: <UL> <LI> No ModelMBeanInfo was
   * found for the Model MBean.</LI> <LI> No ModelMBeanAttributeInfo was found for the specified
   * attribute name.</LI> <LI> The ModelMBeanAttributeInfo isReadable method returns 'false'.</LI>
   * </UL>
   * @throws MBeanException Wraps one of the following Exceptions: <UL> <LI> {@link
   * InvalidAttributeValueException}: A wrong value type was received from the attribute's getter
   * method or no 'getMethod' field defined in the descriptor for the attribute and no default value
   * exists.</LI> <LI> {@link ServiceNotFoundException}: No ModelMBeanOperationInfo defined for the
   * attribute's getter method or no descriptor associated with the ModelMBeanOperationInfo or the
   * managed resource is null.</LI> <LI> {@link InvalidTargetObjectTypeException} The 'targetType'
   * field value is not 'objectReference'.</LI> <LI> An Exception thrown by the managed object's
   * getter.</LI> </UL>
   * @throws ReflectionException Wraps an {@link java.lang.Exception} thrown while trying to invoke
   * the getter.
   * @throws RuntimeOperationsException Wraps an {@link IllegalArgumentException}: The attribute
   ...
   *
   * @param attrNames A String array of names of the attributes to be retrieved.
   * @return The array of the retrieved attributes.
   * @throws RuntimeOperationsException Wraps an {@link IllegalArgumentException}: The object name
   ...
   *
   * @param attribute The Attribute instance containing the name of the attribute to be set and the
   * value it is to be set to.
   * @throws AttributeNotFoundException The specified attribute is not accessible in the MBean.
   * <br>The following cases may result in an AttributeNotFoundException: <UL> <LI> No
   * ModelMBeanAttributeInfo is found for the specified attribute.</LI> <LI> The
   * ModelMBeanAttributeInfo's isWritable method returns 'false'.</LI> </UL>
   * @throws InvalidAttributeValueException No descriptor is defined for the specified attribute.
   * @throws MBeanException Wraps one of the following Exceptions: <UL> <LI> An Exception thrown by
   * the managed object's setter.</LI> <LI> A {@link ServiceNotFoundException} if a setMethod field
   * is defined in the descriptor for the attribute and the managed resource is null; or if no
   * setMethod field is defined and caching is not enabled for the attribute. Note that if there is
   * no getMethod field either, then caching is automatically enabled.</LI> <LI> {@link
   * InvalidTargetObjectTypeException} The 'targetType' field value is not 'objectReference'.</LI>
   * <LI> An Exception thrown by the managed object's getter.</LI> </UL>
   * @throws ReflectionException Wraps an {@link java.lang.Exception} thrown while trying to invoke
   * the setter.
   * @throws RuntimeOperationsException Wraps an {@link IllegalArgumentException}: The attribute in
   * parameter is null.
   ...
   * @return The array of attributes that were set, with their new values in Attribute instances.
   * @throws RuntimeOperationsException Wraps an {@link IllegalArgumentException}: The object name
   * in parameter is null or attributes in parameter is null.
   * @see #getAttributes
   **/
   ...
   * for independently.
   *
   * @param listener The listener object which will handles notifications emitted by the registered
   * MBean.
   * @param filter The filter object. If null, no filtering will be performed before handling
   * notifications.
   * @param handback The context to be sent to the listener with the notification when a
   ...
   *
   * @param listener The listener name which was handling notifications emitted by the registered
  ...
  /**
   * Returns the array of Notifications always generated by the RequiredModelMBean. <P>
   *
   * RequiredModelMBean may always send also two additional notifications: <UL> <LI> One with
   * descriptor <code>"name=GENERIC,descriptorType=notification,log=T,severity=6,displayName=jmx.modelmbean.generic"</code></LI>
   * <LI> Second is a standard attribute change notification with descriptor
   * <code>"name=ATTRIBUTE_CHANGE,descriptorType=notification,log=T,severity=6,displayName=jmx.attribute.change"</code></LI>
   * </UL> Thus these two notifications are always added to those specified by the application.
   *
   ...
   * returned value.
   * @throws java.lang.Exception This exception will be caught by the MBean server and re-thrown as
   * an {@link javax.management.MBeanRegistrationException MBeanRegistrationException}.
   */
