...
public interface DescriptorAccess extends DescriptorRead {
   ...
   *
   * @param inDescriptor replaces the Descriptor associated with the component implementing this
   * interface. If the inDescriptor is invalid for the type of Info object it is being set for, an
   * exception is thrown.  If the inDescriptor is null, then the Descriptor will revert to its
