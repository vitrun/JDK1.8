...
public interface MBeanServer extends MBeanServerConnection {
   ...
   * class name of the newly registered MBean.  If the contained <code>ObjectName</code> is
   ...
   * @throws RuntimeMBeanException If the <CODE>postRegister</CODE> (<CODE>MBeanRegistration</CODE>
   * interface) method of the MBean throws a <CODE>RuntimeException</CODE>, the
   * <CODE>registerMBean</CODE> method will throw a <CODE>RuntimeMBeanException</CODE>, although the
   * MBean registration succeeded. In such a case, the MBean will be actually registered even though
   * the <CODE>registerMBean</CODE> method threw an exception.  Note that
   * <CODE>RuntimeMBeanException</CODE> can also be thrown by <CODE>preRegister</CODE>, in which
   ...
   * interface) method of the MBean throws an <CODE>Error</CODE>, the <CODE>registerMBean</CODE>
   * method will throw a <CODE>RuntimeErrorException</CODE>, although the MBean registration
   * succeeded. In such a case, the MBean will be actually registered even though the
   ...
   *
   * @return the number of registered MBeans, wrapped in an Integer. If the caller's permissions are
   * restricted, this number may be greater than the number of MBeans the caller can access.
   */
   ...
   * @deprecated Use {@link #getClassLoaderFor getClassLoaderFor} to obtain the appropriate class
   ...
   * @return The de-serialized object stream.
   * @throws OperationsException Any of the usual Input/Output related exceptions.
   * @throws ReflectionException The specified class could not be loaded by the class loader
   * repository
   * @deprecated Use {@link #getClassLoaderRepository} to obtain the class loader repository and use
   * it to deserialize.
   */
  @Deprecated
   ...
   * loader.
   * @deprecated Use {@link #getClassLoader getClassLoader} to obtain the class loader for
   * deserialization.
   */
  @Deprecated
   ...
   * ClassLoader, and <var>r</var> is the returned value, then either:
   *
   * <ul> <li><var>r</var> is identical to <var>l</var>; or <li>the result of <var>r</var>{@link
   * ClassLoader#loadClass(String) .loadClass(<var>s</var>)} is the same as <var>l</var>{@link
   * ClassLoader#loadClass(String) .loadClass(<var>s</var>)} for any string <var>s</var>. </ul>
   *
   * What this means is that the ClassLoader may be wrapped in another ClassLoader for security or
   * other reasons.
   ...
   *
   * @param loaderName The ObjectName of the ClassLoader.  May be null, in which case the MBean
   * server's own ClassLoader is returned.
   * @return The named ClassLoader.  If <var>l</var> is the actual ClassLoader with that name, and
