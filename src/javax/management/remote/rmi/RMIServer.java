...
public interface RMIServer extends Remote {
   ...
   * @throws RemoteException if there is a communication exception during the remote method call.
   */
   ...
   * server in order to authenticate the user before creating the <code>RMIConnection</code>.  Can
   * be null.
   * @return the newly-created connection object.
   * @throws IOException if the new client object cannot be created or exported, or if there is a
   * communication exception during the remote method call.
