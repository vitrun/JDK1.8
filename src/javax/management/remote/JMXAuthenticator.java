...
public interface JMXAuthenticator {
   ...
   *
   * @param credentials the user-defined credentials to be passed into the server in order to
   * authenticate the user before creating the <code>MBeanServerConnection</code>.  The actual type
   * of this parameter, and whether it can be null, depends on the connector.
