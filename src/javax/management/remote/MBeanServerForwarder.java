...
public interface MBeanServerForwarder extends MBeanServer {
   ...
   *
   * @return the MBeanServer object to which requests will be forwarded, or null if there is none.
   * @see #setMBeanServer
   */
   ...
   * @throws IllegalArgumentException if this object is already forwarding to an MBeanServer object
   * or if <code>mbs</code> is null or if <code>mbs</code> is identical to this object.
   * @see #getMBeanServer
   */
