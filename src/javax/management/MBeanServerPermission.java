...
public class MBeanServerPermission extends BasicPermission {
   ...
   *
   * @param name the name of the granted permission.  It must respect the constraints spelt out in
   * the description of the {@link MBeanServerPermission} class.
   * @throws NullPointerException if the name is null.
   * @throws IllegalArgumentException if the name is not <code>*</code> or one of the allowed names
   * or a comma-separated list of the allowed names.
   */
   ...
   * @param name the name of the granted permission.  It must respect the constraints spelt out in
   * the description of the {@link MBeanServerPermission} class.
   * @param actions the associated actions.  This parameter is not currently used and must be null
   * or the empty string.
   * @throws NullPointerException if the name is null.
   * @throws IllegalArgumentException if the name is not <code>*</code> or one of the allowed names
   * or a comma-separated list of the allowed names, or if <code>actions</code> is a non-null
   * non-empty string.
...
class MBeanServerPermissionCollection extends PermissionCollection {
  ...
  /**
   * @serial Null if no permissions in collection, otherwise a single permission that is the union
   * of all permissions that have been added.
   */
