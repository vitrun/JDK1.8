...
public class MBeanServerNotification extends Notification {
   ...
   * type.
   *
   * @param type A string denoting the type of the notification. Set it to one these values: {@link
   * #REGISTRATION_NOTIFICATION}, {@link #UNREGISTRATION_NOTIFICATION}.
   * @param source The MBeanServerNotification object responsible for forwarding MBean server
   * notification.
   * @param sequenceNumber A sequence number that can be used to order received notifications.
