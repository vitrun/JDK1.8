...
public interface ValueExp extends java.io.Serializable {
   ...
   * @deprecated This method is not needed because a <code>ValueExp</code> can access the MBean
   * server in which it is being evaluated by using {@link QueryEval#getMBeanServer()}.
   */
  @Deprecated
