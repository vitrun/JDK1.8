...
/**
 * Exception thrown by the monitor when a monitor setting becomes invalid while the monitor is
 * running. <P> As the monitor attributes may change at runtime, a check is performed before each
 * observation. If a monitor attribute has become invalid, a monitor setting exception is thrown.
 *
 * @since 1.5
 */
