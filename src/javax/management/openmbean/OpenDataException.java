...
/**
 * This checked exception is thrown when an <i>open type</i>, an <i>open data</i>  or an <i>open
 * MBean metadata info</i> instance could not be constructed because one or more validity
