...
public class OpenMBeanOperationInfoSupport
  ...
  /**
   * @serial The <i>open type</i> of the values returned by the operation described by this {@link
   ...
   * @param impact must be one of {@code ACTION}, {@code ACTION_INFO}, {@code INFO}, or {@code
   * UNKNOWN}.
   * @param descriptor The descriptor for the operation.  This may be null, which is equivalent to
   * an empty descriptor.
   * @throws IllegalArgumentException if {@code name} or {@code description} are null or empty
   * string, or {@code returnOpenType} is null, or {@code impact} is not one of {@code ACTION},
   * {@code ACTION_INFO}, {@code INFO}, or {@code UNKNOWN}.
   ...
   *
   * @return the hash code value for this {@code OpenMBeanOperationInfoSupport} instance
   */
  public int hashCode() {
   ...
   *
   * @return a string representation of this {@code OpenMBeanOperationInfoSupport} instance
   */
