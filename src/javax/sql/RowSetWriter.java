...
public interface RowSetWriter {
   ...
   * <code>RowSetInternal</code> interface, (2) with which this writer is registered, and (3) that
   * called this method internally
   * @return <code>true</code> if the modified data was written; <code>false</code> if not, which
   * will be the case if there is a conflict
