...
public interface RowSet extends ResultSet {
   ...
   *
   * @param name the logical name of the data source for this <code>RowSet</code> object; may be
   * <code>null</code>
   * @throws SQLException if a database access error occurs
   ...
   * <code>RowSet</code> object.
   *
   * @return the transaction isolation level; one of <code>Connection.TRANSACTION_READ_UNCOMMITTED</code>,
   ...
   *
   * @param level the transaction isolation level; one of <code>Connection.TRANSACTION_READ_UNCOMMITTED</code>,
   * <code>Connection.TRANSACTION_READ_COMMITTED</code>, <code>Connection.TRANSACTION_REPEATABLE_READ</code>,
   * or <code>Connection.TRANSACTION_SERIALIZABLE</code>
   * @throws SQLException if a database access error occurs
   ...
   *
   * @return a <code>java.util.Map</code> object containing the names of SQL user-defined types and
   * the Java classes to which they are to be mapped
   * @throws SQLException if a database access error occurs
   * @see #setTypeMap
   */
   ...
   *
   * @param map a <code>java.util.Map</code> object containing the names of SQL user-defined types
   * and the Java classes to which they are to be mapped
   * @throws SQLException if a database access error occurs
   * @see #getTypeMap
   */
   ...
   *
   * @param cmd the SQL query that will be used to get the data for this <code>RowSet</code> object;
   ...
   *
   * @return <code>true</code> if this <code>RowSet</code> object is read-only; <code>false</code>
   * if it is updatable
   * @see #setReadOnly
   */
  boolean isReadOnly();
   ...
   *
   * @param value <code>true</code> if read-only; <code>false</code> if updatable
   * @throws SQLException if a database access error occurs
   * @see #isReadOnly
   */
   ...
   *
   * @return the current maximum column size limit; zero means that there is no limit
   * @throws SQLException if a database access error occurs
   * @see #setMaxFieldSize
   */
   ...
   *
   * @return the current maximum number of rows that this <code>RowSet</code> object can contain;
   ...
   *
   * @return <code>true</code> if escape processing is enabled; <code>false</code> if it is disabled
   * @throws SQLException if a database access error occurs
   ...
   *
   * @param concurrency one of the <code>ResultSet</code> constants specifying a concurrency level:
   ...
   * @param typeName the fully qualified name of an SQL UDT or the type name of the SQL structured
   * type being referenced by a <code>REF</code> type; ignored if the parameter is not a UDT or
   * <code>REF</code> type
   * @throws SQLException if a database access error occurs
   */
   ...
   *
   * @param parameterIndex the first parameter is 1, the second is 2, ...
   * @param reader the <code>Reader</code> object that contains the UNICODE data to be set
  ...
  /**
   * Sets the designated parameter in this <code>RowSet</code> object's command with the given Java
   * <code>Object</code>.  For integral values, the <code>java.lang</code> equivalent objects should
   * be used (for example, an instance of the class <code>Integer</code> for an <code>int</code>).
   *
   * If the second argument is an <code>InputStream</code> then the stream must contain the number
   * of bytes specified by scaleOrLength.  If the second argument is a <code>Reader</code> then the
   * reader must contain the number of characters specified    * by scaleOrLength. If these
   * conditions are not true the driver will generate a <code>SQLException</code> when the prepared
   * statement is executed.
   *
   * <p>The given Java object will be converted to the targetSqlType before being sent to the
   * database. <P> If the object is of a class implementing <code>SQLData</code>, the rowset should
   * call the method <code>SQLData.writeSQL</code> to write the object to an <code>SQLOutput</code>
   * data stream. If, on the other hand, the object is of a class implementing <code>Ref</code>,
   * <code>Blob</code>, <code>Clob</code>,  <code>NClob</code>, <code>Struct</code>,
   * <code>java.net.URL</code>, or <code>Array</code>, the driver should pass it to the database as
   ...
   * types</code>, this is the number of digits after the decimal point. For Java Object types
   * <code>InputStream</code> and <code>Reader</code>, this is the length of the data in the stream
   ...
   * @param parameterIndex the first parameter is 1, the second is 2, ...
   * @param x the parameter value
   * @param cal the <code>java.util.Calendar</code> object to use for calculating the timestamp
   * @throws SQLException if a database access error occurs
   */
   ...
   *
   * @throws SQLException if a database access error occurs or any of the properties necessary for
   * making a connection and creating a statement have not been set
   */
   ...
   *
   * @param listener a component that has implemented the <code>RowSetListener</code> interface and
   * wants to be notified when events occur on this <code>RowSet</code> object
   ...
   *
   * @param listener a component that has been registered as a listener for this <code>RowSet</code>
   * object
   ...
   * will be generated when the <code>CallableStatement</code> is executed. This method differs from
   * the <code>setCharacterStream (int, Reader, int)</code> method because it informs the driver
   * that the parameter value should be sent to the server as a <code>NCLOB</code>.  When the
   * <code>setCharacterStream</code> method is used, the driver may have to do extra work to
