...
public interface PooledConnection {
   ...
   * @throws java.sql.SQLFeatureNotSupportedException if the JDBC driver does not support this
   * method
   * @since 1.4
   */
   ...
   * <code>ConnectionEventListener</code> interface and wants to be notified when the connection is
   ...
   * <code>StatementEventListener</code> with this <code>PooledConnection</code> object. <p>
   *
   * @param listener an component which implements the <code>StatementEventListener</code> interface
   * that is to be registered with this <code>PooledConnection</code> object <p>
   * @since 1.6
   */
   ...
   * interface that was previously registered with this <code>PooledConnection</code> object <p>
   * @since 1.6
   */
