...
public class RowSetWarning extends SQLException {
   ...
   *
   * @param reason a <code>String</code> object giving a description of the warning; if the
   * <code>String</code> is <code>null</code>, this constructor behaves like the default (zero
   ...
   *
   * @param reason a <code>String</code> giving a description of the warning;
   * @param SQLState an XOPEN code identifying the warning; if a non standard XOPEN <i>SQLState</i>
   ...
   * <code>RowSetWarning</code> object is chained to this one, <code>null</code> is returned
   * (default value)
   * @see #setNextWarning
   */
   ...
   *
   * @param warning the <code>RowSetWarning</code> object to be set as the next warning; if the
   * <code>RowSetWarning</code> is null, this represents the finish point in the warning chain
   * @see #getNextWarning
   */
