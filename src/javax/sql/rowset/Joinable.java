...
public interface Joinable {
   ...
   *
   * @param columnIdx an <code>int</code> identifying the index of the column to be set as the match
   * column
   ...
   * object based on the match column.
   *
   * @param columnIdxes an array of <code>int</code> identifying the indexes of the columns to be
   * set as the match columns
   * @throws SQLException if an invalid column index is set
   * @see #setMatchColumn(int[])
   * @see #unsetMatchColumn(int[])
   */
   ...
   * a <code>CachedRowSet</code> object sets a primary key column as a match column.
   *
   * @param columnName a <code>String</code> object giving the name of the column to be set as the
   * match column
   * @throws SQLException if an invalid column name is set, the column name is a null, or the column
   ...
   * object based on the match column.
   *
   * @param columnNames an array of <code>String</code> objects giving the names of the column to be
   * set as the match columns
   * @throws SQLException if an invalid column name is set, the column name is a null, or the column
   * name is an empty string
   * @see #unsetMatchColumn
   ...
   *
   * @return an <code>int</code> array identifying the indexes of the columns that were set as the
   * match columns for this <code>RowSet</code> object
   ...
   *
   * @return an array of <code>String</code> objects giving the names of the columns set as the
   * match columns for this <code>RowSet</code> object
   * @throws SQLException if no match column has been set
   * @see #setMatchColumn
   * @see #unsetMatchColumn
   ...
   * designated column.
   *
   * @param columnIdx an <code>int</code> that identifies the index of the column that is to be
   * unset as a match column
   * @throws SQLException if an invalid column index is designated or if the designated column was
   * not previously set as a match column
   * @see #setMatchColumn
   */
   ...
   * object.
   *
   * @param columnIdxes an array of <code>int</code> that identifies the indexes of the columns that
   * are to be unset as match columns
   * @throws SQLException if an invalid column index is designated or if the designated column was
   * not previously set as a match column
   * @see #setMatchColumn
   */
   ...
   * designated column.
   *
   * @param columnName a <code>String</code> object giving the name of the column that is to be
   * unset as a match column
   * @throws SQLException if an invalid column name is designated or the designated column was not
   * previously set as a match column
   * @see #setMatchColumn
   */
   ...
   * object.
   *
   * @param columnName an array of <code>String</code> objects giving the names of the columns that
   * are to be unset as the match columns
   * @throws SQLException if an invalid column name is designated or the designated column was not
   * previously set as a match column
   * @see #setMatchColumn
   */
