...
public interface Predicate {
   ...
   * @return <code>true</code> if there are more rows in the filter; <code>false</code> otherwise
   */
  public boolean evaluate(RowSet rs);
   ...
   *
   * @param value An <code>Object</code> value which needs to be checked, whether it can be part of
   * this <code>FilterRowSet</code> object.
   * @param column a <code>int</code> object that must match the SQL index of a column in this
   * <code>RowSet</code> object. This must have been passed to <code>Predicate</code> as one of the
   * columns for filtering while initializing a <code>Predicate</code>
   * @return <code>true</code> if row value lies within the filter; <code>false</code> otherwise
   ...
   *
   * @param value An <code>Object</code> value which needs to be checked, whether it can be part of
   * this <code>FilterRowSet</code>.
   * @param columnName a <code>String</code> object that must match the SQL name of a column in this
   * <code>RowSet</code>, ignoring case. This must have been passed to <code>Predicate</code> as one
   * of the columns for filtering while initializing a <code>Predicate</code>
