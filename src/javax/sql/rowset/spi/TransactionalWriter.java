...
public interface TransactionalWriter extends RowSetWriter {
   ...
   *
   * @throws SQLException if a database access error occurs or the <code>Connection</code> object
   * within this <code>CachedRowSet</code> object is in auto-commit mode
   */
   ...
   *
   * @param s a <code>Savepoint</code> object marking a savepoint in the current transaction.  All
   * changes made before <i>s</i> was set will be undone. All changes made after <i>s</i> was set
