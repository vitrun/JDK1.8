...
public class SyncProviderException extends java.sql.SQLException {
   ...
   *
   * @param syncResolver the <code>SyncResolver</code> instance used to to process the
   * synchronization conflicts
   * @throws IllegalArgumentException if the <code>SyncResolver</code> object is <code>null</code>.
   */
   ...
   *
   * @return the <code>SyncResolver</code> object set for this <code>SyncProviderException</code>
   * object or, if none has been set, an instance of the default <code>SyncResolver</code>
   * implementation. In addition, the default <code>SyncResolver</code> implementation is also
   * returned if the <code>SyncResolver()</code> or <code>SyncResolver(String)</code> constructors
   * are used to instantiate the <code>SyncResolver</code> instance.
   */
   ...
   *
   * @param syncResolver the <code>SyncResolver</code> object to be set; cannot be
   * <code>null</code>
   * @throws IllegalArgumentException if the <code>SyncResolver</code> object is <code>null</code>.
   * @see #getSyncResolver
   */
