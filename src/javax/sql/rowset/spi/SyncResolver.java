...
public interface SyncResolver extends RowSet {
   ...
   *
   * @return one of the following constants: <code>SyncResolver.UPDATE_ROW_CONFLICT</code>,
   * <code>SyncResolver.DELETE_ROW_CONFLICT</code>, <code>SyncResolver.INSERT_ROW_CONFLICT</code>,
   * or <code>SyncResolver.NO_ROW_CONFLICT</code>
   */
   ...
   * @return the value of the designated column in the current row of this <code>SyncResolver</code>
   * object
   ...
   *
   * @param index an <code>int</code> giving the number of the column into which to set the value to
   * be persisted
   * @param obj an <code>Object</code> that is the value to be set in the <code>RowSet</code> object
   * and persisted in the data source
   * @throws SQLException if a database access error occurs
   */
   ...
   * is set as the value in the data source internally.
   *
   * @param columnName a <code>String</code> object giving the name of the column into which to set
   ...
   * more rows
   * @throws SQLException if a database access error occurs or the result set type is
   ...
   * object's warning chain.
   *
   * @return <code>true</code> if the cursor is on a valid row; <code>false</code> if it is off the
   * result set
   * @throws SQLException if a database access error occurs or the result set type is
   * <code>TYPE_FORWARD_ONLY</code>
   */
