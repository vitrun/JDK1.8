...
public interface XmlReader extends RowSetReader {
   ...
   *
   * @param caller the <code>WebRowSet</code> object to be parsed, whose <code>xmlReader</code>
   * field must contain a reference to this <code>XmlReader</code> object
   * @param reader the <code>java.io.Reader</code> object from which <code>caller</code> will be
   * read
   * @throws SQLException if a database access error occurs or this <code>XmlReader</code> object is
   * not the reader for the given rowset
   */
