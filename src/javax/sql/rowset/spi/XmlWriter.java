...
public interface XmlWriter extends RowSetWriter {
   ...
   *
   * @param caller the <code>WebRowSet</code> instance to be written, for which this
   * <code>XmlWriter</code> object is the writer
   * @param writer the <code>java.io.Writer</code> object that serves as the output stream for
   * writing <code>caller</code> as an XML document
   * @throws SQLException if a database access error occurs or this <code>XmlWriter</code> object is
   * not the writer for the given <code>WebRowSet</code> object
   */
