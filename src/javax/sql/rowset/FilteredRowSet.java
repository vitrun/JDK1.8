...
public interface FilteredRowSet extends WebRowSet {
   ...
   * <code>FilteredRowSet</code> object. Setting a <b>null</b> value will clear the predicate,
   * allowing all rows to become visible.
   * @throws SQLException if an error occurs when setting the <code>Predicate</code> object
   */
   ...
   *
   * @return p the <code>Predicate</code> for this <code>FilteredRowSet</code> object;
