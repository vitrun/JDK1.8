...
public interface RowSetInternal {
   ...
   *
   * @return an array of the current parameter values for this <code>RowSet</code> object's command
   ...
   *
   * @return the <code>Connection</code> object passed to the rowset or <code>null</code> if none
   * was passed
   * @throws SQLException if a database access error occurs
   */
   ...
   *
   * @param md the <code>RowSetMetaData</code> object that will be set with information about the
   * rowset's columns
   * @throws SQLException if a database access error occurs
   */
   ...
   *
   * @return the original value of the current row as a <code>ResultSet</code> object
   * @throws SQLException if a database access error occurs or this method is called while the
   * cursor is on the insert row, before the first row, or after the last row
   */
