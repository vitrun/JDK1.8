...
public interface LoginModule {
   ...
   * @param callbackHandler a {@code CallbackHandler} for communicating with the end user (prompting
   * for usernames and passwords, for example). <p>
   * @param sharedState state shared with other configured LoginModules. <p>
   * @param options options specified in the login {@code Configuration} for this particular {@code
   * LoginModule}.
   */
   ...
   * <p>
   *
   * @return true if the authentication succeeded, or false if this {@code LoginModule} should be
   * ignored.
