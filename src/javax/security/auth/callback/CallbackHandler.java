...
public interface CallbackHandler {
   ...
   * }</pre>
   *
   * @param callbacks an array of {@code Callback} objects provided by an underlying security
   * service which contains the information requested to be retrieved or displayed.
   * @throws java.io.IOException if an input or output error occurs. <p>
   * @throws UnsupportedCallbackException if the implementation of this method does not support one
   * or more of the Callbacks specified in the {@code callbacks} parameter.
   */
