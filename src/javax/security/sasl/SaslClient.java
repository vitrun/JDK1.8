...
public abstract interface SaslClient {
   ...
   *
   * @param challenge The non-null challenge sent from the server. The challenge array may have zero
   * length.
   * @return The possibly null response to send to the server. It is null if the challenge
   * accompanied a "SUCCESS" status and the challenge only contains data for the client to update
   * its state and no response needs to be sent to the server. The response is a zero-length byte
   * array if the client is to send a response with no data.
   * @throws SaslException If an error occurred while processing the challenge or generating a
   * response.
   */
   ...
   * @throws SaslException if {@code incoming} cannot be successfully unwrapped.
   * @throws IllegalStateException if the authentication exchange has not completed, or  if the
   * negotiated quality of protection has neither integrity nor privacy.
   */
   ...
   * @throws SaslException if {@code outgoing} cannot be successfully wrapped.
   * @throws IllegalStateException if the authentication exchange has not completed, or if the
   * negotiated quality of protection has neither integrity nor privacy.
   */
   ...
   * @return The value of the negotiated property. If null, the property was not negotiated or is
