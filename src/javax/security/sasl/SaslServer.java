...
public abstract interface SaslServer {
   ...
   * @return The possibly null challenge to send to the client. It is null if the authentication has
   * succeeded and there is no more challenge data to be sent to the client.
   * @throws SaslException If an error occurred while processing the response or generating a
   * challenge.
   */
   ...
   * to use.
   *
   * @param incoming A non-null byte array containing the encoded bytes from the client.
