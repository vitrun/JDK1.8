...
public interface Filer {
   ...
   * or a package name followed by {@code ".package-info"} for a package information file
   * @param originatingElements type or package elements causally associated with the creation of
   * this file, may be elided or {@code null}
   * @return a {@code JavaFileObject} to write the new source file
   * @throws FilerException if the same pathname has already been created, the same type has already
   * been created, or the name is not valid for a type
   ...
   * for this run.
   *
   * @param name binary name of the type being written or a package name followed by {@code
   ...
   * @throws IOException if the file cannot be created
   * @throws FilerException if the same pathname has already been created
   ...
   * @throws FilerException if the same pathname has already been opened for writing
