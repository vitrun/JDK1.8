...
public interface ScriptContext {
   ...
   * @throws IllegalArgumentException If no <code>Bindings</code> is defined for the specified scope
   * value in ScriptContexts of this type.
   * @throws NullPointerException if value of scope is <code>ENGINE_SCOPE</code> and the specified
   ...
   *
   * @param scope The scope
   * @return The associated <code>Bindings</code>.  Returns <code>null</code> if it has not been
   * set.
   * @throws IllegalArgumentException If no <code>Bindings</code> is defined for the specified scope
   * value in <code>ScriptContext</code> of this type.
   */
