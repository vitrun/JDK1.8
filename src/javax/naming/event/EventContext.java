...
public interface EventContext extends Context {
   ...
   * @param scope One of <tt>OBJECT_SCOPE</tt>, <tt>ONELEVEL_SCOPE</tt>, or <tt>SUBTREE_SCOPE</tt>.
   * @param l The nonnull listener.
   * @throws NamingException If a problem was encountered while adding the listener.
   ...
   *
   * @param l The nonnull listener.
   * @throws NamingException If a problem was encountered while removing the listener.
   ...
   * @throws NamingException If the context's behavior in this regard cannot be determined.
   */
