...
public class UnsolicitedNotificationEvent extends java.util.EventObject {
   ...
   *
   * @return The non-null unsolicited notification that caused this event to be fired.
   */
   ...
   *
   * @param listener The non-null listener on which to invoke <tt>notificationReceived</tt>.
   */
