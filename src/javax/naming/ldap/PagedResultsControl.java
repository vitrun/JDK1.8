...
final public class PagedResultsControl extends BasicControl {
   ...
   * @param criticality If true then the server must honor the control and return search results as
   * indicated by pageSize or refuse to perform the search. If false, then the server need not honor
   * the control.
