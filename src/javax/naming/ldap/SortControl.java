...
final public class SortControl extends BasicControl {
   ...
   * @param criticality If true then the server must honor the control and return the search results
   * sorted as requested or refuse to perform the search. If false, then the server need not honor
   * the control.
   * @throws IOException If an error was encountered while encoding the supplied arguments into a
   * control.
   */
   ...
   *
   * @param sortBy A non-null list of attribute IDs to sort by. The list is in order of highest to
   * lowest sort key precedence.
   * @param criticality If true then the server must honor the control and return the search results
   * sorted as requested or refuse to perform the search. If false, then the server need not honor
   * the control.
   * @throws IOException If an error was encountered while encoding the supplied arguments into a
   ...
   *
   * @param sortBy A non-null list of keys to sort by. The list is in order of highest to lowest
   * sort key precedence.
   * @param criticality If true then the server must honor the control and return the search results
   * sorted as requested or refuse to perform the search. If false, then the server need not honor
   * the control.
