...
public interface ExtendedRequest extends java.io.Serializable {
   ...
   *
   * @return A possibly null byte array representing the ASN.1 BER encoded contents of the LDAP
   * <tt>ExtendedRequest.requestValue</tt> component.
   * @throws IllegalStateException If the encoded value cannot be retrieved because the request
   * contains insufficient or invalid data/state.
   */
   ...
   *
   * @param id The possibly null object identifier of the response control.
   * @param berValue The possibly null ASN.1 BER encoded value of the response control. This is the
   ...
   * @throws NamingException if cannot create extended response due to an error.
   * @see ExtendedResponse
   */
  public ExtendedResponse createExtendedResponse(String id,
