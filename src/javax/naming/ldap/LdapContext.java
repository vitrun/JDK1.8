...
public interface LdapContext extends DirContext {
   ...
   * @return The possibly null response of the operation. null means the operation did not generate
   * any response.
   * @throws NamingException If an error occurred while performing the extended operation.
   */
   ...
   *
   * @param requestControls The possibly null request controls to use for the new context. If null,
   * the context is initialized with no request controls.
   * @return A non-null <tt>LdapContext</tt> instance.
   * @throws NamingException If an error occurred while creating the new instance.
   * @see InitialLdapContext
   */
   ...
   *
   * @param connCtls The possibly null controls to use. If null, no controls are used.
   ...
   * caller.
   *
   * @return A possibly-null array of controls. null means no connect controls have been set for
   * this context.
   * @throws NamingException If an error occurred while getting the request controls.
   */
   ...
   *
   * @param requestControls The possibly null controls to use. If null, no controls are used.
   * @throws NamingException If an error occurred while setting the request controls.
   ...
   * caller.
   *
   * @return A possibly-null array of controls. null means no request controls have been set for
   * this context.
   * @throws NamingException If an error occurred while getting the request controls.
   ...
   * <p>
   *
   * @return A possibly null array of controls. If null, the previous method invoked on this context
   * did not produce any controls.
   * @throws NamingException If an error occurred while getting the response controls.
   */
