...
public interface UnsolicitedNotification extends ExtendedResponse, HasControls {
   ...
   *
   * @return A possibly null array of referrals, each of which is represented by a URL string. If
   * null, no referral was sent by the server.
   */
   ...
   * sent by the server.
   *
   * @return A possibly null exception as constructed using information sent by the server. If null,
   * a "success" status was indicated by the server.
   */
