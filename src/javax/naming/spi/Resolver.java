...
public interface Resolver {
   ...
   * @param contextType the type of object to resolve.  This should be a subtype of
   * <code>Context</code>.
   * @return the object that was found, along with the unresolved suffix of <code>name</code>.
   * Cannot be null.
