...
public class CompoundName implements Name {
   ...
   *
   * @param comps A non-null enumeration of the components to add. Each element of the enumeration
   * is of class String. The enumeration will be consumed to extract its elements.
   * @param syntax A non-null properties that specify the syntax of this compound name. See class
   ...
   * @param syntax A non-null list of properties that specify the syntax of this compound name.  See
   * class description for contents of properties.
   * @throws InvalidNameException If 'n' violates the syntax specified by <code>syntax</code>.
   */
   ...
   * [0,size()].
   * @return A compound name consisting of the components at indexes in the range [0,posn).
   * @throws ArrayIndexOutOfBoundsException If posn is outside the specified range.
   */
   ...
   * @return true if n is a CompoundName and is a prefix of this compound name, false otherwise.
   */
   ...
   * @throws InvalidNameException If suffix is not a compound name, or if the addition of the
   ...
   * @return The updated CompoundName, not a new one. Cannot be null.
   * @throws ArrayIndexOutOfBoundsException If posn is outside the specified range.
   * @throws InvalidNameException If n is not a compound name, or if the addition of the components
   * violates the syntax of this compound name (e.g. exceeding number of components).
   */
   ...
   * @return The updated CompoundName, not a new one. Cannot be null.
   * @throws InvalidNameException If adding comp at end of the name would violate the compound
   * name's syntax.
   */
   ...
   * @return The updated CompoundName, not a new one. Cannot be null.
   * @throws ArrayIndexOutOfBoundsException If posn is outside the specified range.
   * @throws InvalidNameException If adding comp at the specified position would violate the
   ...
   * @throws InvalidNameException If deleting the component would violate the compound name's
   * syntax.
   */
   ...
   *
   * @serialData The syntax <tt>Properties</tt>, followed by the number of components (an
   * <tt>int</tt>), and the individual components (each a <tt>String</tt>).
   */
