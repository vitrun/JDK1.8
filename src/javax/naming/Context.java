...
public interface Context {
   ...
   * @throws javax.naming.directory.InvalidAttributesException if object did not supply all
   ...
   * element of the enumeration is of type <tt>NameClassPair</tt>.
   * @throws NamingException if a naming exception is encountered
   * @see #list(String)
   ...
   * @throws NameNotFoundException if an intermediate context does not exist
   * @throws NotContextException if the name is bound but does not name a context, or does not name
   ...
   * @throws NameAlreadyBoundException if name is already bound
   * @throws javax.naming.directory.InvalidAttributesException if creation of the subcontext
   ...
   * @throws OperationNotSupportedException if the naming system does not have the notion of a full
   * name
   * @throws NamingException if a naming exception is encountered
   * @since 1.3
   */
