...
public interface DirContext extends Context {
   ...
   * @return the set of attributes associated with <code>name</code>. Returns an empty attribute set
   * if name has no attributes; never null.
   ...
   * @param mod_op the modification operation, one of: <code>ADD_ATTRIBUTE</code>,
   * <code>REPLACE_ATTRIBUTE</code>, <code>REMOVE_ATTRIBUTE</code>.
   * @param attrs the attributes to be used for the modification; may not be null
   * @throws AttributeModificationException if the modification cannot be completed successfully
   * @throws NamingException if a naming exception is encountered
   ...
   * @throws AttributeModificationException if the modifications cannot be completed successfully
   * @throws NamingException if a naming exception is encountered
   ...
   * @throws InvalidAttributesException if some "mandatory" attributes of the binding are not
   * supplied
   * @throws NamingException if a naming exception is encountered
   ...
   * @throws InvalidAttributesException if <code>attrs</code> does not contain all the mandatory
...
// -------------------- schema operations
   ...
   * @return the <tt>DirContext</tt> containing the named object's class definitions; never null
   * @throws OperationNotSupportedException if schema not supported
   * @throws NamingException if a naming exception is encountered
   */
...
// -------------------- search operations
   ...
   * @return a non-null enumeration of <tt>SearchResult</tt> objects. Each <tt>SearchResult</tt>
   * contains the attributes identified by <code>attributesToReturn</code> and the name of the
   * corresponding object, named relative to the context named by <code>name</code>.
   * @throws NamingException if a naming exception is encountered
   * @see SearchControls
   * @see SearchResult
   ...
   * are used (equivalent to <tt>(new SearchControls())</tt>).
   * @return an enumeration of <tt>SearchResult</tt>s of the objects that satisfy the filter; never
   * null
   * @throws InvalidSearchFilterException if the search filter specified is not supported or
   * understood by the underlying directory
   * @throws InvalidSearchControlsException if the search controls contain invalid settings
   * @throws NamingException if a naming exception is encountered
   * @see #search(Name, String, Object[], SearchControls)
   * @see SearchControls
   * @see SearchResult
   ...
   * variables of the form "<code>{i}</code>" where <code>i</code> is a nonnegative integer.  May
   * not be null.
   * @param filterArgs the array of arguments to substitute for the variables in
   * <code>filterExpr</code>.  The value of <code>filterArgs[i]</code> will replace each occurrence
   * of "<code>{i}</code>". If null, equivalent to an empty array.
   * @param cons the search controls that control the search.  If null, the default search controls
   * are used (equivalent to <tt>(new SearchControls())</tt>).
   * @return an enumeration of <tt>SearchResult</tt>s of the objects that satisfy the filter; never
   * null
   * @throws ArrayIndexOutOfBoundsException if <tt>filterExpr</tt> contains <code>{i}</code>
   * expressions where <code>i</code> is outside the bounds of the array <code>filterArgs</code>
   * @throws InvalidSearchControlsException if <tt>cons</tt> contains invalid settings
   * @throws InvalidSearchFilterException if <tt>filterExpr</tt> with <tt>filterArgs</tt> represents
   * an invalid search filter
   * @throws NamingException if a naming exception is encountered
   * @see #search(Name, Attributes, String[])
