...
public interface Attribute extends Cloneable, java.io.Serializable {
   ...
   * will be ordered.
   *
   * @return A non-null enumeration of the attribute's values. Each element of the enumeration is a
   * possibly null Object. The object's class is the class of the attribute value. The element is
   * null if the attribute's value is null. If the attribute has zero values, an empty enumeration
   * is returned.
   ...
   *
   * @return A possibly null object representing one of the attribute's value. It is null if the
   ...
   *
   * @param attrVal The possibly null value to check. If null, check whether the attribute has an
   ...
   * <tt>Object.equals()</tt> or schema information to determine equality.
   *
   * @param attrVal The new possibly null value to add. If null, null is added as an attribute
   * value.
   ...
   * <tt>Object.equals()</tt> or schema information to determine equality.
   *
   * @param attrval The possibly null value to remove from this attribute. If null, remove the
   ...
   * information.
   *
   * @return The attribute's syntax definition. Null if the implementation supports schemas but this
   * particular attribute does not have any schema information.
   * @throws OperationNotSupportedException If getting the schema is not supported.
   * @throws NamingException If a naming exception occurs while getting the schema.
   */
   ...
   * information.
   *
   * @return This attribute's schema definition. Null if the implementation supports schemas but
   * this particular attribute does not have any schema information.
   * @throws OperationNotSupportedException If getting the schema is not supported.
   * @throws NamingException If a naming exception occurs while getting the schema.
   */
   ...
   *
   * @param ix The index of the value in the ordered list of attribute values. {@code 0 <= ix <
   * size()}.
   * @return The possibly null attribute value at index <tt>ix</tt>; null if the attribute value is
   * null.
   * @throws NamingException If a naming exception was encountered while retrieving the value.
   ...
   *
   * @param ix The index of the value to remove. {@code 0 <= ix < size()}.
   * @return The possibly null attribute value at index <tt>ix</tt> that was removed; null if the
   ...
   *
   * @param ix The index in the ordered list of attribute values to add the new value. {@code 0 <=
   * ix <= size()}.
   * @param attrVal The possibly null attribute value to add; if null, null is the value added.
   * @throws IndexOutOfBoundsException If <tt>ix</tt> is outside the specified range.
   * @throws IllegalStateException If the attribute values are unordered and <tt>attrVal</tt> is one
   * of those values.
   */
   ...
   * @param ix The index of the value in the ordered list of attribute values. {@code 0 <= ix <
   * size()}.
   * @param attrVal The possibly null attribute value to use. If null, 'null' replaces the old
   * value.
   * @return The possibly null attribute value at index ix that was replaced. Null if the attribute
   * value was null.
   * @throws IndexOutOfBoundsException If <tt>ix</tt> is outside the specified range.
   * @throws IllegalStateException If <tt>attrVal</tt> already exists and the attribute values are
   * unordered.
   */
