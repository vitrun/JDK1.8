...
public class SysexMessage extends MidiMessage {
   ...
   * @param length the length of the valid message data in the array, including the status byte; it
   * should be non-negative and less than or equal to {@code data.length}
   ...
   * the {@code setMessage} methods.
   *
   * @param status the status byte for the message; it must be a valid system exclusive status byte
   * (0xF0 or 0xF7)
   * @param data the system exclusive message data (without the status byte)
   * @param length the length of the valid message data in the array; it should be non-negative and
   ...
   * @param length the length of the valid message data in the array, including the status byte.
   */
