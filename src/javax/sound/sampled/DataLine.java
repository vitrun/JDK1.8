...
public interface DataLine extends Line {
  ...
  /**
   * Stops the line.  A stopped line should cease I/O activity. If the line is open and running,
   * however, it should retain the resources required to resume activity.  A stopped line should
   * retain any audio data in its buffer instead of discarding it, so that upon resumption the I/O
   * can continue where it left off, if possible.  (This doesn't guarantee that there will never be
   * discontinuities beyond the current buffer, of course; if the stopped condition continues for
   * too long, input or output samples might be dropped.)  If desired, the retained data can be
   ...
   *
   * @return <code>true</code> if the line is actively capturing or rendering sound, otherwise
   * <code>false</code>
   * @see #isOpen
   * @see #addLineListener
   ...
   *
   * @return the current amplitude of the signal in this line, or <code>{@link
  ...
  public static class Info extends Line.Info {
     ...
     *
     * @return <code>true</code> if this object matches the one specified, otherwise
     * <code>false</code>.
     */
    ...
    public String toString() {
      ...
      if ((minBufferSize != AudioSystem.NOT_SPECIFIED) && (maxBufferSize
