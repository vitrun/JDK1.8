...
public interface Doc {
   ...
   * @throws IOException Thrown if the representation class is a stream and there was an I/O error
   * while constructing the stream.
   */
   ...
   * <P>
   *
   * @return Reader for reading the print data characters from this doc. If a reader cannot be
   * provided because this doc does not meet the criteria stated above, null is returned.
   ...
   * <P>
   *
   * @return Input stream for reading the print data bytes from this doc. If an input stream cannot
   * be provided because this doc does not meet the criteria stated above, null is returned.
