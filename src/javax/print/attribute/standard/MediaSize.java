...
public class MediaSize extends Size2DSyntax implements Attribute {
   ...
   *
   * @return the name for this media size, or null if no name was associated with this size (an
   * anonymous size).
   */
   ...
   * @return size of the media, or null if this media is not associated with any size.
   */
   ...
   * @throws IllegalArgumentException if {@code x <= 0}, {@code y <= 0}, or {@code units < 1}.
   */
   ...
   * @return True if <CODE>object</CODE> is equivalent to this media size attribute, false
   * otherwise.
   */
