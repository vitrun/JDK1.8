...
public final class PrinterMakeAndModel extends TextSyntax
   ...
   * @throws NullPointerException (unchecked exception) Thrown if <CODE>makeAndModel</CODE> is
   * null.
   */
   ...
   * @return True if <CODE>object</CODE> is equivalent to this printer make and model attribute,
   * false otherwise.
   */
