...
public final class PageRanges extends SetOfIntegerSyntax
   ...
   * obey  the proper syntax.  Also thrown if the constructed set-of-integer is a zero-length array
   * or if any member of the set is less than 1.
   */
   ...
   * @return True if <CODE>object</CODE> is equivalent to this page ranges attribute, false
   * otherwise.
   */
