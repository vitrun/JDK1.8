...
public abstract class Size2DSyntax implements Serializable, Cloneable {
   ...
   * @param units Unit conversion factor, e.g. {@link #INCH <CODE>INCH</CODE>} or {@link #MM
   * <CODE>MM</CODE>}.
   ...
   *
   * @param units Unit conversion factor, e.g. {@link #INCH INCH} or {@link #MM MM}.
   * @return A two-element array with the X dimension at index 0 and the Y dimension at index 1.
   ...
   *
   * @param units Unit conversion factor, e.g. {@link #INCH INCH} or {@link #MM MM}.
   * @param unitsName Units name string, e.g. {@code in} or {@code mm}. If null, no units name is
   ...
   * @return True if <CODE>object</CODE> is equivalent to this two-dimensional size attribute, false
   * otherwise.
   */
