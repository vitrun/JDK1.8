...
public interface PrintRequestAttributeSet extends AttributeSet {
   ...
   * @throws ClassCastException (unchecked exception) Thrown if the <CODE>attribute</CODE> is not an
   * instance of interface {@link PrintRequestAttribute PrintRequestAttribute}.
   ...
   * @throws ClassCastException (Unchecked exception) Thrown if some element in the specified set is
   * not an instance of interface {@link PrintRequestAttribute PrintRequestAttribute}.
