...
public interface MultiDocPrintJob extends DocPrintJob {
   ...
   * PrintJobListener.
   *
   * @param multiDoc The documents to be printed. ALL must be a flavor supported by the PrintJob
   ...
   * @throws PrintException The exception additionally may implement an interfaces which more
