...
public abstract class ServiceUIFactory {
   ...
   * <P>
   *
   * @param role requested. Must be one of the standard roles or a private role supported by this
   * factory.
   * @param ui type in which the role is requested.
   * @return the UI role or null if the requested UI role is not available from this factory
   * @throws IllegalArgumentException if the role or ui is neither one of the standard ones, nor a
   ...
   * @return the UI types supported by this class for the specified role, null if no UIs are
   * available for the role.
   * @throws IllegalArgumentException is the role is a non-standard role not supported by this
   * factory.
   */
