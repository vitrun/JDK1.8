...
public interface IIOWriteProgressListener extends EventListener {
   ...
   * @param imageIndex the index of the image being written within its containing input file or
   * stream.
   */
   ...
   *
   * @param source the <code>ImageWriter</code> object calling this method.
   * @param percentageDone the approximate percentage of decoding that has been completed.
   */
