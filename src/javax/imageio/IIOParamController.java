...
public interface IIOParamController {
   ...
   * @return <code>true</code> if the <code>IIOParam</code> has been modified, <code>false</code>
   * otherwise.
   * @throws IllegalArgumentException if <code>param</code> is <code>null</code> or is not an
