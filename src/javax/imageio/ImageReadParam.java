...
public class ImageReadParam extends IIOParam {
   ...
   *
   * @param destinationBands an array of integer band indices to be used.
   * @throws IllegalArgumentException if <code>destinationBands</code> contains a negative or
   * duplicate value.
   ...
   *
   * @return the indices of the destination bands to be used, or <code>null</code>.
   ...
   *
   * @param size a <code>Dimension</code> indicating the desired width and height.
   * @throws IllegalArgumentException if either the width or the height is negative or 0.
   * @throws UnsupportedOperationException if image resizing is not supported by this plug-in.
   ...
   *
   * @return the rendered width and height of the source image as a <code>Dimension</code>.
   * @see #setSourceRenderSize
   */
   ...
   * @throws IllegalArgumentException if <code>minPass</code> is negative, <code>numPasses</code> is
   * negative or 0, or <code>numPasses</code> is smaller than <code>Integer.MAX_VALUE</code> but
   * <code>minPass + numPasses - 1</code> is greater than <code>INTEGER.MAX_VALUE</code>.
   ...
   *
   * @return the index of the last pass to be read, or <code>Integer.MAX_VALUE</code>.
   */
