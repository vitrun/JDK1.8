...
public interface ImageOutputStream extends ImageInputStream, DataOutput {
   ...
   * to guarantee this.
   *
   * @param b an <code>int</code> whose lower 8 bits are to be written.
   ...
   * write.
   *
   * @param v an <code>int</code> containing the byte value to be written.
   * @throws IOException if an I/O error occurs.
   */
   ...
   * write.
   *
   * @param v an <code>int</code> containing the short value to be written.
   * @throws IOException if an I/O error occurs.
   */
   ...
   *
   * @param v an <code>int</code> containing the char (unsigned short) value to be written.
   * @throws IOException if an I/O error occurs.
   * @see #writeShort(int)
   */
   ...
   * write.
   *
   * @param v an <code>int</code> containing the value to be written.
   * @throws IOException if an I/O error occurs.
   */
   ...
   * write.
   *
   * @param v a <code>long</code> containing the value to be written.
   * @throws IOException if an I/O error occurs.
   */
   ...
   * write.
   *
   * @param v a <code>float</code> containing the value to be written.
   * @throws IOException if an I/O error occurs.
   */
   ...
   * write.
   *
   * @param v a <code>double</code> containing the value to be written.
   * @throws IOException if an I/O error occurs.
   */
   ...
   * write.
   *
   * @param s a <code>String</code> containing the value to be written.
   ...
   * @param s a <code>String</code> containing the value to be written.
   * @throws NullPointerException if <code>s</code> is <code>null</code>.
   * @throws java.io.UTFDataFormatException if the modified UTF-8 representation of <code>s</code>
   ...
   *
   * @param bit an <code>int</code> whose least significant bit is to be written to the stream.
   * @throws IOException if an I/O error occurs.
   */
   ...
   * bits will be set to 0 automatically.
   *
   * @param bits a <code>long</code> containing the bits to be written, starting with the bit in
   * position <code>numBits - 1</code> down to the least significant bit.
