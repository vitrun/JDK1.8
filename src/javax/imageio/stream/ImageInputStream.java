...
public interface ImageInputStream extends DataInput, Closeable {
   ...
   *
   * @param byteOrder one of <code>ByteOrder.BIG_ENDIAN</code> or <code>java.nio.ByteOrder.LITTLE_ENDIAN</code>,
   ...
   *
   * @return one of <code>ByteOrder.BIG_ENDIAN</code> or <code>ByteOrder.LITTLE_ENDIAN</code>,
   ...
   * negative, or <code>off + len</code> is greater than <code>b.length</code>.
   * @throws IOException if an I/O error occurs.
   */
   ...
   * @throws IndexOutOfBoundsException if <code>off</code> is negative, <code>len</code> is
   * negative, or <code>off + len</code> is greater than <code>s.length</code>.
   ...
   * @throws IndexOutOfBoundsException if <code>off</code> is negative, <code>len</code> is
   * negative, or <code>off + len</code> is greater than <code>c.length</code>.
   ...
   * @throws IndexOutOfBoundsException if <code>off</code> is negative, <code>len</code> is
   * negative, or <code>off + len</code> is greater than <code>i.length</code>.
   ...
   * @throws IndexOutOfBoundsException if <code>off</code> is negative, <code>len</code> is
   * negative, or <code>off + len</code> is greater than <code>l.length</code>.
   ...
   * @throws IndexOutOfBoundsException if <code>off</code> is negative, <code>len</code> is
   * negative, or <code>off + len</code> is greater than <code>f.length</code>.
   ...
   * @throws IndexOutOfBoundsException if <code>off</code> is negative, <code>len</code> is
   * negative, or <code>off + len</code> is greater than <code>d.length</code>.
   ...
   *
   * @return an <code>int</code> containing the bit offset between 0 and 7, inclusive.
   * @throws IOException if an I/O error occurs.
   * @see #setBitOffset
   */
   ...
   * significant bit, of the byte being read.
   *
   * @param bitOffset the desired offset, as an <code>int</code> between 0 and 7, inclusive.
   * @throws IllegalArgumentException if <code>bitOffset</code> is not between 0 and 7, inclusive.
   * @throws IOException if an I/O error occurs.
   * @see #getBitOffset
   */
   ...
   * modulo 8.
   *
   * @return an <code>int</code> containing the value <code>0</code> or <code>1</code>.
   ...
   * @return the bitstring, as a <code>long</code> with the last bit read stored in the least
   * significant bit.
   * @throws IllegalArgumentException if <code>numBits</code> is not between 0 and 64, inclusive.
   * @throws java.io.EOFException if the stream reaches the end before reading all the bits.
   * @throws IOException if an I/O error occurs.
   */
   ...
   *
   * @return a <code>long</code> containing the length of the stream, if known, or else
   * <code>-1</code>.
   * @throws IOException if an I/O error occurs.
   */
   ...
   *
   * @param n an <code>int</code> containing the number of bytes to be skipped.
   ...
   *
   * @param n a <code>long</code> containing the number of bytes to be skipped.
   ...
   * stream.
   *
   * @param pos a <code>long</code> containing the length of the stream prefix that may be flushed.
   * @throws IndexOutOfBoundsException if <code>pos</code> lies in the flushed portion of the stream
   * or past the current stream position.
   * @throws IOException if an I/O error occurs.
   */
   ...
   *
   * @return <code>true</code> if this <code>ImageInputStream</code> caches data.
   * @see #isCachedMemory
   * @see #isCachedFile
   */
  boolean isCached();
   ...
   *
   * @return <code>true</code> if this <code>ImageInputStream</code> caches data in main memory.
   * @see #isCached
   * @see #isCachedFile
   */
   ...
   * in order to conserve cache resources.
   *
   * @return <code>true</code> if this <code>ImageInputStream</code> caches data in a temporary
   * file.
   * @see #isCached
   * @see #isCachedMemory
   */
