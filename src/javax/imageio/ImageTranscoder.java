...
public interface ImageTranscoder {
   ...
   *
   * @param inData an <code>IIOMetadata</code> object representing stream metadata, used to
   ...
   * <code>null</code>.
   * @return an <code>IIOMetadata</code> object, or <code>null</code> if the plug-in does not
   * provide metadata encoding capabilities.
   ...
   * transcoder, they will be ignored.
   *
   * @param inData an <code>IIOMetadata</code> object representing image metadata, used to
   * initialize the state of the returned object.
   * @param imageType an <code>ImageTypeSpecifier</code> indicating the layout and color information
   * of the image with which the metadata will be associated.
   * @param param an <code>ImageWriteParam</code> that will be used to encode the image, or
   * <code>null</code>.
   * @return an <code>IIOMetadata</code> object, or <code>null</code> if the plug-in does not
   * provide metadata encoding capabilities.
   * @throws IllegalArgumentException if either of <code>inData</code> or <code>imageType</code> is
   * <code>null</code>.
   */
