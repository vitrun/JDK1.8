...
public interface IIOMetadataController {
   ...
   * @return <code>true</code> if the <code>IIOMetadata</code> has been modified, <code>false</code>
   * otherwise.
   * @throws IllegalArgumentException if <code>metadata</code> is <code>null</code> or is not an
