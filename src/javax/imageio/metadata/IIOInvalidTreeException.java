...
public class IIOInvalidTreeException extends IIOException {
   ...
   *
   * @param message a <code>String</code> containing the reason for the parsing failure.
   * @param offendingNode the DOM <code>Node</code> that caused the exception, or
   * <code>null</code>.
   */
   ...
   *
   * @param message a <code>String</code> containing the reason for the parsing failure.
   * @param cause the <code>Throwable</code> (<code>Error</code> or <code>Exception</code>) that
   * caused this exception to occur, or <code>null</code>.
   * @param offendingNode the DOM <code>Node</code> that caused the exception, or
   * <code>null</code>.
   */
