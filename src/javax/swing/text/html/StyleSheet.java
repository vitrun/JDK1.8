...
public class StyleSheet extends StyleContext {
   ...
   * @param e the element representing the tag; the element can be used to determine the nesting for
   * situations where the attributes will differ if nested inside of other elements
   ...
   * @param ref the reference URL.  This value represents the location of the stream and may be
   * null.  All relative URLs specified in the stream will be based upon this parameter.
   */
   ...
   *
   * @param a The set of attributes to be represented in the the compact form.
   */
   ...
   * attribute conversion.
   *
   * @param a The set of attributes to be represented in the the larger form.
   */
   ...
   *
   * @param selector the selector to use for the rule. This will be a set of simple selectors, and
   * must be a length of 1 or greater.
   * @param declaration the set of CSS attributes that make up the rule.
   */
   ...
   *
   * @param elements a Vector of all the Elements the style is being asked for. The first Element is
   * the deepest Element, with the last Element representing the root.
   * @param t the Tag to use for the first Element in <code>elements</code>
   */
  ...
  public static class BoxPainter implements Serializable {
     ...
     *
     * @param side The size of the box to fetch the inset for.  This can be View.TOP, View.LEFT,
     * View.BOTTOM, or View.RIGHT.
     * @param v the view making the request.  This is used to get the AttributeSet, and may be used
     * to resolve percentage arguments.
     ...
     * @param x the x coordinate of the allocated area to render into.
     * @param y the y coordinate of the allocated area to render into.
     ...
     *
     * @param side The horizontal side to fetch margin for This can be HorizontalMargin.LEFT or
  ...
  public static class ListPainter implements Serializable {
     ...
     * @param item which list item is being painted.  This is a number greater than or equal to 0.
     */
