...
class OptionListModel<E> extends DefaultListModel<E> implements ListSelectionModel, Serializable {
   ...
   *
   * @return all of the <code>ListSelectionListener</code>s added or an empty array if no listeners
   * have been added
   * @since 1.4
   */
   ...
   * @throws CloneNotSupportedException if the receiver does not both (a) implement the
   * <code>Cloneable</code> interface and (b) define a <code>clone</code> method
   */
