...
public interface Caret {
   ...
   *
   * @param v true if the caret should be shown, and false if the caret should be hidden
   */
   ...
   *
   * @param p the Point to use for the saved position.  This can be null to indicate there is no
   * visual location.
   */
   ...
   *
   * @param rate the delay in milliseconds &gt;=0.  If this is zero the caret will not blink.
   */
   ...
   * way to attract attention to the caret.
   *
   * @return the delay in milliseconds &gt;=0.  If this is zero the caret will not blink.
   */
