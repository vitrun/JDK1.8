 ...
 * toplevel window which has no system border or controls.
 * @see JRootPane
 */
...
public class JWindow extends Window implements Accessible,
   ...
   * returned by <code>JComponent.getDefaultLocale</code>.
   *
   * @param gc the <code>GraphicsConfiguration</code> that is used to construct the new window with;
   * if gc is <code>null</code>, the system default <code>GraphicsConfiguration</code> is assumed
   * @throws HeadlessException If <code>GraphicsEnvironment.isHeadless()</code> returns true.
   ...
   * @param gc the <code>GraphicsConfiguration</code> that is used to construct the new window with;
   * if gc is <code>null</code>, the system default <code>GraphicsConfiguration</code> is assumed,
   * unless <code>owner</code> is also null, in which case the <code>GraphicsConfiguration</code>
   ...
   * should operate directly on the <code>JWindow</code>.
   ...
   * <code>null</code>
   * @beaninfo hidden: true description: The client area of the window where child components are
   * normally inserted.
   * @see #getContentPane
...
////////////////
   ...
   *
   * @return an AccessibleJWindow that serves as the AccessibleContext of this JWindow
   */
