...
public class DefaultListSelectionModel implements ListSelectionModel, Cloneable, Serializable {
   ...
   *
   * @return all of this model's <code>ListSelectionListener</code>s or an empty array if no list
   ...
   * you can query a <code>DefaultListSelectionModel</code> instance <code>m</code> for its list
   * selection listeners with the following code:
   *
   ...
   *
   * @throws CloneNotSupportedException if the selection model does not both (a) implement the
