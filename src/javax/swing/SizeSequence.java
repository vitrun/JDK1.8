...
public class SizeSequence {
   ...
   *
   * @param sizes the array of sizes to be contained in the <code>SizeSequence</code>
   */
   ...
   *
   * @param sizes the array of sizes to be contained in this <code>SizeSequence</code>
   */
   ...
   * may be thrown.
   *
   * @param start the index to be assigned to the first entry in the group
   * @param length the number of entries in the group
   * @param value the size to be assigned to each new entry
   * @throws ArrayIndexOutOfBoundsException if the parameters are outside of the range: (<code>0
   * &lt;= start &lt; (getSizes().length)) AND (length &gt;= 0)</code>
   */
