...
final class SplitPaneDividerPainter extends AbstractRegionPainter {
  ...
  private Paint decodeGradient1(Shape s) {
    ...
    return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y,
        new float[]{0.058064517f, 0.08064516f, 0.103225805f, 0.116129026f, 0.12903225f, 0.43387097f,
            0.7387097f, 0.77903223f, 0.81935483f, 0.85806453f, 0.8967742f},
        new Color[]{color1,
  ...
  private Paint decodeGradient2(Shape s) {
    ...
    float h = (float) bounds.getHeight();
    return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y,
        new float[]{0.058064517f, 0.08064516f, 0.103225805f, 0.1166129f, 0.13f, 0.43f, 0.73f,
