...
final class ToolBarButtonPainter extends AbstractRegionPainter {
  ...
  private Path2D decodePath1() {
    ...
    path.curveTo(decodeAnchorX(2.9000000953674316f, 0.0f), decodeAnchorY(1.95652174949646f, 3.0f),
        decodeAnchorX(1.9893617630004883f, 3.0f), decodeAnchorY(2.8714287281036377f, 0.0f),
    ...
    path.curveTo(decodeAnchorX(1.9893617630004883f, 2.071428571428598f),
        ...
        decodeAnchorY(1.95652174949646f, 2.2142857142857046f), decodeX(2.5f), decodeY(1.9565217f));
