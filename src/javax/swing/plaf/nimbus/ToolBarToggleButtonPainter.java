...
final class ToolBarToggleButtonPainter extends AbstractRegionPainter {
  ...
  private Path2D decodePath1() {
    ...
    path.curveTo(decodeAnchorX(1.9893617630004883f, 3.0f),
        ...
        decodeAnchorY(1.0416666269302368f, -3.0f), decodeX(2.8857148f), decodeY(1.0416666f));
    ...
    path.curveTo(decodeAnchorX(2.9000000953674316f, 0.0f), decodeAnchorY(1.9166667461395264f, 3.0f),
        decodeAnchorX(1.9893617630004883f, 3.0f), decodeAnchorY(2.671428680419922f, 0.0f),
        decodeX(1.9893618f), decodeY(2.6714287f));
    ...
    path.curveTo(decodeAnchorX(1.0106383562088013f, -3.0f), decodeAnchorY(2.671428680419922f, 0.0f),
        decodeAnchorX(0.12000000476837158f, 0.0f), decodeAnchorY(1.9166667461395264f, 3.0f),
    ...
    path.curveTo(decodeAnchorX(0.12000000476837158f, 0.0f),
        ...
        decodeAnchorX(1.0106383562088013f, -3.0f), decodeAnchorY(0.12000000476837158f, 0.0f),
        decodeX(1.0106384f), decodeY(0.120000005f));
    ...
    path.curveTo(decodeAnchorX(2.5142853260040283f, 0.0f),
        ...
        decodeAnchorY(0.4714285731315613f, 0.0f), decodeX(1.9901216f), decodeY(0.47142857f));
    path.lineTo(decodeX(1.4148936f), decodeY(0.4857143f));
