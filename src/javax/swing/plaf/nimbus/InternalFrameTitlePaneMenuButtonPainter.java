...
final class InternalFrameTitlePaneMenuButtonPainter extends AbstractRegionPainter {
  ...
  private Color color1 = decodeColor("nimbusBlueGrey", 0.0055555105f, -0.0029994324f, -0.38039216f,
      -185);
  ...
  private Color color11 = decodeColor("nimbusBlueGrey", 0.0055555105f, -0.0029994324f, -0.38039216f,
      -208);
