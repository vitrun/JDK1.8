...
final class RadioButtonPainter extends AbstractRegionPainter {
  ...
  private Color color53 = decodeColor("nimbusBlueGrey", -0.01111114f, -0.058170296f, 0.0039215684f,
      0);
  private Color color54 = decodeColor("nimbusBlueGrey", -0.013888836f, -0.04195489f, -0.058823526f,
      0);
  private Color color55 = decodeColor("nimbusBlueGrey", 0.009259284f, -0.0147816315f, -0.007843137f,
      0);
  ...
  private Paint decodeGradient2(Shape s) {
    ...
    return decodeGradient((0.49754903f * w) + x, (0.004901961f * h) + y, (0.50735295f * w) + x,
        (1.0f * h) + y,
        new float[]{0.06344411f, 0.21601209f, 0.36858007f, 0.54833835f, 0.72809666f, 0.77492446f,
            0.82175225f, 0.91087615f, 1.0f},
        new Color[]{color3,
  ...
  private Paint decodeGradient4(Shape s) {
    ...
    return decodeGradient((0.49754903f * w) + x, (0.004901961f * h) + y, (0.50735295f * w) + x,
        (1.0f * h) + y,
        new float[]{0.06344411f, 0.25009555f, 0.43674698f, 0.48042166f, 0.52409637f, 0.70481926f,
            0.88554215f},
        new Color[]{color10,
  ...
  private Paint decodeGradient8(Shape s) {
    ...
    return decodeGradient((0.49754903f * w) + x, (0.004901961f * h) + y, (0.50735295f * w) + x,
        (1.0f * h) + y,
        new float[]{0.06344411f, 0.20792687f, 0.35240963f, 0.45030123f, 0.5481928f, 0.748494f,
            0.9487952f},
        new Color[]{color22,
  ...
  private Paint decodeGradient10(Shape s) {
    ...
    return decodeGradient((0.49754903f * w) + x, (0.004901961f * h) + y, (0.50735295f * w) + x,
        (1.0f * h) + y,
        new float[]{0.0813253f, 0.100903615f, 0.12048193f, 0.28915662f, 0.45783132f, 0.6159638f,
            0.77409637f, 0.82981926f, 0.88554215f},
        new Color[]{color27,
  ...
  private Paint decodeGradient13(Shape s) {
    ...
    return decodeGradient((0.49754903f * w) + x, (0.004901961f * h) + y, (0.50735295f * w) + x,
        (1.0f * h) + y,
        new float[]{0.039156627f, 0.07831325f, 0.11746988f, 0.2876506f, 0.45783132f, 0.56174695f,
            0.66566265f, 0.7756024f, 0.88554215f},
        new Color[]{color36,
  ...
  private Paint decodeGradient16(Shape s) {
    ...
    return decodeGradient((0.49754903f * w) + x, (0.004901961f * h) + y, (0.50735295f * w) + x,
        (1.0f * h) + y,
        new float[]{0.0813253f, 0.100903615f, 0.12048193f, 0.20180723f, 0.28313252f, 0.49246985f,
            0.7018072f, 0.7560241f, 0.810241f, 0.84789157f, 0.88554215f},
        new Color[]{color43,
