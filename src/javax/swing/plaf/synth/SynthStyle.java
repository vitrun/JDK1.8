...
public abstract class SynthStyle {
   ...
   *
   * @param context SynthContext identifying component to install properties to.
   */
   ...
   * @param context SynthContext identifying requester
   * @param key Property being requested.
   * @param defaultValue Value to return if the property has not been specified, or is not a Number
   * @return Value of the named property
   */
   ...
   * @param context SynthContext identifying requester
   * @param key Property being requested.
   * @param defaultValue Value to return if the property has not been specified, or is not a
   * Boolean
   * @return Value of the named property
   */
   ...
   * @param context SynthContext identifying requester
   * @param key Property being requested.
   * @param defaultValue Value to return if the property has not been specified, or is not a String
   * @return Value of the named property
   */
