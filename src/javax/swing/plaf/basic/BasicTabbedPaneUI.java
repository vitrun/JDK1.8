...
// UI Installation/De-installation
   ...
   *
   * @param direction One of the SwingConstants constants: SOUTH, NORTH, EAST or WEST
  ...
  private void addMnemonic(int index, int mnemonic) {
    ...
    mnemonicInputMap
        .put(KeyStroke.getKeyStroke(mnemonic, BasicLookAndFeel.getFocusAcceleratorKeyMask()),
            "setSelectedIndex");
   ...
   * longer over any tab.
   *
   * @return the tab the mouse is currently over, or {@code -1} if the mouse is no longer over any
   * tab
   * @since 1.5
   */
...
// UI Rendering
  ...
  protected int getTabLabelShiftY(int tabPlacement, int tabIndex, boolean isSelected) {
    Rectangle tabRect = rects[tabIndex];
    int nudge = (isSelected ? DefaultLookup
        .getInt(tabPane, this, "TabbedPane.selectedLabelShift", -1) :
