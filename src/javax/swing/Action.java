...
public interface Action extends ActionListener {
  ...
  /**
   * The key used for storing an <code>Integer</code> that corresponds to one of the
   * <code>KeyEvent</code> key codes.  The value is commonly used to specify a mnemonic.  For
   * example: <code>myAction.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_A)</code> sets the mnemonic
   * of <code>myAction</code> to 'a', while <code>myAction.putValue(Action.MNEMONIC_KEY,
   * KeyEvent.getExtendedKeyCodeForChar('\u0444'))</code> sets the mnemonic of <code>myAction</code>
