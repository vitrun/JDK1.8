...
public class ScrollPaneLayout
   ...
   * @throws IllegalArgumentException if <code>x</code> is an invalid vertical scroll bar policy, as
   * listed above
   */
   ...
   * @throws IllegalArgumentException if <code>x</code> is not a valid horizontal scrollbar policy,
   * as listed above
   */
   ...
   * @return the <code>Component</code> at the specified corner, as defined in {@link
   * ScrollPaneConstants}; if <code>key</code> is not one of the four corners, <code>null</code> is
   * returned
   ...
   * @return a <code>Dimension</code> object specifying the preferred size of the viewport and any
   * scrollbars
   * @see ViewportLayout
   * @see LayoutManager
   */
   ...
   * @deprecated As of JDK version Swing1.1 replaced by <code>JScrollPane.getViewportBorderBounds()</code>.
   */
  @Deprecated
