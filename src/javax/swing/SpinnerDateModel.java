...
public class SpinnerDateModel extends AbstractSpinnerModel implements Serializable {
   ...
   * @param calendarField one of <ul> <li><code>Calendar.ERA</code> <li><code>Calendar.YEAR</code>
   * <li><code>Calendar.MONTH</code> <li><code>Calendar.WEEK_OF_YEAR</code>
   * <li><code>Calendar.WEEK_OF_MONTH</code> <li><code>Calendar.DAY_OF_MONTH</code>
   * <li><code>Calendar.DAY_OF_YEAR</code> <li><code>Calendar.DAY_OF_WEEK</code>
   * <li><code>Calendar.DAY_OF_WEEK_IN_MONTH</code> <li><code>Calendar.AM_PM</code>
   * <li><code>Calendar.HOUR</code> <li><code>Calendar.HOUR_OF_DAY</code>
   * <li><code>Calendar.MINUTE</code> <li><code>Calendar.SECOND</code>
   * <li><code>Calendar.MILLISECOND</code> </ul>
   * @throws IllegalArgumentException if <code>value</code> or <code>calendarField</code> are
   * <code>null</code>, if <code>calendarField</code> isn't valid, or if the following expression is
   ...
   * <li><code>Calendar.HOUR</code> <li><code>Calendar.HOUR_OF_DAY</code>
   * <li><code>Calendar.MINUTE</code> <li><code>Calendar.SECOND</code>
   * <li><code>Calendar.MILLISECOND</code> </ul> <p> This method fires a <code>ChangeEvent</code> if
   * the <code>calendarField</code> has changed.
   ...
   *
   * @return the next <code>Date</code> in the sequence, or <code>null</code> if the next date is
   * after <code>end</code>.
   ...
   *
   * @return the previous <code>Date</code> in the sequence, or <code>null</code> if the previous
   * date is before <code>start</code>
