...
///////////////////////////////////////////////////////////////////////////////
   ...
   * are underneath.)
   *
   * @param type an integer specifying either <code>BevelBorder.LOWERED</code> or
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @return the {@code Border} object or {@code null} if the specified type is not valid
...
//// EtchedBorder ///////////////////////////////////////////////////////////
   ...
   * highlighting and shading.
   *
   * @param type one of <code>EtchedBorder.RAISED</code>, or <code>EtchedBorder.LOWERED</code>
   * @return the <code>Border</code> object
   * @throws IllegalArgumentException if type is not either <code>EtchedBorder.RAISED</code> or
...
//// TitledBorder ////////////////////////////////////////////////////////////
   ...
   * font and text color (determined by the current look and feel).
   *
   * @param border the <code>Border</code> object to add the title to; if <code>null</code> the
   ...
   * @param border the <code>Border</code> object to add the title to
   * @param title a <code>String</code> containing the text of the title
   * @param titleJustification an integer specifying the justification of the title -- one of the
   * following: <ul> <li><code>TitledBorder.LEFT</code> <li><code>TitledBorder.CENTER</code>
   * <li><code>TitledBorder.RIGHT</code> <li><code>TitledBorder.LEADING</code>
   * <li><code>TitledBorder.TRAILING</code> <li><code>TitledBorder.DEFAULT_JUSTIFICATION</code>
   * (leading) </ul>
   * @param titlePosition an integer specifying the vertical position of the text in relation to the
   * border -- one of the following: <ul> <li><code> TitledBorder.ABOVE_TOP</code>
   * <li><code>TitledBorder.TOP</code> (sitting on the top line) <li><code>TitledBorder.BELOW_TOP</code>
   * <li><code>TitledBorder.ABOVE_BOTTOM</code> <li><code>TitledBorder.BOTTOM</code> (sitting on the
   * bottom line) <li><code>TitledBorder.BELOW_BOTTOM</code> <li><code>TitledBorder.DEFAULT_POSITION</code>
   * (the title position is determined by the current look and feel) </ul>
   * @return the <code>TitledBorder</code> object
   */
  public static TitledBorder createTitledBorder(Border border,
      String title,
...
//// CompoundBorder ////////////////////////////////////////////////////////
   ...
   *
   * @param outsideBorder a <code>Border</code> object for the outer edge of the compound border
   * @param insideBorder a <code>Border</code> object for the inner edge of the compound border
   * @return the <code>CompoundBorder</code> object
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @return the {@code Border} object
   * @throws IllegalArgumentException if the specified {@code length} is less than {@code 1}, or if
   ...
   * if the specified {@code length} is less than {@code 1}, or if the specified {@code spacing} is
   * less than {@code 0}
   * @since 1.7
   */
  public static Border createDashedBorder(Paint paint, float thickness, float length, float spacing,
      boolean rounded) {
    boolean shared =
        !rounded && (paint == null) && (thickness == 1.0f) && (length == 1.0f) && (spacing == 1.0f);
