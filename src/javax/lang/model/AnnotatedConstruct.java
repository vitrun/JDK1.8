...
public interface AnnotatedConstruct {
   ...
   * this construct.
   *
   * @return the annotations <em>directly present</em> on this construct; an empty list if there are
   * none
   */
   ...
   * @return this construct's annotation for the specified annotation type if present, else {@code
   * null}
   ...
   * @param <A> the annotation type
   * @param annotationType the {@code Class} object corresponding to the annotation type
   * @return this construct's annotations for the specified annotation type if present on this
   * construct, else an empty array
   * @jls 9.6 Annotation Types
   * @jls 9.6.1 Annotation Type Elements
   * @see #getAnnotationMirrors()
