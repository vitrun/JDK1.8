 ...
 * </pre>
 *
 * @param <BoundType> The type that JAXB doesn't know how to handle. An adapter is written to allow
 * this type to be used as an in-memory representation through the <tt>ValueType</tt>.
 * @param <ValueType> The type that JAXB knows how to handle out of the box.
 * @author <ul><li>Sekhar Vajjhala, Sun Microsystems Inc.</li> <li> Kohsuke Kawaguchi, Sun
