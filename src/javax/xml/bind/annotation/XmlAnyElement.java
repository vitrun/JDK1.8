 ...
 * instance of a JAXB annotated class. It typically annotates a multi-valued JavaBean property, but
 * it can occur on single value JavaBean property. During unmarshalling, each xml element that does
 * not match a static &#64;XmlElement or &#64;XmlElementRef annotation for the other JavaBean
 ...
 * </pre>
 *
 * <h2>Restriction usage constraints</h2> <p> This annotation is mutually exclusive with {@link
 * XmlElement}, {@link XmlAttribute}, {@link XmlValue}, {@link XmlElements}, {@link XmlID}, and
 * {@link XmlIDREF}.
 *
 * <p> There can be only one {@link XmlAnyElement} annotated JavaBean property in a class and its
 * super classes.
 *
 * <h2>Relationship to other annotations</h2> <p> This annotation can be used with {@link
 * XmlJavaTypeAdapter}, so that users can map their own data structure to DOM, which in turn can be
 * composed into XML.
 *
 ...
 *   &lt;b>3</b>
 *   &lt;e:other />
 *   &lt;c>5</c>     // this will be bound to DOM, because the annotation doesn't remember
 * namespaces.
 * &lt;/foo>
 * </pre>
 *
 ...
 *
 *
 * <h2>Using {@link XmlAnyElement} with {@link XmlElementRef}</h2> <p> The {@link XmlAnyElement}
 * annotation can be used with {@link XmlElementRef}s to designate additional elements that can
 * participate in the content tree.
 *
 ...
 *
 *
 * <h2>W3C XML Schema "lax" wildcard emulation</h2> The lax element of the annotation enables the
 * emulation of the "lax" wildcard semantics. For example, when the Java source code is annotated
 * like this:
 * <pre>
 * &#64;{@link XmlRootElement}
 * class Foo {
