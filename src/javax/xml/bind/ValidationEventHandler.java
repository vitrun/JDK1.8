...
public interface ValidationEventHandler {
   ...
   *
   * @param event the encapsulated validation event information.  It is a provider error if this
   * parameter is null.
   * @return true if the JAXB Provider should attempt to continue the current unmarshal, validate,
   * or marshal operation after handling this warning/error, false if the provider should terminate
   * the current operation with the appropriate <tt>UnmarshalException</tt>,
