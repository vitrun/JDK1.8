...
public interface AlgorithmMethod {
   ...
   *
   * @return the algorithm parameters of this <code>AlgorithmMethod</code>. Returns
   * <code>null</code> if this <code>AlgorithmMethod</code> does not require parameters and they are
   * not specified.
   */
