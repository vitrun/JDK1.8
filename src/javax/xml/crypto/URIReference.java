...
public interface URIReference {
   ...
   *
   * @return the URI of the data object in RFC 2396 format (may be <code>null</code> if not
   * specified)
   */
  String getURI();
   ...
   *
   * @return the type (a URI) of the data object (may be <code>null</code> if not specified)
   */
  String getType();
}
