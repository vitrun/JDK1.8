...
public interface Transform extends XMLStructure, AlgorithmMethod {
   ...
   *
   * @return the algorithm-specific input parameters (may be <code>null</code> if not specified)
   */
   ...
   * @throws TransformException if an error occurs while executing the transform
   */
   ...
   * @param context the <code>XMLCryptoContext</code> containing additional context (may be
   * <code>null</code> if not applicable)
   * @param os the <code>OutputStream</code> that should be used to write the transformed data to
   * @return the transformed data (or <code>null</code> if the data was written to the
   * <code>OutputStream</code> parameter)
   * @throws NullPointerException if <code>data</code> or <code>os</code> is <code>null</code>
   * @throws TransformException if an error occurs while executing the transform
   */
