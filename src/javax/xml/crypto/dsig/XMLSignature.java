...
public interface XMLSignature extends XMLStructure {
   ...
   * @throws ClassCastException if the type of <code>validateContext</code> is not compatible with
   * this <code>XMLSignature</code>
   * @throws NullPointerException if <code>validateContext</code> is <code>null</code>
   * @throws XMLSignatureException if an unexpected error occurs during validation that prevented
   * the validation operation from completing
   */
   ...
   *
   * @return an unmodifiable list of <code>XMLObject</code>s (may be empty but never
   * <code>null</code>)
   */
   ...
   * @throws ClassCastException if the type of <code>signContext</code> is not compatible with this
   ...
   *
   * @return the key selector result, or <code>null</code> if a key selector has not been specified
   * or this <code>XMLSignature</code> has not been signed or validated
   */
  ...
  public interface SignatureValue extends XMLStructure {
     ...
     *
     * @return the signature value (may be <code>null</code> if the <code>XMLSignature</code> has
     * not been signed yet). Each invocation of this method returns a new clone of the array to
     ...
     *
     * @param validateContext the validating context
     * @return <code>true</code> if the signature was validated successfully; <code>false</code>
     * otherwise
     * @throws NullPointerException if <code>validateContext</code> is <code>null</code>
     * @throws XMLSignatureException if an unexpected exception occurs while validating the
     * signature
     */
    boolean validate(XMLValidateContext validateContext)
        throws XMLSignatureException;
