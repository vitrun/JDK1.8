...
public class DOMValidateContext extends DOMCryptoContext
   ...
   * @param node the node
   * @throws NullPointerException if <code>ks</code> or <code>node</code> is <code>null</code>
   */
   ...
   * @param node the node
   * @throws NullPointerException if <code>validatingKey</code> or <code>node</code> is
   * <code>null</code>
   */
