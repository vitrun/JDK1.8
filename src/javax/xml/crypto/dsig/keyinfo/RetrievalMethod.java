...
public interface RetrievalMethod extends URIReference, XMLStructure {
   ...
   *
   * @return an unmodifiable list of <code>Transform</code> objects (may be empty but never
   * <code>null</code>).
   */
   ...
   *
   * @return the URI of the referenced <code>KeyInfo</code> information in RFC 2396 format (never
   * <code>null</code>)
   */
  String getURI();
   ...
   *
   * @param context an <code>XMLCryptoContext</code> that may contain additional useful information
   * for dereferencing the URI. The context's <code>baseURI</code> and <code>dereferencer</code>
   * parameters (if specified) are used to resolve and dereference this
   * <code>RetrievalMethod</code>
   * @return a <code>Data</code> object representing the raw contents of the <code>KeyInfo</code>
   * information referenced by this <code>RetrievalMethod</code>. It is the caller's responsibility
   * to convert the returned data to an appropriate <code>KeyInfo</code> object.
