...
public final class ExcC14NParameterSpec implements C14NMethodParameterSpec {
   ...
   * modification.
   *
   * @param prefixList the inclusive namespace prefix list. Each entry in the list is a
   * <code>String</code> that represents a namespace prefix.
   * @throws NullPointerException if <code>prefixList</code> is <code>null</code>
   * @throws ClassCastException if any of the entries in the list are not of type
   * <code>String</code>
   */
   ...
   *
   * @return the inclusive namespace prefix list (may be empty but never <code>null</code>)
   */
  @SuppressWarnings("rawtypes")
