...
public interface Reference extends URIReference, XMLStructure {
   ...
   * <code>Reference</code>.
   *
   * @return an unmodifiable list of <code>Transform</code>s (may be empty but never
   * <code>null</code>)
   */
   ...
   *
   * @return the raw digest value, or <code>null</code> if this reference has not been digested yet.
   * Each invocation of this method returns a new clone to protect against subsequent modification.
   */
  byte[] getDigestValue();
   ...
   *
   * @return the calculated digest value, or <code>null</code> if this reference has not been
   * validated yet. Each invocation of this method returns a new clone to protect against subsequent
   * modification.
   */
   ...
   * @return <code>true</code> if this reference was validated successfully; <code>false</code>
   * otherwise
   ...
   *
   * @return the dereferenced data, or <code>null</code> if reference caching is not enabled or this
   ...
   *
   * @return an input stream containing the pre-digested input, or <code>null</code> if reference
   * caching is not enabled or this reference has not been generated or validated
   */
