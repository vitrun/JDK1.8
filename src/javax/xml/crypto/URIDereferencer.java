...
public interface URIDereferencer {
   ...
   * for dereferencing the URI. This implementation should dereference the specified
   * <code>URIReference</code> against the context's <code>baseURI</code> parameter, if specified.
   * @return the dereferenced data
   * @throws NullPointerException if <code>uriReference</code> or <code>context</code> are
   * <code>null</code>
   * @throws URIReferenceException if an exception occurs while dereferencing the specified
