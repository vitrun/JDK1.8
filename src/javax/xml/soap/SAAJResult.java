...
public class SAAJResult extends DOMResult {
   ...
   * @throws SOAPException if a <code>SOAPMessage</code> supporting the specified protocol cannot be
   * created
   * @since SAAJ 1.3
   */
   ...
   * specification.
   *
   * @param message - the message whose <code>SOAPPart</code> will be populated as a result of some
