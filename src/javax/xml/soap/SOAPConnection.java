...
public abstract class SOAPConnection {
   ...
   * @param to an <code>Object</code> that identifies where the message should be sent. It is
   * required to support Objects of type <code>java.lang.String</code>, <code>java.net.URL</code>,
   * and when JAXM is present <code>javax.xml.messaging.URLEndpoint</code>
   * @return the <code>SOAPMessage</code> object that is the response to the message that was sent
   ...
   *
   * @param to an <code>Object</code> that identifies where the request should be sent. Objects of
   * type <code>java.lang.String</code> and <code>java.net.URL</code> must be supported.
   * @return the <code>SOAPMessage</code> object that is the response to the get message request
   * @throws SOAPException if there is a SOAP error
   * @since SAAJ 1.3
   */
