...
public final class XMLConstants {
   ...
   *
   * <ul> <li> {@code true} instructs the implementation to process XML securely. This may set
   * limits on XML constructs to avoid conditions such as denial of service attacks. </li> <li>
   * {@code false} instructs the implementation to process XML in accordance with the XML
   * specifications ignoring security issues such as limits on XML constructs to avoid conditions
   * such as denial of service attacks. </li> </ul>
   */
