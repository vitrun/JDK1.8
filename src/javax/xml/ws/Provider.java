...
public interface Provider<T> {
   ...
   * @return The response message or message payload. May be <code>null</code> if there is no
   * response.
   * @throws WebServiceException If there is an error processing request. The cause of the
   * <code>WebServiceException</code> may be set to a subclass of <code>ProtocolException</code> to
   * control the protocol level representation of the exception.
