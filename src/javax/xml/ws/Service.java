...
public class Service {
   ...
   * @param serviceEndpointInterface Service endpoint interface supported by the dynamic proxy
   * instance.
   * @return Object Proxy instance that supports the specified service endpoint interface.
   * @throws WebServiceException This exception is thrown in the following cases: <UL> <LI>If there
   * is an error in creation of the proxy. <LI>If there is any missing WSDL metadata as required by
   * this method. <LI>If an illegal <code>serviceEndpointInterface</code> or <code>portName</code>
   * is specified. </UL>
   ...
   * @param serviceEndpointInterface Service endpoint interface supported by the dynamic proxy
   * instance.
   * @param features A list of WebServiceFeatures to configure on the proxy.  Supported features not
   ...
   * @return Object instance that supports the specified service endpoint interface.
   * @throws WebServiceException <UL> <LI>If there is an error during creation of the proxy. <LI>If
   * there is any missing WSDL metadata as required by this method. <LI>If an illegal
   * <code>serviceEndpointInterface</code> is specified. </UL>
   **/
   ...
   * @throws WebServiceException <UL> <LI>If there is an error during creation of the proxy. <LI>If
   * there is any missing WSDL metadata as required by this method. <LI>If an illegal
   * <code>serviceEndpointInterface</code> is specified. <LI>If a feature is enabled that is not
   * compatible with this port or is unsupported. </UL>
   * @see WebServiceFeature
   * @since JAX-WS 2.1
   **/
  public <T> T getPort(Class<T> serviceEndpointInterface,
   ...
   *
   * @param endpointReference The <code>EndpointReference</code> for the target service endpoint
   * that will be invoked by the returned proxy.
   * @param serviceEndpointInterface Service endpoint interface.
   * @param features A list of <code>WebServiceFeatures</code> to configure on the proxy.  Supported
   * features not in the <code>features </code> parameter will have their default values.
   * @return Object Proxy instance that supports the specified service endpoint interface.
   * @throws WebServiceException <UL> <LI>If there is an error during creation of the proxy. <LI>If
   * there is any missing WSDL metadata as required by this method. <LI>If the
   * <code>endpointReference</code> metadata does not match the <code>serviceName</code> of this
   * <code>Service</code> instance. <LI>If a <code>portName</code> cannot be extracted from the WSDL
   * or <code>endpointReference</code> metadata. <LI>If an invalid <code>endpointReference</code> is
   * specified. <LI>If an invalid <code>serviceEndpointInterface</code> is specified. <LI>If a
   * feature is enabled that is not compatible with this port or is unsupported. </UL>
   * @since JAX-WS 2.1
   **/
   ...
   *
   * @param portName Qualified name for the target service endpoint
   * @param type The class of object used for messages or message payloads. Implementations are
   * required to support <code>javax.xml.transform.Source</code>, <code>javax.xml.soap.SOAPMessage</code>
   * and <code>javax.activation.DataSource</code>, depending on the binding in use.
   * @param mode Controls whether the created dispatch instance is message or payload oriented, i.e.
   * whether the client will work with complete protocol messages or message payloads. E.g. when
   * using the SOAP protocol, this parameter controls whether the client will work with SOAP
   * messages or the contents of a SOAP body. Mode MUST be MESSAGE when type is SOAPMessage.
   * @return Dispatch instance.
   * @throws WebServiceException If any error in the creation of the <code>Dispatch</code> object.
   ...
   * @param portName Qualified name for the target service endpoint
   * @param type The class of object used for messages or message payloads. Implementations are
   * required to support <code>javax.xml.transform.Source</code> and <code>javax.xml.soap.SOAPMessage</code>.
   * @param mode Controls whether the created dispatch instance is message or payload oriented, i.e.
   * whether the client will work with complete protocol messages or message payloads. E.g. when
   * using the SOAP protocol, this parameter controls whether the client will work with SOAP
   * messages or the contents of a SOAP body. Mode MUST be <code>MESSAGE</code> when type is
   * <code>SOAPMessage</code>.
   * @param features A list of <code>WebServiceFeatures</code> to configure on the proxy.  Supported
   * features not in the <code>features </code> parameter will have their default values.
   * @return Dispatch instance.
   * @throws WebServiceException If any error in the creation of the <code>Dispatch</code> object or
   ...
   *
   * @param endpointReference The <code>EndpointReference</code> for the target service endpoint
   * that will be invoked by the returned <code>Dispatch</code> object.
   * @param type The class of object used to messages or message payloads. Implementations are
   * required to support <code>javax.xml.transform.Source</code> and <code>javax.xml.soap.SOAPMessage</code>.
   * @param mode Controls whether the created dispatch instance is message or payload oriented, i.e.
   * whether the client will work with complete protocol messages or message payloads. E.g. when
   * using the SOAP protocol, this parameter controls whether the client will work with SOAP
   ...
   * @return Dispatch instance
   * @throws WebServiceException <UL> <LI>If there is any missing WSDL metadata as required by this
   * method. <li>If the <code>endpointReference</code> metadata does not match the
   * <code>serviceName</code> or <code>portName</code> of a WSDL associated with this
   * <code>Service</code> instance. <li>If the <code>portName</code> cannot be determined from the
   * <code>EndpointReference</code> metadata. <li>If any error in the creation of the
   * <code>Dispatch</code> object. <li>If a feature is enabled that is not compatible with this port
   * or is unsupported. </UL>
   * @see javax.xml.transform.Source
   * @see javax.xml.soap.SOAPMessage
   * @see WebServiceFeature
   * @since JAX-WS 2.1
   ...
   * whether the client will work with complete protocol messages or message payloads. E.g. when
   * using the SOAP protocol, this parameter controls whether the client will work with SOAP
   * messages or the contents of a SOAP body.
   * @return Dispatch instance.
   * @throws WebServiceException If any error in the creation of the <code>Dispatch</code> object.
   ...
   * @throws WebServiceException If this Service class does not have access to the required WSDL
   * metadata.
   **/
   ...
   *
   * @return HandlerResolver The <code>HandlerResolver</code> being used by this
   * <code>Service</code> instance, or <code>null</code> if there isn't one.
   **/
   ...
   *
   * @param handlerResolver The <code>HandlerResolver</code> to use for all subsequently created
   * proxy/dispatch objects.
   * @see javax.xml.ws.handler.HandlerResolver
   **/
   ...
   * require callbacks.
   *
   * @return The <code>java.util.concurrent.Executor</code> to be used to invoke a callback.
   * @see java.util.concurrent.Executor
   **/
   ...
   * require callbacks.
   *
   * @param executor The <code>java.util.concurrent.Executor</code> to be used to invoke a
   * callback.
   ...
   *
   * @param wsdlDocumentLocation <code>URL</code> for the WSDL document location for the service
   ...
   * @param wsdlDocumentLocation <code>URL</code> for the WSDL document location for the service
   * @param serviceName <code>QName</code> for the service
   * @param features Web Service features that must be configured on the service. If the provider
