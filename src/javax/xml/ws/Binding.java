...
public interface Binding {
   ...
   * @throws java.lang.UnsupportedOperationException If this operation is not supported. This may be
   * done to avoid any overriding of a pre-configured handler chain.
   */
   ...
   *
   * @return String The binding identifier for the port. Never returns <code>null</code>
   * @since JAX-WS 2.1
   */
  String getBindingID();
}
