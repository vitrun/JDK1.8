...
public interface SOAPBinding extends Binding {
   ...
   *
   * @param flag A <code>boolean</code> specifying whether the use of MTOM should be enabled or
   * disabled.
   * @throws WebServiceException If the specified setting is not supported by this binding
   * instance.
   **/
