...
public final class AddressingFeature extends WebServiceFeature {
   ...
   *
   * @param enabled true enables ws-addressing i.e.ws-addressing is supported but doesn't require
   * its use
   */
   ...
   * <p>
   *
   * @return {@link Responses#ALL} when endpoint supports all types of responses, {@link
   * Responses#ANONYMOUS} when endpoint requires the use of only anonymous responses, {@link
   * Responses#NON_ANONYMOUS} when endpoint requires the use of only non-anonymous responses
   * @since JAX-WS 2.2
   */
