...
public interface XMLResolver {
   ...
   * java.io.InputStream (2) javax.xml.stream.XMLStreamReader (3) java.xml.stream.XMLEventReader. If
   * this method returns null the processor will attempt to resolve the entity using its default
   * mechanism.
   *
