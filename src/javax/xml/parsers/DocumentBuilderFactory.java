...
public abstract class DocumentBuilderFactory {
  ...
  /**
   * <p>Set a feature for this <code>DocumentBuilderFactory</code> and <code>DocumentBuilder</code>s
   * created by this factory.</p>
   *
   * <p> Feature names are fully qualified {@link java.net.URI}s. Implementations may define their
   * own features. A {@link ParserConfigurationException} is thrown if this
   * <code>DocumentBuilderFactory</code> or the <code>DocumentBuilder</code>s it creates cannot
   * support the feature. It is possible for a <code>DocumentBuilderFactory</code> to expose a
   ...
   * DocumentBuilder#setErrorHandler(org.xml.sax.ErrorHandler errorHandler)}. </li> <li>
   ...
   * @throws ParserConfigurationException if this <code>DocumentBuilderFactory</code> or the
   ...
   * <code>DocumentBuilderFactory</code> or the <code>DocumentBuilder</code>s it creates cannot
   * support the feature. It is possible for an <code>DocumentBuilderFactory</code> to expose a
   * feature value but be unable to change its state. </p>
   *
   * @param name Feature name.
