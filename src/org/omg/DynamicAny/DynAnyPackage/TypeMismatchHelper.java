...
/**
 * org/omg/DynamicAny/DynAnyPackage/TypeMismatchHelper.java . Generated by the IDL-to-Java compiler
 * (portable), version "3.2" from c:/re/workspace/8-2-build-windows-amd64-cygwin/jdk8u60/4407/corba/src/share/classes/org/omg/DynamicAny/DynamicAny.idl
      ...
      synchronized (org.omg.CORBA.TypeCode.class) {
        if (__typeCode == null) {
          ...
          __typeCode = org.omg.CORBA.ORB.init()
              .create_exception_tc(org.omg.DynamicAny.DynAnyPackage.TypeMismatchHelper.id(),
