...
/**
 * org/omg/DynamicAny/NameDynAnyPairHelper.java . Generated by the IDL-to-Java compiler (portable),
 * version "3.2" from c:/re/workspace/8-2-build-windows-amd64-cygwin/jdk8u60/4407/corba/src/share/classes/org/omg/DynamicAny/DynamicAny.idl
      ...
      synchronized (org.omg.CORBA.TypeCode.class) {
        if (__typeCode == null) {
          ...
          _tcOf_members0 = org.omg.CORBA.ORB.init()
              .create_alias_tc(org.omg.DynamicAny.FieldNameHelper.id(), "FieldName",
                  _tcOf_members0);
          ...
          __typeCode = org.omg.CORBA.ORB.init()
              .create_struct_tc(org.omg.DynamicAny.NameDynAnyPairHelper.id(), "NameDynAnyPair",
                  _members0);
          __active = false;
        }
      }
