...
/**
 * org/omg/Messaging/SyncScopeHelper.java . Generated by the IDL-to-Java compiler (portable),
 * version "3.2" from c:/re/workspace/8-2-build-windows-amd64-cygwin/jdk8u60/4407/corba/src/share/classes/org/omg/PortableInterceptor/Messaging.idl
  ...
  synchronized public static org.omg.CORBA.TypeCode type() {
    if (__typeCode == null) {
      ...
      __typeCode = org.omg.CORBA.ORB.init()
          .create_alias_tc(org.omg.Messaging.SyncScopeHelper.id(), "SyncScope", __typeCode);
    }
    return __typeCode;
  }
