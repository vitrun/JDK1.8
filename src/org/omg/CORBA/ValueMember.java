...
public final class ValueMember implements org.omg.CORBA.portable.IDLEntity {
   ...
   * <code>ValueMember</code> object.
   * @param __id The repository ID of the <code>value</code> member described by this
   * <code>ValueMember</code> object;
   * @param __defined_in The repository ID of the <code>value</code> in which this member is
   * defined.
   ...
   * @param __type_def The typedef that represents the IDL type of the <code>value</code> member
   * described by this <code>ValueMember</code> object.
   * @param __access The type of access (public, private) for the <code>value</code> member
   * described by this <code>ValueMember</code> object.
   */
