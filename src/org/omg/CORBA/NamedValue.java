...
public abstract class NamedValue {
   ...
   *
   * @return a <code>String</code> object representing the name of this <code>NamedValue</code>
   * object
   */
   ...
   *
   * @return an <code>Any</code> object containing the value of this <code>NamedValue</code> object
   */
   ...
   *
   * @return an <code>int</code> representing the argument mode for this <code>NamedValue</code>
   * object
   */
