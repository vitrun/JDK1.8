...
public final class ValueBaseHolder implements Streamable {
   ...
   *
   * @param initial the <code>java.io.Serializable</code> with which to initialize the
   * <code>value</code> field of the newly-created <code>ValueBaseHolder</code> object
   */
