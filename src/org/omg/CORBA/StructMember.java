...
public final class StructMember implements org.omg.CORBA.portable.IDLEntity {
   ...
   * given values.
   *
   * @param __name a <code>String</code> object with the name of the struct member
   * @param __type a <code>TypeCode</code> object describing the type of the struct member
   * @param __type_def an <code>IDLType</code> object representing the IDL type of the struct
   * member
   */
