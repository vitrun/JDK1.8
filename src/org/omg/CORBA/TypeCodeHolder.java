...
public final class TypeCodeHolder implements Streamable {
   ...
   *
   * @param initial the <code>TypeCode</code> object with which to initialize the <code>value</code>
   * field of the newly-created <code>TypeCodeHolder</code> object
   */
   ...
   * this <code>TypeCodeHolder</code> object.
   *
   * @return the TypeCode of the value held in this <code>TypeCodeHolder</code> object
   */
