...
public final class IntHolder implements Streamable {
   ...
   * <code>int</code>.
   *
   * @param initial the <code>int</code> with which to initialize the <code>value</code> field of
   * the newly-created <code>IntHolder</code> object
   */
   ...
   *
   * @param output the <code>OutputStream</code> object that will contain the CDR formatted data
   */
   ...
   *
   * @return the type code for the value held in this <code>IntHolder</code> object
   */
