...
public abstract class ExceptionList {
   ...
   *
   * @return the     number of <code>TypeCode</code> objects in this <code>ExceptionList</code>
   * object
   */
   ...
   * item is at index 0.
   *
   * @param index the index of the <code>TypeCode</code> object desired. This must be an
   * <code>int</code> between 0 and the number of <code>TypeCode</code> objects minus one,
   * inclusive.
   * @return the <code>TypeCode</code> object  at the given index
   * @throws org.omg.CORBA.Bounds if the index given is greater than or equal to the number of
   * <code>TypeCode</code> objects in this <code>ExceptionList</code> object
   */
   ...
   *
   * @param index the index of the <code>TypeCode</code> object to be removed. This must be an
   * <code>int</code> between 0 and the number of <code>TypeCode</code> objects minus one,
   * inclusive.
   * @throws org.omg.CORBA.Bounds if the index is greater than or equal to the number of
   * <code>TypeCode</code> objects in this <code>ExceptionList</code> object
   */
