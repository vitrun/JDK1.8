...
public abstract class NVList {
   ...
   *
   * @return an <code>int</code> indicating the number of <code>NamedValue</code> objects in this
   * <code>NVList</code>.
   */
   ...
   *
   * @param item_name the name for the new <code>NamedValue</code> object
   * @param val an <code>Any</code> object containing the  value for the new <code>NamedValue</code>
   * object
   * @param flags one of the following argument passing modes: <code>ARG_IN.value</code>,
   ...
   *
   * @param index the index of the desired <code>NamedValue</code> object, which must be between
   * zero and the length of the list minus one, inclusive.  The first item is at index zero.
   * @return the <code>NamedValue</code> object at the given index
   * @throws org.omg.CORBA.Bounds if the index is greater than or equal to number of
   ...
   *
   * @param index the index of the <code>NamedValue</code> object to be removed, which must be
   * between zero and the length of the list minus one, inclusive. The first item is at index zero.
   * @throws org.omg.CORBA.Bounds if the index is greater than or equal to number of
