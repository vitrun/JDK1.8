...
public final class CompletionStatus implements org.omg.CORBA.portable.IDLEntity {
   ...
   *
   * @return one of the possible <code>CompletionStatus</code> values: <code>_COMPLETED_YES</code>,
   * <code>_COMPLETED_NO</code>, or <code>_COMPLETED_MAYBE</code>
   */
  public int value() {
    return _value;
  }
   ...
   * @return one of the possible <code>CompletionStatus</code> objects with values:
   * <code>_COMPLETED_YES</code>, <code>_COMPLETED_NO</code>, or <code>_COMPLETED_MAYBE</code>
   * @throws org.omg.CORBA.BAD_PARAM if the argument given is not one of the <code>int</code>
