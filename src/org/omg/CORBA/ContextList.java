...
public abstract class ContextList {
   ...
   *
   * @return an <code>int</code> representing the number of <code>String</code>s in this
   * <code>ContextList</code> object
   */
   ...
   *
   * @param index the index of the string desired, with 0 being the index of the first string
   * @return the string at the given index
   * @throws org.omg.CORBA.Bounds if the index is greater than or equal to the number of strings in
   ...
   * shifted down by one.
   *
   * @param index the index of the <code>String</code> object to be removed, with 0 designating the
   * first string
   * @throws org.omg.CORBA.Bounds if the index is greater than or equal to the number of
   * <code>String</code> objects in this <code>ContextList</code> object
   */
