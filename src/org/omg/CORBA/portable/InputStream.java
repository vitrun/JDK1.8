...
public abstract class InputStream extends java.io.InputStream {
  ...
  /**
   * @see <a href="package-summary.html#unimpl"><code>portable</code> package comments for
   ...
   *
   * @param clz The Class object for the stub class which corresponds to the type that is
   * statistically expected, or the Class object for the RMI/IDL interface type that is
