...
/**
 * org/omg/CORBA/PolicyErrorCodeHelper.java . Generated by the IDL-to-Java compiler (portable),
 * version "3.2" from c:/re/workspace/8-2-build-windows-amd64-cygwin/jdk8u60/4407/corba/src/share/classes/org/omg/PortableInterceptor/CORBAX.idl
  ...
  synchronized public static org.omg.CORBA.TypeCode type() {
    if (__typeCode == null) {
      ...
      __typeCode = org.omg.CORBA.ORB.init()
          .create_alias_tc(org.omg.CORBA.PolicyErrorCodeHelper.id(), "PolicyErrorCode", __typeCode);
    }
    return __typeCode;
  }
