...
public final class ByteHolder implements Streamable {
   ...
   * <code>byte</code>.
   *
   * @param initial the <code>byte</code> with which to initialize the <code>value</code> field of
   * the new <code>ByteHolder</code> object
   */
   ...
   * this <code>ByteHolder</code> object.
   *
   * @return the TypeCode of the value held in this <code>ByteHolder</code> object
   */
