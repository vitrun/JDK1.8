...
public abstract class Context {
   ...
   *
   * @return the <code>Context</code> object that is the parent of this <code>Context</code> object
   */
   ...
   * so on.
   *
   * @param child_ctx_name the <code>String</code> object to be set as the name of the new
   * <code>Context</code> object
   * @return the newly-created child <code>Context</code> object initialized with the specified name
   */
   ...
   * @param propvalue the <code>Any</code> object to which the value of the property will be set.
   * The <code>Any</code> object's <code>value</code> field contains the value to be associated with
   * the given propname; the <code>kind</code> field must be set to <code>TCKind.tk_string</code>.
   */
   ...
   *
   * @param values an NVList containing the property names and associated values to be set
   * @see #get_values
   ...
   * is returned.
   *
   * @param start_scope a <code>String</code> object indicating the context object level at which to
   * initiate the search for the specified properties (for example, "_USER", "_GROUP", "_SYSTEM").
   * Valid scope names are implementation-specific. If a scope name is omitted, the search begins
   * with the specified context object. If the specified scope name is not found, an exception is
   * returned.
   * @param op_flags an operation flag.  The one flag that may be specified is
   * <code>CTX_RESTRICT_SCOPE</code>. If this flag is specified, searching is limited to the
   * specified <code>start_scope</code> or this <code>Context</code> object.
   * @param pattern the property name whose values are to be retrieved. <code>pattern</code> may be
   * a name or a name with a trailing wildcard character ("*").
   * @return an <code>NVList</code> containing all the property values (in the form of
   * <code>NamedValue</code> objects) whose associated property name matches the given name or name
   * pattern
   * @see #set_values
   * @see org.omg.CORBA.NamedValue
   */
