...
public abstract class TypeCode implements IDLEntity {
   ...
   * @return <code>true</code> if the type codes are equal; <code>false</code> otherwise
   */
   ...
   * @return <code>true</code> if the given typecode is equivalent to this typecode;
   ...
   *
   * @return a <code>TypeCode</code> object with optional name and member name fields stripped out,
   ...
   * <code>TypeCode</code> object.
   *
   * @return the <code>TCKind</code> instance indicating the value of the <code>kind</code> field of
   ...
   *
   * @return the RepositoryId for this <code>TypeCode</code> object or an empty string if there is
   * no RepositoryID
   * @throws org.omg.CORBA.TypeCodePackage.BadKind if the method is invoked on an inappropriate kind
   * of<code>TypeCode</code> object
   */
   ...
   *
   * @return the name identifying this <code>TypeCode</code> object or an empty string
   * @throws org.omg.CORBA.TypeCodePackage.BadKind if the method is invoked on an inappropriate kind
   * of<code>TypeCode</code> object
   */
   ...
   *
   * @return the number of members constituting the type described by this <code>TypeCode</code>
   * object
   * @throws org.omg.CORBA.TypeCodePackage.BadKind if the method is invoked on an inappropriate kind
   * of <code>TypeCode</code> object
   */
   ...
   * @return simple name of the member identified by the index or an empty string
   * @throws org.omg.CORBA.TypeCodePackage.Bounds if the index is equal to or greater than the
   * number of members constituting the type
   * @throws org.omg.CORBA.TypeCodePackage.BadKind if the method is invoked on an inappropriate kind
   * of <code>TypeCode</code> object
   */
   ...
   * operate on exceptions as well.
   *
   * @param index index of the member for which type information is begin requested
   * @return the <code>TypeCode</code> object describing the member at the given index
   * @throws org.omg.CORBA.TypeCodePackage.Bounds if the index is equal to or greater than the
   * number of members constituting the type
   * @throws org.omg.CORBA.TypeCodePackage.BadKind if the method is invoked on an inappropriate kind
   * of <code>TypeCode</code> object
   ...
   * <code>TypeCode</code> objects.
   *
   * @param index index of the union member for which the label is being requested
   * @return an <code>Any</code> object describing the label of the requested union member or the
   * zero octet for the default member
   * @throws org.omg.CORBA.TypeCodePackage.Bounds if the index is equal to or greater than the
   * number of members constituting the union
   * @throws org.omg.CORBA.TypeCodePackage.BadKind if the method is invoked on a non-union
   * <code>TypeCode</code> object
   */
   ...
   *
   * @return the <code>TypeCode</code> object describing the non-default member labels
   * @throws org.omg.CORBA.TypeCodePackage.BadKind if the method is invoked on a non-union
   * <code>TypeCode</code> object
   */
   ...
   * <code>TypeCode</code> objects.
   *
   * @return the index of the default member, or -1 if there is no default member
   * @throws org.omg.CORBA.TypeCodePackage.BadKind if the method is invoked on a non-union
   * <code>TypeCode</code> object
   */
   ...
   *
   * @return the bound for strings and sequences, or the number of elements for arrays
   * @throws org.omg.CORBA.TypeCodePackage.BadKind if the method is invoked on an inappropriate kind
   * of <code>TypeCode</code> object
   */
   ...
   *
   * @return a <code>TypeCode</code> object representing the element type for sequences and arrays,
   * the original type for aliases, or the boxed type for boxed valuetypes.
   * @throws org.omg.CORBA.TypeCodePackage.BadKind if the method is invoked on an inappropriate kind
   * of <code>TypeCode</code> object
   */
   ...
   * @throws org.omg.CORBA.TypeCodePackage.BadKind if this method is invoked on an inappropriate
   * kind of <code>TypeCode</code> object
   */
   ...
   *
   * @return the scale of the fixed type that this <code>TypeCode</code> object describes
   * @throws org.omg.CORBA.TypeCodePackage.BadKind if this method is invoked on an inappropriate
   * kind of <code>TypeCode</code> object
   */
   ...
   * <code>TypeCode</code> objects.
   *
   * @param index an <code>int</code> indicating the index into the value
   * @return either <code>PRIVATE_MEMBER.value</code> or <code>PUBLIC_MEMBER.value</code>
   * @throws org.omg.CORBA.TypeCodePackage.BadKind if this method is invoked on a non-value type
   * <code>TypeCode</code> object
   ...
   *
   * @return a constant describing the value type that this <code>TypeCode</code> object describes
   * @throws org.omg.CORBA.TypeCodePackage.BadKind if this method is invoked on a non-value type
   * <code>TypeCode</code> object
   * @see <a href="package-summary.html#unimpl"><code>CORBA</code> package comments for
   * unimplemented features</a>
   ...
   *
   * @return the <code>TypeCode</code> object that describes the concrete base type of the value
   * type that this <code>TypeCode</code> object describes
   * @throws org.omg.CORBA.TypeCodePackage.BadKind if this method is invoked on a non-boxed value
   * type <code>TypeCode</code> object
   * @see <a href="package-summary.html#unimpl"><code>CORBA</code> package comments for
   * unimplemented features</a>
   */
