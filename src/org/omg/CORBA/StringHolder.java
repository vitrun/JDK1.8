...
public final class StringHolder implements Streamable {
   ...
   * <code>String</code>.
   *
   * @param initial the <code>String</code> with which to initialize the <code>value</code> field of
   * the newly-created <code>StringHolder</code> object
   */
   ...
   *
   * @return the type code of the value held in this <code>StringHolder</code> object
   */
