...
public final class UnionMember implements org.omg.CORBA.portable.IDLEntity {
   ...
   * to the given values.
   *
   * @param __name a <code>String</code> object with the name of this <code>UnionMember</code>
   * object
   * @param __label an <code>Any</code> object with the label of this <code>UnionMember</code>
   * object
   * @param __type a <code>TypeCode</code> object describing the type of this
   * <code>UnionMember</code> object
   * @param __type_def an <code>IDLType</code> object that represents the IDL type of this
   * <code>UnionMember</code> object
   */
