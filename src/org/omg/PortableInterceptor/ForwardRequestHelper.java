...
/**
 * org/omg/PortableInterceptor/ForwardRequestHelper.java . Generated by the IDL-to-Java compiler
      ...
      synchronized (org.omg.CORBA.TypeCode.class) {
        if (__typeCode == null) {
          ...
          __typeCode = org.omg.CORBA.ORB.init()
              .create_exception_tc(org.omg.PortableInterceptor.ForwardRequestHelper.id(),
