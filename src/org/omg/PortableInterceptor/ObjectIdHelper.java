...
/**
 * org/omg/PortableInterceptor/ObjectIdHelper.java . Generated by the IDL-to-Java compiler
  ...
  synchronized public static org.omg.CORBA.TypeCode type() {
    if (__typeCode == null) {
      ...
      __typeCode = org.omg.CORBA.ORB.init()
          .create_alias_tc(org.omg.CORBA.OctetSeqHelper.id(), "OctetSeq", __typeCode);
      __typeCode = org.omg.CORBA.ORB.init()
          .create_alias_tc(org.omg.PortableInterceptor.ObjectIdHelper.id(), "ObjectId", __typeCode);
    }
    return __typeCode;
  }
