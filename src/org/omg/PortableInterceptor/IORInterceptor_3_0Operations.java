...
/**
 * org/omg/PortableInterceptor/IORInterceptor_3_0Operations.java . Generated by the IDL-to-Java
 * compiler (portable), version "3.2" from c:/re/workspace/8-2-build-windows-amd64-cygwin/jdk8u60/4407/corba/src/share/classes/org/omg/PortableInterceptor/Interceptors.idl
...
public interface IORInterceptor_3_0Operations extends
   ...
   *
   * @param id the adapter manager id of the adapter manager that changed state
   ...
   * instances.
   *
   * @param templates the sequence of <code>ObjectReferenceTemplate</code> instances on which this
