...
/**
 * org/omg/IOP/TaggedProfileHelper.java . Generated by the IDL-to-Java compiler (portable), version
      ...
      synchronized (org.omg.CORBA.TypeCode.class) {
        if (__typeCode == null) {
          ...
          _tcOf_members0 = org.omg.CORBA.ORB.init()
              .create_alias_tc(org.omg.IOP.ProfileIdHelper.id(), "ProfileId", _tcOf_members0);
          ...
          __typeCode = org.omg.CORBA.ORB.init()
              .create_struct_tc(org.omg.IOP.TaggedProfileHelper.id(), "TaggedProfile", _members0);
          __active = false;
        }
      }
    }
