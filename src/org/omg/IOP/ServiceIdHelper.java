...
/**
 * org/omg/IOP/ServiceIdHelper.java . Generated by the IDL-to-Java compiler (portable), version
  ...
  synchronized public static org.omg.CORBA.TypeCode type() {
    if (__typeCode == null) {
      ...
      __typeCode = org.omg.CORBA.ORB.init()
          .create_alias_tc(org.omg.IOP.ServiceIdHelper.id(), "ServiceId", __typeCode);
    }
    return __typeCode;
  }
