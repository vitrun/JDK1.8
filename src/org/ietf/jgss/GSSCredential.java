...
public interface GSSCredential extends Cloneable {
   ...
   *
   * @param mech the Oid of the mechanism for which the Mechanism Name should be returned.
   * @return a GSSName representing the entity canonicalized for the desired mechanism
   ...
   *
   * @return the minimum remaining lifetime in seconds for this credential. A return value of {@link
   * #INDEFINITE_LIFETIME INDEFINITE_LIFETIME} indicates that the credential does not expire. A
   * return value of 0 indicates that the credential is already expired.
   * @throws GSSException containing the following major error codes: {@link GSSException#FAILURE
   * GSSException.FAILURE}
   ...
   * specified mechanism.
   *
   * @param mech the Oid of the mechanism whose initiator credential element should be queried.
   * @return the number of seconds remaining in the life of this credential element. A return value
   * of {@link #INDEFINITE_LIFETIME INDEFINITE_LIFETIME} indicates that the credential element does
   * not expire.  A return value of 0 indicates that the credential element is already expired.
   * @throws GSSException containing the following major error codes: {@link GSSException#BAD_MECH
   * GSSException.BAD_MECH}, {@link GSSException#FAILURE GSSException.FAILURE}
   */
   ...
   * specified mechanism.
   *
   * @param mech the Oid of the mechanism whose acceptor credential element should be queried.
   * @return the number of seconds remaining in the life of this credential element. A return value
   * of {@link #INDEFINITE_LIFETIME INDEFINITE_LIFETIME} indicates that the credential element does
   * not expire.  A return value of 0 indicates that the credential element is already expired.
   * @throws GSSException containing the following major error codes: {@link GSSException#BAD_MECH
   ...
   *
   * @return The return value will be one of {@link #INITIATE_ONLY INITIATE_ONLY}, {@link
   * #ACCEPT_ONLY ACCEPT_ONLY}, and {@link #INITIATE_AND_ACCEPT INITIATE_AND_ACCEPT}.
   * @throws GSSException containing the following major error codes: {@link GSSException#FAILURE
   * GSSException.FAILURE}
   */
   ...
   * mechanism.
   *
   * @param mech the Oid of the mechanism whose credentials usage mode is to be determined.
   * @return The return value will be one of {@link #INITIATE_ONLY INITIATE_ONLY}, {@link
   * #ACCEPT_ONLY ACCEPT_ONLY}, and {@link #INITIATE_AND_ACCEPT INITIATE_AND_ACCEPT}.
   * @throws GSSException containing the following major error codes: {@link GSSException#BAD_MECH
   * GSSException.BAD_MECH}, {@link GSSException#FAILURE GSSException.FAILURE}
   ...
   * @param initLifetime the number of seconds that the credential element should remain valid for
   * initiating of security contexts. Use {@link GSSCredential#INDEFINITE_LIFETIME
   * GSSCredential.INDEFINITE_LIFETIME} to request that the credentials have the maximum permitted
   * lifetime for this.  Use {@link GSSCredential#DEFAULT_LIFETIME GSSCredential.DEFAULT_LIFETIME}
   * to request default credential lifetime for this.
   * @param acceptLifetime the number of seconds that the credential element should remain valid for
   * accepting security contexts. Use {@link GSSCredential#INDEFINITE_LIFETIME
   * GSSCredential.INDEFINITE_LIFETIME} to request that the credentials have the maximum permitted
   * lifetime for this.  Use {@link GSSCredential#DEFAULT_LIFETIME GSSCredential.DEFAULT_LIFETIME}
   * to request default credential lifetime for this.
   * @param mech the mechanism over which the credential is to be acquired.
   * @param usage the usage mode that this credential element should add to the credential. The
   * value of this parameter must be one of: {@link #INITIATE_AND_ACCEPT INITIATE_AND_ACCEPT},
   * {@link #ACCEPT_ONLY ACCEPT_ONLY}, and {@link #INITIATE_ONLY INITIATE_ONLY}.
   * @throws GSSException containing the following major error codes: {@link
   * GSSException#DUPLICATE_ELEMENT GSSException.DUPLICATE_ELEMENT}, {@link GSSException#BAD_MECH
   * GSSException.BAD_MECH}, {@link GSSException#BAD_NAMETYPE GSSException.BAD_NAMETYPE}, {@link
   * GSSException#NO_CRED GSSException.NO_CRED}, {@link GSSException#CREDENTIALS_EXPIRED
   * GSSException.CREDENTIALS_EXPIRED}, {@link GSSException#FAILURE GSSException.FAILURE}
   */
   ...
   * @return <code>true</code> if the two GSSCredentials assert the same entity; <code>false</code>
   * otherwise.
   */
