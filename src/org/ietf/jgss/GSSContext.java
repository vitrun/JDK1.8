...
public interface GSSContext {
   ...
   *
   * @param inputBuf token generated by the peer. This parameter is ignored on the first call since
   * no token has been received from the peer.
   * @param offset the offset within the inputBuf where the token begins.
   * @param len the length of the token.
   * @return a byte[] containing the token to be sent to the peer. <code>null</code> indicates that
   * no token is generated.
   * @throws GSSException containing the following major error codes: {@link
   * GSSException#DEFECTIVE_TOKEN GSSException.DEFECTIVE_TOKEN}, {@link GSSException#BAD_MIC
   * GSSException.BAD_MIC}, {@link GSSException#NO_CRED GSSException.NO_CRED}, {@link
   * GSSException#CREDENTIALS_EXPIRED GSSException.CREDENTIALS_EXPIRED}, {@link
   * GSSException#BAD_BINDINGS GSSException.BAD_BINDINGS}, {@link GSSException#OLD_TOKEN
   * GSSException.OLD_TOKEN}, {@link GSSException#DUPLICATE_TOKEN GSSException.DUPLICATE_TOKEN},
   ...
   * </pre>
   *
   * @param inStream an InputStream that contains the token generated by the peer. This parameter is
   * ignored on the first call since no token has been or will be received from the peer at that
   * point.
   * @param outStream an OutputStream where the output token will be written. During the final stage
   * of context establishment, there may be no bytes written.
   * @return the number of bytes written to the OutputStream as part of the token to be sent to the
   * peer. A value of 0 indicates that no token needs to be sent.
   * @throws GSSException containing the following major error codes: {@link
   * GSSException#DEFECTIVE_TOKEN GSSException.DEFECTIVE_TOKEN}, {@link GSSException#BAD_MIC
   * GSSException.BAD_MIC}, {@link GSSException#NO_CRED GSSException.NO_CRED}, {@link
   * GSSException#CREDENTIALS_EXPIRED GSSException.CREDENTIALS_EXPIRED}, {@link
   ...
   * </pre>
   *
   * @param inStream an InputStream that contains the token generated by the peer.
   * @param outStream an OutputStream where the output token will be written. During the final stage
   * of context establishment, there may be no bytes written.
   * @throws GSSException containing the following major error codes: {@link
   * GSSException#DEFECTIVE_TOKEN GSSException.DEFECTIVE_TOKEN}, {@link GSSException#BAD_MIC
   ...
   * context.
   *
   * @return <code>true</code> if this is a fully established context on the caller's side and no
   * more tokens are needed from the peer.
   */
   ...
   * @param confReq <code>true</code> if wrap will be asked to provide privacy, <code>false</code>
   * otherwise.
   * @param maxTokenSize the desired maximum size of the token emitted by wrap.
   * @return the maximum size of the input token for the given output token size
   * @throws GSSException containing the following major error codes: {@link
   * GSSException#CONTEXT_EXPIRED GSSException.CONTEXT_EXPIRED}, {@link GSSException#BAD_QOP
   * GSSException.BAD_QOP}, {@link GSSException#FAILURE GSSException.FAILURE}
   */
   ...
   * @param msgProp instance of MessageProp that is used by the application to set the desired QOP
   * and privacy state. Set the desired QOP to 0 to request the default QOP. Upon return from this
   * method, this object will contain the the actual privacy state that was applied to the message
   ...
   * that is available in inStream is used.
   * @param outStream an OutputStream to write the protected message to.
   * @param msgProp instance of MessageProp that is used by the application to set the desired QOP
   * and privacy state. Set the desired QOP to 0 to request the default QOP. Upon return from this
   * method, this object will contain the the actual privacy state that was applied to the message
   * by the underlying mechanism.
   ...
   *
   * @param inBuf a byte array containing the wrap token received from peer.
   * @param offset the offset where the token begins.
   * @param len the length of the token
   * @param msgProp upon return from the method, this object will contain the applied QOP, the
   * privacy state of the message, and supplementary information stating if the token was a
   * duplicate, old, out of sequence or arriving after a gap.
   * @return a byte[] containing the message unwrapped from the input token.
   * @throws GSSException containing the following major error codes: {@link
   * GSSException#DEFECTIVE_TOKEN GSSException.DEFECTIVE_TOKEN}, {@link GSSException#BAD_MIC
   * GSSException.BAD_MIC}, {@link GSSException#CONTEXT_EXPIRED GSSException.CONTEXT_EXPIRED},
   ...
   *
   * @param inStream an InputStream that contains the wrap token generated by the peer.
   * @param outStream an OutputStream to write the application message to.
   * @param msgProp upon return from the method, this object will contain the applied QOP, the
   * privacy state of the message, and supplementary information stating if the token was a
   * duplicate, old, out of sequence or arriving after a gap.
   * @throws GSSException containing the following major error codes: {@link
   ...
   * @param msgProp an instance of <code>MessageProp</code> that is used by the application to set
   * the desired QOP.  Set the desired QOP to <code>0</code> in <code>msgProp</code> to request the
   * default QOP. Alternatively pass in <code>null</code> for <code>msgProp</code> to request the
   * default QOP.
   * @return a byte[] containing the token to be sent to the peer.
   * @throws GSSException containing the following major error codes: {@link
   * GSSException#CONTEXT_EXPIRED GSSException.CONTEXT_EXPIRED}, {@link GSSException#BAD_QOP
   ...
   * @param tokOffset the offset within the inToken where the token begins.
   * @param tokLen the length of the token.
   * @param inMsg the application message to verify the cryptographic MIC over.
   * @param msgOffset the offset in inMsg where the message begins.
   * @param msgLen the length of the message.
   * @param msgProp upon return from the method, this object will contain the applied QOP and
   * supplementary information stating if the token was a duplicate, old, out of sequence or
   * arriving after a gap.
   * @throws GSSException containing the following major error codes: {@link
   * GSSException#DEFECTIVE_TOKEN GSSException.DEFECTIVE_TOKEN} {@link GSSException#BAD_MIC
   * GSSException.BAD_MIC} {@link GSSException#CONTEXT_EXPIRED GSSException.CONTEXT_EXPIRED} {@link
   ...
   * @param msgStream an InputStream containing the application message to verify the cryptographic
   * MIC over. All of the data that is available in msgStream is used.
   * @param msgProp upon return from the method, this object will contain the applied QOP and
   * supplementary information stating if the token was a duplicate, old, out of sequence or
   * arriving after a gap.
   * @throws GSSException containing the following major error codes: {@link
   ...
   * @throws GSSException containing the following major error codes: {@link
   * GSSException#UNAVAILABLE GSSException.UNAVAILABLE}, {@link GSSException#CONTEXT_EXPIRED
   * GSSException.CONTEXT_EXPIRED}, {@link GSSException#NO_CONTEXT GSSException.NO_CONTEXT}, {@link
   * GSSException#FAILURE GSSException.FAILURE}
   ...
   *
   * @param state a boolean value indicating whether mutual authentication should be used or not.
   * @throws GSSException containing the following major error codes: {@link GSSException#FAILURE
   * GSSException.FAILURE}
   ...
   * method.<p>
   *
   * @param state a boolean value indicating whether replay detection should be enabled over the
   * established context or not.
   * @throws GSSException containing the following major error codes: {@link GSSException#FAILURE
   * GSSException.FAILURE}
   ...
   * method.<p>
   *
   * @param state a boolean value indicating whether sequence checking should be enabled over the
   * established context or not.
   * @throws GSSException containing the following major error codes: {@link GSSException#FAILURE
   * GSSException.FAILURE}
   ...
   * is not requested.<p>
   *
   * @param state a boolean value indicating whether the credentials should be delegated or not.
   * @throws GSSException containing the following major error codes: {@link GSSException#FAILURE
   * GSSException.FAILURE}
   ...
   *
   * @param state a boolean value indicating if the initiator should be authenticated to the
   * acceptor as an anonymous principal.
   * @throws GSSException containing the following major error codes: {@link GSSException#FAILURE
   * GSSException.FAILURE}
   ...
   * integrity.<p>
   *
   * @param state a boolean value indicating whether confidentiality should be enabled or not.
   * @throws GSSException containing the following major error codes: {@link GSSException#FAILURE
   * GSSException.FAILURE}
   * @see #getConfState()
   * @see #getIntegState()
   ...
   * confidentiality.<p>
   *
   * @param state a boolean value indicating whether integrity should be enabled or not.
   * @throws GSSException containing the following major error codes: {@link GSSException#FAILURE
   * GSSException.FAILURE}
   * @see #getIntegState()
   */
   ...
   *
   * @param lifetime the desired context lifetime in seconds. Use <code>INDEFINITE_LIFETIME</code>
   * to request an indefinite lifetime and <code>DEFAULT_LIFETIME</code> to request a default
   * lifetime.
   * @throws GSSException containing the following major error codes: {@link GSSException#FAILURE
   * GSSException.FAILURE}
   * @see #getLifetime()
   ...
   *
   * @return true if the context initiator is still anonymous, false otherwise.
   ...
   *
   * @return true if methods like <code>wrap</code>, <code>unwrap</code>, <code>getMIC</code>, and
   * <code>verifyMIC</code> can be used with this context at the current stage of context
   * establishment, false otherwise.
   */
   ...
   *
   * @return a GSSName that is an MN containing the name of the context initiator.
   * @throws GSSException containing the following major error codes: {@link GSSException#FAILURE
   * GSSException.FAILURE}
   * @see GSSName
   */
   ...
   * #isEstablished() isEstablished} return <code>true</code>.
   *
   * @return a GSSName that is an MN containing the name of the context acceptor.
   * @throws GSSException containing the following major error codes: {@link GSSException#FAILURE
   * GSSException.FAILURE}
   */
   ...
   *
   * @return a GSSCredential containing the initiator's delegated credentials, or <code>null</code>
   * is no credentials were delegated.
   * @throws GSSException containing the following major error codes: {@link GSSException#FAILURE
   * GSSException.FAILURE}
   */
   ...
   * side.
   *
   * @return true if this is the context initiator, false if it is the context acceptor.
   * @throws GSSException containing the following major error codes: {@link GSSException#FAILURE
   * GSSException.FAILURE}
   */
