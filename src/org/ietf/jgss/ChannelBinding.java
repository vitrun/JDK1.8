...
public class ChannelBinding {
   ...
   *
   * @param initAddr the address of the context initiator. <code>null</code> value can be supplied
   * to indicate that the application does not want to set this value.
   * @param acceptAddr the address of the context acceptor. <code>null</code> value can be supplied
   * to indicate that the application does not want to set this value.
   * @param appData application supplied data to be used as part of the channel bindings.
   * <code>null</code> value can be supplied to indicate that the application does not want to set
   * this value.
   */
   ...
   *
   * @return the initiator's address. <code>null</code> is returned if the address has not been set.
   */
   ...
   *
   * @return the acceptor's address. null is returned if the address has not been set.
   */
   ...
   *
   * @return the application data being used as part of the ChannelBinding. <code>null</code> is
   * returned if no application data has been specified for the channel binding.
   */
   ...
   * @return true if the two ChannelBinding's contain the same values for the initiator and acceptor
   * addresses and the application data.
   */
