 ...
 * Mouse events. <p>The <code>detail</code> attribute inherited from <code>UIEvent</code> indicates
 * the number of times a mouse button has been pressed and released over the same screen location
 * during a user action. The attribute value is 1 when the user begins this action and increments by
 * 1 for each full sequence of pressing and releasing. If the user moves the mouse between the
 * mousedown and mouseup the value will be set to 0, indicating that no click is occurring. <p>In
 * the case of nested elements mouse events are always targeted at the most deeply nested element.
 * Ancestors of the targeted element may use bubbling to obtain notification of mouse events which
 * occur within its descendent elements. <p>See also the <a href='http://www.w3.org/TR/2000/REC-DOM-Level-2-Events-20001113'>Document
...
public interface MouseEvent extends UIEvent {
   ...
   * @param ctrlKeyArg Specifies whether or not control key was depressed during the
   * <code>Event</code>.
   * @param altKeyArg Specifies whether or not alt key was depressed during the <code>Event</code>.
   * @param shiftKeyArg Specifies whether or not shift key was depressed during the
   * <code>Event</code>.
   * @param metaKeyArg Specifies whether or not meta key was depressed during the
   * <code>Event</code>.
