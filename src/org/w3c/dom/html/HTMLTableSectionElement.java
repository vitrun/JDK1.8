...
/**
 * The <code>THEAD</code> , <code>TFOOT</code> , and <code>TBODY</code> elements. <p>See also the <a
...
public interface HTMLTableSectionElement extends HTMLElement {
   ...
   * of rows of if the index is neagative.
   */
   ...
   *
   * @param index The index of the row to be deleted. This index starts from 0 and is relative only
