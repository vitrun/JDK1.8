 ...
 * document's relationship to that resource (or vice versa). See the  LINK element definition in
 * HTML 4.0  (see also the <code>LinkStyle</code> interface in the  module). <p>See also the <a
