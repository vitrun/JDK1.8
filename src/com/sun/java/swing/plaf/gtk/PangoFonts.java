...
class PangoFonts {
   ...
   * a Font object.
   *
   * @param pangoName a String describing a pango font e.g. "Sans Italic 10"
   * @return a Font object as a FontUIResource or null if no suitable font could be created.
   */
   ...
   * @return the size of the font described by pangoName (e.g. if pangoName is "Sans Italic 10",
   * then this method returns 10)
   */
