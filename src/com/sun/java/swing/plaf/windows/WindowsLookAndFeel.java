...
public class WindowsLookAndFeel extends BasicLookAndFeel {
   ...
   * </p>
   *
   * @param component Component the error occurred in, may be null indicating the error condition is
   * not directly associated with a <code>Component</code>.
   ...
   *
   * @return an Action which knows how to render the auditory cue for one particular system or user
   * activity
