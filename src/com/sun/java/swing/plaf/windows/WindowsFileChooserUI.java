...
public class WindowsFileChooserUI extends BasicFileChooserUI {
  ...
  private String fileNameString(File file) {
    if (file == null) {
      ...
      if ((fc.isDirectorySelectionEnabled() && !fc.isFileSelectionEnabled()) ||
          (fc.isDirectorySelectionEnabled() && fc.isFileSelectionEnabled() && fc.getFileSystemView()
   ...
   */
  protected class DirectoryComboBoxModel extends AbstractListModel<File> implements
      ComboBoxModel<File> {
