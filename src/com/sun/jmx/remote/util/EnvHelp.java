...
public class EnvHelp {
   ...
   * @throws IllegalArgumentException if one of the following is true: <ul> <li>both
   * <code>jmx.remote.default.class.loader</code> and <code>jmx.remote.default.class.loader.name</code>
   * are specified, </li> <li>or <code>jmx.remote.default.class.loader</code> is not an instance of
   * {@link ClassLoader}, </li> <li>or <code>jmx.remote.default.class.loader.name</code> is not an
   * instance of {@link ObjectName}, </li> <li>or <code>jmx.remote.default.class.loader.name</code>
   * is specified but <var>mbs</var> is null. </li>
   * @throws InstanceNotFoundException if <code>jmx.remote.default.class.loader.name</code> is
   * specified and the ClassLoader MBean is not found in <var>mbs</var>.
   */
   ...
   * @throws IllegalArgumentException if <code>jmx.remote.default.class.loader</code> is specified
   ...
   * @return the cause if getCause() succeeded and the got value is not null, otherwise return the
   * <var>t</var>.
   */
   ...
   *
   * @throws IllegalArgumentException if <code>env</code> contains an entry for <code>name</code>
   ...
   *
   * @param stringBoolean the string value that must be converted into a boolean value.
   * @return <ul> <li>{@code false} if {@code stringBoolean} is {@code null}</li> <li>{@code false}
   * if {@code stringBoolean.equalsIgnoreCase("false")} is {@code true}</li> <li>{@code true} if
   * {@code stringBoolean.equalsIgnoreCase("true")} is {@code true}</li> </ul>
   * @throws IllegalArgumentException if {@code ((String)env.get(prop)).equalsIgnoreCase("false")}
   * and {@code ((String)env.get(prop)).equalsIgnoreCase("true")} are {@code false}.
   */
   ...
   *
   * @param stringBoolean the string value that must be converted into a boolean value.
   * @param defaultValue a default value to return in case no property was defined.
   * @return <ul> <li>{@code defaultValue} if {@code stringBoolean} is {@code null}</li> <li>{@code
   * false} if {@code stringBoolean.equalsIgnoreCase("false")} is {@code true}</li> <li>{@code true}
   * if {@code stringBoolean.equalsIgnoreCase("true")} is {@code true}</li> </ul>
   * @throws IllegalArgumentException if {@code ((String)env.get(prop)).equalsIgnoreCase("false")}
   * and {@code ((String)env.get(prop)).equalsIgnoreCase("true")} are {@code false}.
   */
