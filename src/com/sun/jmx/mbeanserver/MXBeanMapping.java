...
public abstract class MXBeanMapping {
   ...
   * @param openType the Open Type (for example, {@code ArrayType.getArrayType(SimpleType.STRING)})
   ...
   *
   * @return the Java class that corresponds to instances of the Open Type for this mapping.
   ...
   * appropriate.</p>
   *
   * @throws InvalidObjectException if {@code fromOpenValue} will throw an exception no matter what
   * its argument is.
   */
