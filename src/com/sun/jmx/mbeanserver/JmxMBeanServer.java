...
public final class JmxMBeanServer
  ...
  /**
   * <b>Package:</b> Creates an MBeanServer with the specified default domain name, outer interface,
   * and delegate. <p>The default domain name is used as the domain part in the ObjectName of MBeans
   * if no domain is specified by the user. <ul><b>Note:</b>Using this constructor directly is
   * strongly discouraged. You should use {@link javax.management.MBeanServerFactory#createMBeanServer(java.lang.String)}
   * or {@link javax.management.MBeanServerFactory#newMBeanServer(java.lang.String)} instead. <p> By
   * default, interceptors are disabled. Use {@link #JmxMBeanServer(java.lang.String, javax.management.MBeanServer, javax.management.MBeanServerDelegate, boolean)}
   * to enable them. </ul>
   *
   * @param domain The default domain name used by this MBeanServer.
   * @param outer A pointer to the MBeanServer object that must be passed to the MBeans when
   * invoking their {@link javax.management.MBeanRegistration} interface.
   * @param delegate A pointer to the MBeanServerDelegate associated with the new MBeanServer. The
   ...
   * @param delegate A pointer to the MBeanServerDelegate associated with the new MBeanServer. The
   * new MBeanServer must register this MBean in its MBean repository.
   * @param interceptors If <code>true</code>, {@link MBeanServerInterceptor} will be enabled
   * (default is <code>false</code>) Note: this parameter is not taken into account by this
   * implementation - the default value <code>false</code> is always used.
   * @throws IllegalArgumentException if the instantiator is null.
   */
  JmxMBeanServer(String domain, MBeanServer outer,
   ...
   * @param delegate A pointer to the MBeanServerDelegate associated with the new MBeanServer. The
   * new MBeanServer must register this MBean in its MBean repository.
   * @param instantiator The MBeanInstantiator that will be used to instantiate MBeans and take care
   * of class loading issues.
   * @param metadata The MetaData object that will be used by the MBean server in order to invoke
   * the MBean interface of the registered MBeans.
   * @param interceptors If <code>true</code>, {@link MBeanServerInterceptor} will be enabled
   ...
   * java.util.concurrent.locks.ReentrantReadWriteLock#ReentrantReadWriteLock(boolean) fair locking}
   * policy.
   */
  JmxMBeanServer(String domain, MBeanServer outer,
      MBeanServerDelegate delegate,
   ...
   *
   * @throws UnsupportedOperationException if {@link MBeanServerInterceptor}s are not enabled on
   * this object.
   ...
   * @throws ReflectionException Wraps an <CODE>{@link java.lang.ClassNotFoundException}</CODE> or
   ...
   * (<CODE>MBeanRegistration</CODE> interface) method of the MBean has thrown an exception. The
   ...
   * @throws RuntimeOperationsException Wraps an <CODE>{@link java.lang.IllegalArgumentException}</CODE>:
   * The className passed in parameter is null, the <CODE>ObjectName</CODE> passed in parameter
   * contains a pattern or no <CODE>ObjectName</CODE> is specified for the MBean.
   */
   ...
   * @return An <CODE>ObjectInstance</CODE>, containing the <CODE>ObjectName</CODE> and the Java
   * class name of the newly instantiated MBean.
   * @throws ReflectionException Wraps a <CODE>{@link java.lang.ClassNotFoundException}</CODE> or an
   * <CODE>{@link java.lang.Exception}</CODE> that occurred when trying to invoke the MBean's
   * constructor.
   * @throws InstanceAlreadyExistsException The MBean is already under the control of the MBean
   * server.
   * @throws MBeanRegistrationException The <CODE>preRegister()</CODE>
   ...
   * (<CODE>MBeanRegistration</CODE>  interface) method of the MBean has thrown an exception. The
   * MBean will not be registered.
   * @throws NotCompliantMBeanException This object is not a JMX compliant MBean
   * @throws RuntimeOperationsException Wraps an <CODE>{@link java.lang.IllegalArgumentException}</CODE>:
   ...
   * @throws RuntimeOperationsException Wraps an <CODE>{@link java.lang.IllegalArgumentException}</CODE>:
   * The object name in parameter is null or the MBean you are when trying to de-register is the
   * {@link javax.management.MBeanServerDelegate MBeanServerDelegate} MBean.
   **/
   ...
   * the selected MBeans.
   *
   * @param name The object name pattern identifying the MBeans to be retrieved. If null or or no
   ...
   * @return A set containing the <CODE>ObjectInstance</CODE> objects for the selected MBeans. If no
   ...
   * @throws InstanceNotFoundException The MBean specified is not registered in the MBean server.
   * @throws ReflectionException Wraps an <CODE>{@link java.lang.Exception}</CODE> thrown when
   ...
   * @throws RuntimeOperationsException Wrap an <CODE>{@link java.lang.IllegalArgumentException}</CODE>:
   ...
   * was invoked.
   * @return The object returned by the operation, which represents the result ofinvoking the
   * operation on the  MBean specified.
   * @throws InstanceNotFoundException The MBean specified is not registered in the MBean server.
   * @throws MBeanException Wraps an exception thrown by the MBean's invoked method.
   * @throws ReflectionException Wraps an <CODE>{@link java.lang.Exception}</CODE> thrown while
   ...
   * @throws ReflectionException Wraps the <CODE>{@link java.lang.ClassNotFoundException}</CODE> or
   * the <CODE>{@link java.lang.Exception}</CODE> that occurred when trying to invoke the object's
   * constructor.
   ...
   * @return The de-serialized object stream.
   * @throws OperationsException Any of the usual Input/Output related exceptions.
   * @throws ReflectionException The specified class could not be loaded by the default loader
   * repository
   */
  @Deprecated
   ...
   * @throws InstanceNotFoundException if the named ClassLoader is not found.
   */
   ...
   * @param delegate A pointer to the MBeanServerDelegate associated with the new MBeanServer. The
   * new MBeanServer must register this MBean in its MBean repository.
   * @param interceptors If <code>true</code>, {@link MBeanServerInterceptor}s will be enabled
   * (default is <code>false</code>). Note: this parameter is not taken into account by this
   * implementation - the default value <code>false</code> is always used.
