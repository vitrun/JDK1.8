...
public interface SnmpStandardMetaServer {
   ...
   * request.
   * @return The <CODE>SnmpValue</CODE> of the scalar object identified by <CODE>arc</CODE>.
   * @throws SnmpStatusException If the arc is not valid, or if access is denied.
   **/
   ...
   * OID arc.
   *
   * @param x New value for the scalar object identified by <CODE>arc</CODE>
   * @param arc OID arc of the scalar object whose value is set.
   * @param userData A contextual object containing user-data. This object is allocated through the
   * <code> {@link com.sun.jmx.snmp.agent.SnmpUserDataFactory}</code> for each incoming SNMP
   * request.
   * @return The new <CODE>SnmpValue</CODE> of the scalar object identified by <CODE>arc</CODE>.
   * @throws SnmpStatusException If the arc is not valid, or if access is denied.
   **/
   ...
   * <code> {@link com.sun.jmx.snmp.agent.SnmpUserDataFactory}</code> for each incoming SNMP
   * request.
   * @throws SnmpStatusException If the arc is not valid, or if access is denied, or if the new
   * desired value is not valid.
   **/
