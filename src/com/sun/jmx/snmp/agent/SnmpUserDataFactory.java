...
public interface SnmpUserDataFactory {
   ...
   * decoded.
   *
   * @param requestPdu The SnmpPduPacket received from the SNMP manager. <b>This parameter is owned
   * by the SNMP framework and must be considered as transient.</b> If you wish to keep some of its
   * content after this method returns (by storing it in the returned object for instance) you
   * should clone that information.
   * @return A newly allocated user-data contextual object, or <code>null</code>
   * @throws SnmpStatusException If an SnmpStatusException is thrown, the request will be aborted.
   * @since 1.5
   **/
   ...
   * @param responsePdu The SnmpPduPacket that will be sent back to the SNMP manager. <b>This
   * parameter is owned by the SNMP framework and must be considered as transient.</b> If you wish
   * to keep some of its content after this method returns you should clone that information.
   * @throws SnmpStatusException If an SnmpStatusException is thrown, the responsePdu is dropped and
   * nothing is returned to to the manager.
   * @since 1.5
   **/
