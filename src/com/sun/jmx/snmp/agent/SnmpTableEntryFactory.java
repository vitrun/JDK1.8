...
public interface SnmpTableEntryFactory extends SnmpTableCallbackHandler {
   ...
   * </i></b></p>
   *
   * @param request The SNMP subrequest containing the sublist of varbinds for the new entry.
   * @param rowOid The OID indexing the conceptual row (entry) for which the creation was
   * requested.
   * @param depth The depth reached in the OID tree (the position at which the columnar object ids
   * start in the OIDs included in the varbind).
