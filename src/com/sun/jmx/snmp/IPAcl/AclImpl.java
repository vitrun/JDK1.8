...
class AclImpl extends OwnerImpl implements Acl, Serializable {
   ...
   * @return true on success, false if an entry of the same type (positive or negative) for the same
   * principal is already present in this ACL.
   * @throws NotOwnerException if the caller principal is not an owner of this ACL.
   * @see java.security.Principal
   */
  @Override
   ...
   * @return the permission set specifying the permissions the principal is allowed.
   * @see java.security.Principal
   */
  @Override
   ...
   *
   * @param community the community name associated with the principal.
   * @return true if the specified community string is defined, false otherwise.
   * @see java.security.Principal
   * @see java.security.Permission
   */
