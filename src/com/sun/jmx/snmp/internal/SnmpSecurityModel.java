...
/**
 * Security model interface. Any security model implementation must implement this interface in
 * order to be integrated in the engine framework. Security models are called when SNMP messages are
 * received or sent. They deal with security (authentication and privacy). <p><b>This API is a Sun
 * Microsystems internal API  and is subject to change without notice.</b></p>
 *
 * @since 1.5
 */
public interface SnmpSecurityModel extends SnmpModel {
  ...
  /**
   * Called when a request is to be sent to the network. It must be securized. <BR>The specified
  ...
  /**
   * Called when a response is to be sent to the network. It must be securized. <BR>The specified
   * parameters are defined in RFC 2572 (see also the {@link com.sun.jmx.snmp.SnmpV3Message}
   * class).
   *
   * @param cache The cache that has been created by calling <CODE>createSecurityCache</CODE> on
   ...
   * <BR>The specified parameters are defined in RFC 2572 (see also the {@link
   * com.sun.jmx.snmp.SnmpV3Message} class).
   *
   * @param cache The cache that has been created by calling <CODE>createSecurityCache</CODE> on
   * this model.
   * @param version The SNMP protocol version.
   ...
   * @param msgFlags The message flags (reportable, Auth and Priv)
   * @param msgSecurityModel This current security model.
   * @param params The security parameters in a marshalled format. The informations contained in
