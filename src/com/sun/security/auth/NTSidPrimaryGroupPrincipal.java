...
public class NTSidPrimaryGroupPrincipal extends NTSid {
   ...
   * <p>
   *
   * @param o Object to be compared for equality with this <code>NTSidPrimaryGroupPrincipal</code>.
   * @return true if the specified Object is equal equal to this <code>NTSidPrimaryGroupPrincipal</code>.
   */
