 ...
 * @deprecated As of JDK&nbsp;1.4, replaced by {@link UnixPrincipal}. This class is entirely
 * deprecated.
 */
@jdk.Exported(false)
@Deprecated
public class SolarisPrincipal implements Principal, java.io.Serializable {
   ...
   * <p>
   *
   * @param o Object to be compared for equality with this <code>SolarisPrincipal</code>.
   * @return true if the specified Object is equal equal to this <code>SolarisPrincipal</code>.
   */
