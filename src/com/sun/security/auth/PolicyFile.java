 ...
 * @deprecated As of JDK&nbsp;1.4, replaced by <code>sun.security.provider.PolicyFile</code>. This
 * class is entirely deprecated.
 */
@jdk.Exported(false)
@Deprecated
public class PolicyFile extends javax.security.auth.Policy {
   ...
   * <p>
   *
   * @throws SecurityException if the caller doesn't have permission to refresh the
   * <code>Policy</code>.
   */
  @Override
  public void refresh() {
   ...
   * <p>
   *
   * @param subject the Permissions granted to this <code>Subject</code> and the additionally
   * provided <code>CodeSource</code> are returned. <p>
   * @param codesource the Permissions granted to this <code>CodeSource</code> and the additionally
   * provided <code>Subject</code> are returned.
   * @return the Permissions granted to the provided <code>Subject</code> <code>CodeSource</code>.
   */
  @Override
