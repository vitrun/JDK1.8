...
public class UnixNumericUserPrincipal implements
   ...
   * <p>
   *
   * @param name the user identification number (UID) for this user represented as a long.
   */
   ...
   * <p>
   *
   * @return the user identification number (UID) for this <code>UnixNumericUserPrincipal</code> as
   * a long.
   */
   ...
   * <p>
   *
   * @param o Object to be compared for equality with this <code>UnixNumericUserPrincipal</code>.
   * @return true if the specified Object is equal equal to this <code>UnixNumericUserPrincipal</code>.
   */
