 ...
 * @deprecated As of JDK&nbsp;1.4, replaced by {@link UnixNumericUserPrincipal}. This class is
 * entirely deprecated.
 */
@jdk.Exported(false)
@Deprecated
public class SolarisNumericUserPrincipal implements
   ...
   * <p>
   *
   * @param o Object to be compared for equality with this <code>SolarisNumericUserPrincipal</code>.
   * @return true if the specified Object is equal equal to this <code>SolarisNumericUserPrincipal</code>.
   */
