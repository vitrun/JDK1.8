...
public class NTSidUserPrincipal extends NTSid {
   ...
   * <p>
   *
   * @param o Object to be compared for equality with this <code>NTSidUserPrincipal</code>.
   * @return true if the specified Object is equal equal to this <code>NTSidUserPrincipal</code>.
   */
