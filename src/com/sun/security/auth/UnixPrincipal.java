...
public class UnixPrincipal implements Principal, java.io.Serializable {
   ...
   * <p>
   *
   * @param o Object to be compared for equality with this <code>UnixPrincipal</code>.
   * @return true if the specified Object is equal equal to this <code>UnixPrincipal</code>.
   */
