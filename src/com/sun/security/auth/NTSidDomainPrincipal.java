...
public class NTSidDomainPrincipal extends NTSid {
   ...
   * <p>
   *
   * @param name a string version of the Windows NT SID for this user's domain.<p>
   ...
   * <p>
   *
   * @param o Object to be compared for equality with this <code>NTSidDomainPrincipal</code>.
   * @return true if the specified Object is equal equal to this <code>NTSidDomainPrincipal</code>.
   */
