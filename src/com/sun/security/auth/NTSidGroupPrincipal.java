...
public class NTSidGroupPrincipal extends NTSid {
   ...
   * <p>
   *
   * @param o Object to be compared for equality with this <code>NTSidGroupPrincipal</code>.
   * @return true if the specified Object is equal equal to this <code>NTSidGroupPrincipal</code>.
   */
