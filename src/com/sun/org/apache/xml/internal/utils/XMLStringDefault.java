...
public class XMLStringDefault implements XMLString {
   ...
   * <ul><li><code>srcBegin</code> is negative. <li><code>srcBegin</code> is greater than
   * <code>srcEnd</code> <li><code>srcEnd</code> is greater than the length of this string
   * <li><code>dstBegin</code> is negative <li><code>dstBegin+(srcEnd-srcBegin)</code> is larger
   ...
   * @return <code>true</code> if the argument is not <code>null</code> and the <code>String</code>s
   * are equal, ignoring case; <code>false</code> otherwise.
   * @see #equals(Object)
   ...
   * than <code>0</code> if this string is lexicographically less than the string argument; and a
   * value greater than <code>0</code> if this string is lexicographically greater than the string
   * argument.
   * @throws java.lang.NullPointerException if <code>anotherString</code> is <code>null</code>.
   */
   ...
   * @return a negative integer, zero, or a positive integer as the the specified String is greater
   ...
   * otherwise. The result is <code>false</code> if <code>toffset</code> is negative or greater than
   * the length of this <code>String</code> object; otherwise the result is the same as the result
   * of the expression
   * <pre>
   *          this.subString(toffset).startsWith(prefix)
   *          </pre>
   * @throws java.lang.NullPointerException if <code>prefix</code> is <code>null</code>.
   */
   ...
   * @param prefix the prefix.
   * @return <code>true</code> if the character sequence represented by the argument is a prefix of
   * the character sequence represented by this string; <code>false</code> otherwise. Note also that
   ...
   * the character sequence represented by this object; <code>false</code> otherwise. Note that the
   * result will be <code>true</code> if the argument is the empty string or is equal to this
   * <code>String</code> object as determined by the {@link #equals(Object)} method.
   * @throws java.lang.NullPointerException if <code>suffix</code> is <code>null</code>.
   */
   ...
   * <code>fromIndex</code>. If it is greater than or equal to the length of this string, it has the
   * same effect as if it were equal to one less than the length of this string: this entire string
   * may be searched. If it is negative, it has the same effect as if it were -1: -1 is returned.
   * @return the index of the last occurrence of the character in the character sequence represented
   * by this object that is less than or equal to <code>fromIndex</code>, or <code>-1</code> if the
   ...
   * @param fromIndex the index to start the search from.
   * @return If the string argument occurs as a substring within this object at a starting index no
   * smaller than <code>fromIndex</code>, then the index of the first character of the first such
   * substring is returned. If it does not occur as a substring starting at <code>fromIndex</code>
   ...
   * as a substring, <code>-1</code> is returned.
   * @throws java.lang.NullPointerException if <code>str</code> is <code>null</code>.
   */
   ...
   * @param str the substring to search for.
   * @param fromIndex the index to start the search from. There is no restriction on the value of
   * fromIndex. If it is greater than the length of this string, it has the same effect as if it
   * were equal to the length of this string: this entire string may be searched. If it is negative,
   * it has the same effect as if it were -1: -1 is returned.
   * @return If the string argument occurs one or more times as a substring within this object at a
   * starting index no greater than <code>fromIndex</code>, then the index of the first character of
   * the last such substring is returned. If it does not occur as a substring starting at
   * <code>fromIndex</code> or earlier, <code>-1</code> is returned.
   * @throws java.lang.NullPointerException if <code>str</code> is <code>null</code>.
   */
   ...
   * <code>endIndex</code> is larger than the length of this <code>String</code> object, or
   ...
   *
   * @param str the <code>String</code> that is concatenated to the end of this
   * <code>String</code>.
