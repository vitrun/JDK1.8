...
public class StylesheetPIHandler extends DefaultHandler {
  ...
  public void processingInstruction(String target, String data)
    ...
    if (target.equals("xml-stylesheet")) {
      ...
      if ((null != type)
          && (type.equals("text/xsl") || type.equals("text/xml") || type
          .equals("application/xml+xslt"))
          && (null != href)) {
        if (null != m_media) {
          if (null != media) {
  ...
  /**
   * The spec notes that "The xml-stylesheet processing instruction is allowed only in the prolog of
   * an XML document.", so, at least for right now, I'm going to go ahead an throw a
