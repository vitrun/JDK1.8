...
public class UnImplNode implements Node, Element, NodeList, Document {
   ...
   * is the string "2.0". If the version is not specified, supporting any version of the feature
   * will cause the method to return <code>true</code>.
   ...
   * <code>Attr</code> , <code>EntityReference</code>, and <code>Notation</code> nodes.
   * @return null
   */
