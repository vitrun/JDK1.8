...
public class DOM2DTM extends DTMDefaultBaseIterators {
   ...
   * rather than CDATASection when their coalesced value includes ordinary Text nodes (current DTM
   * behavior).
   ...
   * built-in SAX ContentHandler, the IncrmentalSAXSource if we're bound to one and should receive
