...
public class SAX2DTM extends DTMDefaultBaseIterators
   ...
   *
   * Note that IncrementalSAXSource_Filter is package private, hence it can be statically referenced
   * using instanceof (CR 6537912).
   */
  ...
  public String getDocumentTypeDeclarationSystemIdentifier() {
    ...
    error(XMLMessages
        .createXMLMessage(XMLErrorResources.ER_METHOD_NOT_SUPPORTED, null));//"Not yet supported!");
