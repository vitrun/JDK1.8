...
public interface DTM {
   ...
   * representing the chunk's start position within the returned character buffer and the length of
   * the chunk.
   ...
   * this as <code>(firstNode.documentOrderPosition &lt;= secondNode.documentOrderPosition)</code>.
   */
