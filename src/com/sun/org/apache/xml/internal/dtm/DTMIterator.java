...
public interface DTMIterator {
   ...
   * which should provide: <ul> <li>a node (the context node... same value as "root" defined below)
   * </li> <li>a pair of non-zero positive integers (the context position and the context size)
   * </li> <li>a set of variable bindings </li> <li>a function library </li> <li>the set of
   * namespace declarations in scope for the expression.</li> <ul>
   *
   * <p>At this time the exact implementation of this environment is application dependent.
   * Probably a proper interface will be created fairly soon.</p>
   */
