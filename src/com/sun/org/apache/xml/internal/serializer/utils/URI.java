...
final class URI {
  ...
  public URI(String p_scheme, String p_userinfo, String p_host, int p_port, String p_path,
    ...
    if (p_scheme == null || p_scheme.trim().length() == 0) {
      throw new MalformedURIException(
          Utils.messages.createMessage(MsgKey.ER_SCHEME_REQUIRED, null)); //"Scheme is required!");
    }

    if (p_host == null) {
      if (p_userinfo != null) {
        throw new MalformedURIException(
            Utils.messages.createMessage(MsgKey.ER_NO_USERINFO_IF_NO_HOST,
                null)); //"Userinfo may not be specified if host is not specified!");
      }

      if (p_port != -1) {
        throw new MalformedURIException(
            Utils.messages.createMessage(MsgKey.ER_NO_PORT_IF_NO_HOST,
    ...
    if (p_path != null) {
      if (p_path.indexOf('?') != -1 && p_queryString != null) {
        throw new MalformedURIException(
            Utils.messages.createMessage(MsgKey.ER_NO_QUERY_STRING_IN_PATH,
                null)); //"Query string cannot be specified in path and query string!");
      }

      if (p_path.indexOf('#') != -1 && p_fragment != null) {
        throw new MalformedURIException(
            Utils.messages.createMessage(MsgKey.ER_NO_FRAGMENT_STRING_IN_PATH,
  ...
  private void initialize(URI p_base, String p_uriSpec)
    ...
    if (p_base == null
      ...
      throw new MalformedURIException(
          Utils.messages.createMessage(MsgKey.ER_CANNOT_INIT_URI_EMPTY_PARMS,
  ...
  private void initializeScheme(String p_uriSpec) throws MalformedURIException {
    ...
    if (scheme.length() == 0) {
      throw new MalformedURIException(Utils.messages
          .createMessage(MsgKey.ER_NO_SCHEME_INURI, null)); //"No scheme found in URI.");
    } else {
      setScheme(scheme);
    }
  }
    ...
    while (index < end) {
      ...
      if (testChar == '%') {
        if (index + 2 >= end || !isHex(p_uriSpec.charAt(index + 1))
          ...
          throw new MalformedURIException(
              Utils.messages.createMessage(MsgKey.ER_PATH_CONTAINS_INVALID_ESCAPE_SEQUENCE,
  ...
  public void setScheme(String p_scheme) throws MalformedURIException {
    ...
    if (p_scheme == null) {
      throw new MalformedURIException(Utils.messages
          .createMessage(MsgKey.ER_SCHEME_FROM_NULL_STRING,
  ...
  public void setHost(String p_host) throws MalformedURIException {
    ...
    if (p_host == null || p_host.trim().length() == 0) {
      ...
      throw new MalformedURIException(Utils.messages
          .createMessage(MsgKey.ER_HOST_ADDRESS_NOT_WELLFORMED,
  ...
  public void setPort(int p_port) throws MalformedURIException {
    ...
    if (p_port >= 0 && p_port <= 65535) {
      if (m_host == null) {
        throw new MalformedURIException(
            Utils.messages.createMessage(MsgKey.ER_PORT_WHEN_HOST_NULL,
                null)); //"Port cannot be set when host is null!");
      }
    } else if (p_port != -1) {
      throw new MalformedURIException(
          Utils.messages.createMessage(MsgKey.ER_INVALID_PORT, null)); //"Invalid port number!");
    }
  ...
  public void setFragment(String p_fragment) throws MalformedURIException {
    ...
    if (p_fragment == null) {
      ...
      throw new MalformedURIException(
          Utils.messages.createMessage(MsgKey.ER_FRAG_FOR_GENERIC_URI,
              null)); //"Fragment can only be set for a generic URI!");
    } else if (getPath() == null) {
      throw new MalformedURIException(
          Utils.messages.createMessage(MsgKey.ER_FRAG_WHEN_PATH_NULL,
              null)); //"Fragment cannot be set when path is null!");
    } else if (!isURIString(p_fragment)) {
      throw new MalformedURIException(Utils.messages.createMessage(MsgKey.ER_FRAG_INVALID_CHAR,
  ...
  public boolean equals(Object p_test) {
    ...
    if (p_test instanceof URI) {
      ...
      if (((m_scheme == null && testURI.m_scheme == null) || (m_scheme != null
          && testURI.m_scheme != null && m_scheme.equals(
          testURI.m_scheme))) && ((m_userinfo == null && testURI.m_userinfo == null) || (
          m_userinfo != null && testURI.m_userinfo != null && m_userinfo.equals(
              testURI.m_userinfo))) && ((m_host == null && testURI.m_host == null) || (
          m_host != null && testURI.m_host != null && m_host.equals(
              testURI.m_host))) && m_port == testURI.m_port && (
          (m_path == null && testURI.m_path == null) || (m_path != null && testURI.m_path != null
              && m_path.equals(
              testURI.m_path))) && ((m_queryString == null && testURI.m_queryString == null) || (
          m_queryString != null && testURI.m_queryString != null && m_queryString.equals(
              testURI.m_queryString))) && ((m_fragment == null && testURI.m_fragment == null) || (
          m_fragment != null && testURI.m_fragment != null && m_fragment.equals(
              testURI.m_fragment)))) {
        return true;
      }
    }
