...
public interface EncryptedKey extends EncryptedType {
   ...
   * respectively.
   *
   * @return an <code>Iterator</code> over all the <code>ReferenceList</code>s contained in this
   ...
   *
   * @return over all the carried names contained in this <code>EncryptedKey</code>.
   */
