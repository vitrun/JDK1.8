...
public interface CipherReference {
   ...
   * dereferenced.
   *
   * @return an <code>URI</code> that contains an identifier that should be dereferenced.
   */
  String getURI();
   ...
   *
   * @return the transform that specifies how to transform the reference to yield the intended
   * cipher value.
   */
   ...
   * <code>URI</code> to yield the appropriate cipher value.
   *
   * @param transforms the set of <code>Transforms</code> that specifies how to transform the
   * reference to yield the intended cipher value.
   */
