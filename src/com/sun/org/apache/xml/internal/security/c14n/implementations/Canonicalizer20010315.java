...
public abstract class Canonicalizer20010315 extends CanonicalizerBase {
  ...
  /**
   * Returns the Attr[]s to be output for the given element. <br> IMPORTANT: This method expects to
   * work on a modified DOM tree, i.e. a DOM which has been prepared using {@link
