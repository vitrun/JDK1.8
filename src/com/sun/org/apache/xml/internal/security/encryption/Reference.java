...
public interface Reference {
   ...
   *
   * @return an Uniform Resource Identifier that qualifies an <code>EncryptedType</code>.
   */
  String getURI();
   ...
   * <code>EncryptedKey</code> element.
   *
   * @param uri the Uniform Resource Identifier that qualifies an <code>EncryptedType</code>.
   */
