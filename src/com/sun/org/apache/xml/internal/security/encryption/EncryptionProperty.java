...
public interface EncryptionProperty {
   ...
   *
   * @return the <code>EncryptedType</code> being described by this <code>EncryptionProperty</code>.
   */
  String getTarget();
   ...
   *
   * @return an <code>Iterator</code> over all the additional encryption information contained in
   * this class.
   */
