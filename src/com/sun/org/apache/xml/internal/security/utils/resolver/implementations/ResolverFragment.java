 ...
 * @see <A HREF="http://www.w3.org/TR/xmldsig-core/#sec-ReferenceProcessingModel">The Reference
 * processing model in the XML Signature spec</A>
 * @see <A HREF="http://www.w3.org/TR/xmldsig-core/#sec-Same-Document">Same-Document URI-References
 * in the XML Signature spec</A>
...
public class ResolverFragment extends ResourceResolverSpi {
  ...
  public boolean engineCanResolveURI(ResourceResolverContext context) {
    ...
    if (log.isLoggable(java.util.logging.Level.FINE)) {
      log.log(java.util.logging.Level.FINE,
          "Do not seem to be able to resolve reference: \"" + context.uriToResolve + "\"");
    }
    return false;
  }
