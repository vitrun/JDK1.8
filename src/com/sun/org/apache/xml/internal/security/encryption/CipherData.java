...
public interface CipherData {
   ...
   *
   * @return <code>VALUE_TYPE</code> if the encrypted data is contained as <code>CipherValue</code>
   * or <code>REFERENCE_TYPE</code> if the encrypted data is contained as
   * <code>CipherReference</code>.
   */
  int getDataType();
   ...
   *
   * @return the reference to an external location containing the encrypted octet sequence.
   */
