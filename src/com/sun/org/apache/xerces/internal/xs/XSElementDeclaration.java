...
public interface XSElementDeclaration extends XSTerm {
   ...
   *
   * @param disallowed { <code>DERIVATION_SUBSTITUTION, DERIVATION_EXTENSION,
   * DERIVATION_RESTRICTION</code> } or <code>DERIVATION_NONE</code>. Represents a block set for the
   * element.
