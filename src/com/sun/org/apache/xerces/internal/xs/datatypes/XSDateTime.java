...
public interface XSDateTime {
  ...
  /**
   * @return a new date-time related object with normalized values (has no effect on objects already
   * normalized)
   */
  public XSDateTime normalize();

  /**
   * @return whether a date-time related object is normalized or not (value is not useful for types
   * where timezone is not specified)
   */
