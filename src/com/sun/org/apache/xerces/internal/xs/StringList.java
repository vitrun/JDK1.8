...
public interface StringList extends List {
   ...
   * @return The <code>GenericString</code> at the <code>index</code>th position in the
   * <code>StringList</code>, or <code>null</code> if the index specified is not valid.
   */
