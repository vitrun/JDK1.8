...
public final class XMLSecurityManager {
  ...
  public static enum Limit {
    ...
    ENTITY_EXPANSION_LIMIT(Constants.JDK_ENTITY_EXPANSION_LIMIT,
    ...
    ELEMENT_ATTRIBUTE_LIMIT(Constants.JDK_ELEMENT_ATTRIBUTE_LIMIT,
        Constants.SP_ELEMENT_ATTRIBUTE_LIMIT, 0, 10000),
    TOTAL_ENTITY_SIZE_LIMIT(Constants.JDK_TOTAL_ENTITY_SIZE_LIMIT,
        Constants.SP_TOTAL_ENTITY_SIZE_LIMIT, 0, 50000000),
    GENERAL_ENTITY_SIZE_LIMIT(Constants.JDK_GENERAL_ENTITY_SIZE_LIMIT,
        Constants.SP_GENERAL_ENTITY_SIZE_LIMIT, 0, 0),
    PARAMETER_ENTITY_SIZE_LIMIT(Constants.JDK_PARAMETER_ENTITY_SIZE_LIMIT,
  ...
  static public XMLSecurityManager convert(Object value, XMLSecurityManager securityManager) {
    ...
    if (XMLSecurityManager.class.isAssignableFrom(value.getClass())) {
      ...
      if (SecurityManager.class.isAssignableFrom(value.getClass())) {
        ...
        securityManager
            .setLimit(Limit.MAX_OCCUR_NODE_LIMIT, State.APIPROPERTY, origSM.getMaxOccurNodeLimit());
