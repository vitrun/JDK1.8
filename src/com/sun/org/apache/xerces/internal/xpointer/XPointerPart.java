...
public interface XPointerPart {
   ...
   * @throws XNIException Thrown if the PointerPart string does not conform to the syntax defined by
   * its scheme.
   */
   ...
   *
   * @return True if the xpointer expression matches a fragment in the resource else returns false.
   * @throws XNIException Thrown to signal an error
   */
   ...
   *
   * @return True if the XPointer expression resolves to a non-element child of the current resource
   * fragment.
   * @throws XNIException Thrown to signal an error
   */
