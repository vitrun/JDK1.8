...
public class DateTimeDV extends AbstractDateTimeDV {
   ...
   *
   * @param str The lexical representation of dateTime object CCYY-MM-DDThh:mm:ss.sss with possible
  ...
  protected XMLGregorianCalendar getXMLGregorianCalendar(DateTimeData date) {
    return datatypeFactory
        .newXMLGregorianCalendar(BigInteger.valueOf(date.unNormYear), date.unNormMonth,
