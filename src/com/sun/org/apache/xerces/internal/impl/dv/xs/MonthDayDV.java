...
public class MonthDayDV extends AbstractDateTimeDV {
   ...
   *
   * @param str The lexical representation of gMonthDay object --MM-DD with possible time zone Z or
   * (-),(+)hh:mm
  ...
  protected XMLGregorianCalendar getXMLGregorianCalendar(DateTimeData date) {
    return datatypeFactory
        .newXMLGregorianCalendar(DatatypeConstants.FIELD_UNDEFINED, date.unNormMonth,
            date.unNormDay,
