...
public class ExsltDynamic extends ExsltBase {
  ...
  public static double max(ExpressionContext myContext, NodeList nl, String expr)
    ...
    if (myContext instanceof XPathContext.XPathExpressionContext) {
      ...
      throw new SAXNotSupportedException(XSLMessages
          .createMessage(XSLTErrorResources.ER_INVALID_CONTEXT_PASSED, new Object[]{myContext}));
    }
  ...
  public static XObject evaluate(ExpressionContext myContext, String xpathExpr)
    ...
    if (myContext instanceof XPathContext.XPathExpressionContext) {
      ...
      throw new SAXNotSupportedException(XSLMessages
          .createMessage(XSLTErrorResources.ER_INVALID_CONTEXT_PASSED,
