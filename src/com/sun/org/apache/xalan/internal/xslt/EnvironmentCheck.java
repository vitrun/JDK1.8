...
public class EnvironmentCheck {
   ...
   * @see #writeEnvironmentReport(Hashtable) for an equivalent that writes to a PrintWriter instead
   */
    ...
    try {
      ...
      if (null == h) {
        ...
        statusNode.appendChild(
            factory.createTextNode("appendEnvironmentReport called with null Hashtable!"));
...
//              || "xalan.jar".equalsIgnoreCase(jarName))
  ...
  static {
    ...
    jarVersions
        .put(new Long(1808883), "xerces.jar from xalan-j_2_2_D10,D11,D12 or xerces-1_4_3.bin");
