...
public class XStringForFSB extends XString {
  ...
  public XStringForFSB(FastStringBuffer val, int start, int length) {
    ...
    if (null == val) {
      throw new IllegalArgumentException(
          XSLMessages
              .createXPATHMessage(XPATHErrorResources.ER_FASTSTRINGBUFFER_CANNOT_BE_NULL, null));
    }
  }
  ...
  private XStringForFSB(String val) {
    ...
    throw new IllegalArgumentException(
        XSLMessages.createXPATHMessage(XPATHErrorResources.ER_FSB_CANNOT_TAKE_STRING,
