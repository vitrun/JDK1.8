...
//  }
   ...
   *
   * @return The previous <code>Node</code> in the set being iterated over, or<code>DTM.NULL</code>
  ...
  public void runTo(int index) {
    ...
    if (!m_cacheNodes) {
      throw new RuntimeException(
          XSLMessages.createXPATHMessage(XPATHErrorResources.ER_NODESETDTM_CANNOT_INDEX,
              null)); //"This NodeSetDTM can not do indexing or counting functions!");
    }
  ...
  public void addNode(int n) {
    ...
    if (!m_mutable) {
      throw new RuntimeException(XSLMessages
          .createXPATHMessage(XPATHErrorResources.ER_NODESETDTM_NOT_MUTABLE,
...
//  }
  ...
  public void setShouldCacheNodes(boolean b) {
    ...
    if (!isFresh()) {
      throw new RuntimeException(
          XSLMessages.createXPATHMessage(XPATHErrorResources.ER_CANNOT_CALL_SETSHOULDCACHENODE,
              null)); //"Can not call setShouldCacheNodes after nextNode has been called!");
    }
