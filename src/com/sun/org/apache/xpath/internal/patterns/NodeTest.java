...
public class NodeTest extends Expression {
   ...
   *
   * @param whatToShow Bit set defined mainly by {@link com.sun.org.apache.xml.internal.dtm.DTMFilter}.
   * @return the node type for the whatToShow.  Since whatToShow can specify multiple types, it will
   * return the first bit tested that is on, so the caller of this function should take care that
   * this is the function they really want to call.  If none of the known bits are set, this
