...
//      expr = quo(opPos); break;
      ...
      default:
        error(XPATHErrorResources.ER_UNKNOWN_OPCODE,
            new Object[]{
                Integer.toString(getOp(opPos))});  //"ERROR! Unknown op code: "+m_opMap[opPos]);
    }
//    if(null != expr)
...
//      return DTMFilter.SHOW_ALL;
   ...
   *
   * @param opPos The position of the first predicate the m_opMap array.
   * @param predicates An empty pre-determined array of {@link com.sun.org.apache.xpath.internal.Expression}s,
