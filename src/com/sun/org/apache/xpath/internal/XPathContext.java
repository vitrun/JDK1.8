...
//
   ...
   * a <a href="http://www.w3.org/TR/xpath#NT-UnionExpr">UnionExpr</a>.
   *
   * @param xpathString Must be a valid string expressing a <a href="http://www.w3.org/TR/xpath#NT-LocationPath>LocationPath</a>
   * or a <a href="http://www.w3.org/TR/xpath#NT-UnionExpr">UnionExpr</a>.
...
//
   ...
   * tree presented by the iterator. See the description of <code>NodeFilter</code> for the set of
   * possible <code>SHOW_</code> values.These flags can be combined using <code>OR</code>.
