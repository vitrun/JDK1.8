...
public class FuncExtFunction extends Function {
   ...
   * stack frame). NEEDSDOC @param globalsSize
   */
   ...
   *
   * @param namespace The namespace for the extension function, which should not normally be null or
   * empty.
   * @param extensionName The local name of the extension.
   * @param methodKey Unique method key, which is passed to ExtensionsTable#extFunction in order to
   * allow caching of the method.
   */
