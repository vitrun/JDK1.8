...
public class VariableStack implements Cloneable {
   ...
   * parameter arguments.
   *
   * <p>I use the link/unlink concept because of distant <a href="http://math.millikin.edu/mprogers/Courses/currentCourses/CS481-ComputerArchitecture/cs481.Motorola68000.html">
   ...
   * maximum number of variables that you can have allocated at one time in the new stack frame.
  ...
  public XObject getLocalVariable(XPathContext xctxt, int index)
    ...
    if (null == val) {
      throw new TransformerException(XSLMessages
          .createXPATHMessage(XPATHErrorResources.ER_VARIABLE_ACCESSED_BEFORE_BIND, null),
          xctxt.getSAXLocator());
    }
