...
/**
 * com/sun/corba/se/spi/activation/LocatorHelper.java . Generated by the IDL-to-Java compiler
  ...
  synchronized public static org.omg.CORBA.TypeCode type() {
    if (__typeCode == null) {
      __typeCode = org.omg.CORBA.ORB.init()
          .create_interface_tc(com.sun.corba.se.spi.activation.LocatorHelper.id(), "Locator");
    }
    return __typeCode;
  }
