...
/**
 * com/sun/corba/se/spi/activation/POANameHelper.java . Generated by the IDL-to-Java compiler
  ...
  synchronized public static org.omg.CORBA.TypeCode type() {
    if (__typeCode == null) {
      ...
      __typeCode = org.omg.CORBA.ORB.init()
          .create_alias_tc(com.sun.corba.se.spi.activation.POANameHelper.id(), "POAName",
              __typeCode);
    }
    return __typeCode;
  }
