...
/**
 * com/sun/corba/se/spi/activation/ORBPortInfoHelper.java . Generated by the IDL-to-Java compiler
      ...
      synchronized (org.omg.CORBA.TypeCode.class) {
        if (__typeCode == null) {
          ...
          _tcOf_members0 = org.omg.CORBA.ORB.init()
              .create_alias_tc(com.sun.corba.se.spi.activation.ORBidHelper.id(), "ORBid",
                  _tcOf_members0);
          ...
          _tcOf_members0 = org.omg.CORBA.ORB.init()
              .create_alias_tc(com.sun.corba.se.spi.activation.TCPPortHelper.id(), "TCPPort",
                  _tcOf_members0);
          ...
          __typeCode = org.omg.CORBA.ORB.init()
              .create_struct_tc(com.sun.corba.se.spi.activation.ORBPortInfoHelper.id(),
