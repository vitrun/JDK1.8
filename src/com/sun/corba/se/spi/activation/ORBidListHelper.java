...
/**
 * com/sun/corba/se/spi/activation/ORBidListHelper.java . Generated by the IDL-to-Java compiler
  ...
  synchronized public static org.omg.CORBA.TypeCode type() {
    if (__typeCode == null) {
      ...
      __typeCode = org.omg.CORBA.ORB.init()
          .create_alias_tc(com.sun.corba.se.spi.activation.ORBidHelper.id(), "ORBid", __typeCode);
      __typeCode = org.omg.CORBA.ORB.init().create_sequence_tc(0, __typeCode);
      __typeCode = org.omg.CORBA.ORB.init()
          .create_alias_tc(com.sun.corba.se.spi.activation.ORBidListHelper.id(), "ORBidList",
              __typeCode);
    }
    return __typeCode;
  }
