 ...
 * <p>
 *
 * @author Hemanth Puttaswamy </p> <p> A Cleaner Abstraction to provide a Monitored Attribute of
 *         type 'Long' </p>
 */
public abstract class LongMonitoredAttributeBase extends MonitoredAttributeBase {
   ...
   * <p>
   *
   * @param name of tthe MonitoredAttribute </p> <p>
   * @param description of the Attribute, Please provid a well thought out description, so that the
   * admin can make sense of the attribute supplied. </p>
   */
