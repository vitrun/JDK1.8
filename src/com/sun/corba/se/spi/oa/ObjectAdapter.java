...
public interface ObjectAdapter {
   ...
   * @throws ForwardException (a runtime exception) is thrown if the request is to be handled by a
   ...
   *
   * @throws OADestroyed is thrown when an OA has been destroyed, which requires a retry in the case
   * where an AdapterActivator is present.
   */
