...
public class PersistentBindingIterator extends BindingIteratorImpl {
   ...
   * @param aTable A hashtable containing InternalBindingValues which is the content of the
   * PersistentNamingContext.
   * @param java.lang.Exception a Java exception.
   * @throws Exception a Java exception thrown of the base class cannot initialize.
   */
