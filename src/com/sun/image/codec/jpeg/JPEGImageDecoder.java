...
public interface JPEGImageDecoder {
   ...
   *
   * @return Raster containg the image data.  Colorspace and other pertinent information can be
   * obtained from the JPEGDecodeParam object.
   * @throws ImageFormatException if irregularities in the JPEG stream or an unknown condition is
   * encountered.
   */
