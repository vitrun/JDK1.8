...
public interface JPEGEncodeParam
   ...
   *
   * @param huffTable JPEGHuffmanTable that will be assigned to index tableNum.
   * @param tableNum - the index of the table to be set.
   * @throws IllegalArgumentException - thrown if the tableNum is out of range.  Index must range in
   * value from 0 - 3.
   */
   ...
   *
   * @param density the horizontal pixel density, in units described by @see
   ...
   *
   * @param density The verticle pixel density, in units described by @see
   * JPEGParam.getDensityUnit.
   */
