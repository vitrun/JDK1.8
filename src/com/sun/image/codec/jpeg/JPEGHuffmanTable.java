...
public class JPEGHuffmanTable {
   ...
   *
   * @param lengths lengths[k] = # of symbols with codes of length k bits; lengths[0] is ignored
   * @param symbols symbols in order of increasing code length
   * @throws IllegalArgumentException if the length of <code>lengths</code> is greater than 17
   * @throws IllegalArgumentException if the length of <code>symbols</code> is greater than 256
   * @throws IllegalArgumentException if any of the values in <code>lengths</code> or
   ...
   *
   * @return A short array where array[k] = # of symbols in the table of length k. array[0] is
   * unused
   */
