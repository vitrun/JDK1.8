...
public class JPEGCodec {
   ...
   * given BufferedImage.
   *
   * @param bi A BufferedImage that is similar to the BufferedImage(s) that will encoded using the
   * returned JPEGEncodeParam object.
   */
   ...
   * @param colorID the COLOR_ID for the encoded data.  This should match the data in the raster.
   */
   ...
   * @param colorID the COLOR_ID for the encoded data.  This is used to set reasonable defaults in
   * the parameter object.  This must match the number of bands given.
   */
