...
public interface DoubleStream extends BaseStream<Double, DoubleStream> {
   ...
   * produces a {@code DoubleStream} of new values
   * @return the new stream
   ...
   * as {@link #generate(DoubleSupplier)}) or removing the ordering constraint with {@link
   ...
   * {@link #generate(DoubleSupplier)}) or removing the ordering constraint with {@link
   ...
   * @apiNote Elements sorted by increasing absolute magnitude tend to yield more accurate results.
   */
  double sum();
   ...
   * operation</a>.
   *
   * @return an {@code OptionalDouble} containing the minimum element of this stream, or an empty
   ...
   * operation</a>.
   *
   * @return an {@code OptionalDouble} containing the maximum element of this stream, or an empty
   * optional if the stream is empty
   */
  OptionalDouble max();
   ...
   * operation</a>.
   *
   * @return a {@code DoubleSummaryStatistics} describing various summary data about the elements of
   * this stream
   */
   ...
   * terminal operation</a>.
   *
   * @return an {@code OptionalDouble} describing the first element of this stream, or an empty
   ...
   *
   * @return an {@code OptionalDouble} describing some element of this stream, or an empty {@code
   * OptionalDouble} if the stream is empty
   * @see #findFirst()
   */
   ...
   * operation</a>.
   *
   * @return a {@code Stream} consistent of the elements of this stream, each boxed to a {@code
   * Double}
   */
  Stream<Double> boxed();
