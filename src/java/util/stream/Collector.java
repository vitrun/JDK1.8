 ...
 *
 * <p>Collectors are designed to be <em>composed</em>; many of the methods in {@link Collectors} are
 * functions that take a collector and produce a new collector.  For example, given the following
 * collector that computes the sum of the salaries of a stream of employees:
 *
 * <pre>{@code
