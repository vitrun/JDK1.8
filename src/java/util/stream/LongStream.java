...
public interface LongStream extends BaseStream<Long, LongStream> {
   ...
   * produces a {@code LongStream} of new values
   * @return the new stream
   ...
   * as {@link #generate(LongSupplier)}) or removing the ordering constraint with {@link
   ...
   * {@link #generate(LongSupplier)}) or removing the ordering constraint with {@link #unordered()}
   ...
   *
   * @return an {@code OptionalLong} containing the minimum element of this stream, or an empty
   ...
   * operation</a>.
   *
   * @return an {@code OptionalLong} containing the maximum element of this stream, or an empty
   * {@code OptionalLong} if the stream is empty
   */
  OptionalLong max();
   ...
   * operation</a>.
   *
   * @return a {@code LongSummaryStatistics} describing various summary data about the elements of
   * this stream
   */
   ...
   * terminal operation</a>.
   *
   * @return an {@code OptionalLong} describing the first element of this stream, or an empty {@code
   * OptionalLong} if the stream is empty
   */
   ...
   *
   * @return an {@code OptionalLong} describing some element of this stream, or an empty {@code
   * OptionalLong} if the stream is empty
   * @see #findFirst()
   */
   ...
   * operation</a>.
   *
   * @return a {@code Stream} consistent of the elements of this stream, each boxed to {@code Long}
   */
  Stream<Long> boxed();
