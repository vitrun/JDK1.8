...
public class Vector<E>
   ...
   * @throws ArrayStoreException if a component of this vector is not of a runtime type that can be
   ...
   *
   * @return the current capacity (the length of its internal data array, kept in the field {@code
   * elementData} of this vector)
   */
   ...
   * @return the index of the first occurrence of the specified element in this vector, or -1 if
   ...
   * the lowest index {@code i} such that <tt>(i&nbsp;&gt;=&nbsp;index&nbsp;&amp;&amp;&nbsp;(o==null&nbsp;?&nbsp;get(i)==null&nbsp;:&nbsp;o.equals(get(i))))</tt>,
   * or -1 if there is no such index.
   *
   * @param o element to search for
   * @param index index to start searching from
   * @return the index of the first occurrence of the element in this vector at position {@code
   * index} or later in the vector; {@code -1} if the element is not found.
   ...
   * the highest index {@code i} such that <tt>(i&nbsp;&lt;=&nbsp;index&nbsp;&amp;&amp;&nbsp;(o==null&nbsp;?&nbsp;get(i)==null&nbsp;:&nbsp;o.equals(get(i))))</tt>,
   * or -1 if there is no such index.
   *
   * @param o element to search for
   ...
   *
   * @param a the array into which the elements of the Vector are to be stored, if it is big enough;
   * otherwise, a new array of the same runtime type is allocated for this purpose.
   * @return an array containing the elements of the Vector
   * @throws ArrayStoreException if the runtime type of a is not a supertype of the runtime type of
   * every element in this Vector
   * @throws NullPointerException if the given array is null
   * @since 1.2
   */
  @SuppressWarnings("unchecked")
   ...
   * @throws ClassCastException if the types of one or more elements in this vector are incompatible
   ...
   * specified collection does not support null elements (<a href="Collection.html#optional-restrictions">optional</a>),
