...
public interface NavigableSet<E> extends SortedSet<E> {
   ...
   * if this set itself has a restricted range, and {@code fromElement} or {@code toElement} lies
   ...
   * (or, if the set has no comparator, if {@code toElement} does not implement {@link Comparable}).
   * Implementations may, but are not required to, throw this exception if {@code toElement} cannot
