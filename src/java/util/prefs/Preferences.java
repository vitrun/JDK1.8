...
public abstract class Preferences {
   ...
   * @return the system preference node associated with the package of which <tt>c</tt> is a member.
   * @throws NullPointerException if <tt>c</tt> is <tt>null</tt>.
   * @throws SecurityException if a security manager is present and it denies
   * <tt>RuntimePermission("preferences")</tt>.
   * @see RuntimePermission
   ...
   * <tt>key</tt>, or the backing store is inaccessible.
   * @throws IllegalStateException if this node (or an ancestor) has been removed with the {@link
   * #removeNode()} method.
   ...
   * @param def the value to be returned in the event that this preference node has no value
   * associated with <tt>key</tt> or the associated value cannot be interpreted as an int, or the
   ...
   * @param def the value to be returned in the event that this preference node has no value
   * associated with <tt>key</tt> or the associated value cannot be interpreted as a long, or the
   * backing store is inaccessible.
   ...
   * @param def the value to be returned in the event that this preference node has no value
   * associated with <tt>key</tt> or the associated value cannot be interpreted as a boolean, or the
   * backing store is inaccessible.
   ...
   * @param def the value to be returned in the event that this preference node has no value
   * associated with <tt>key</tt> or the associated value cannot be interpreted as a float, or the
   * backing store is inaccessible.
   ...
   * @param def the value to be returned in the event that this preference node has no value
   * associated with <tt>key</tt> or the associated value cannot be interpreted as a double, or the
   * backing store is inaccessible.
   ...
   * @param def the value to be returned in the event that this preference node has no value
   * associated with <tt>key</tt> or the associated value cannot be interpreted as a byte array, or
   ...
   *
   * @param pathName the path name of the node whose existence is to be checked.
   ...
   * @throws IllegalArgumentException if <tt>pcl</tt> was not a registered preference change
   ...
   * <tt>IOException</tt>.
   * @throws InvalidPreferencesFormatException Data on input stream does not constitute a valid XML
