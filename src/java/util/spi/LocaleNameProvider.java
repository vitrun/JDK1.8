...
public abstract class LocaleNameProvider extends LocaleServiceProvider {
   ...
   *
   * @param languageCode the language code string in the form of two to eight lower-case letters
   * between 'a' (U+0061) and 'z' (U+007A)
   * @param locale the desired locale
   * @return the name of the given language code for the specified locale, or null if it's not
   * available.
   * @throws NullPointerException if <code>languageCode</code> or <code>locale</code> is null
   * @throws IllegalArgumentException if <code>languageCode</code> is not in the form of two or
   * three lower-case letters, or <code>locale</code> isn't one of the locales returned from {@link
   * java.util.spi.LocaleServiceProvider#getAvailableLocales() getAvailableLocales()}.
   ...
   *
   * @param scriptCode the four letter script code string in the form of title-case letters (the
   * first letter is upper-case character between 'A' (U+0041) and 'Z' (U+005A) followed by three
   * lower-case character between 'a' (U+0061) and 'z' (U+007A)).
   * @param locale the desired locale
   ...
   * @throws IllegalArgumentException if <code>scriptCode</code> is not in the form of four title
   * case letters, or <code>locale</code> isn't one of the locales returned from {@link
   * java.util.spi.LocaleServiceProvider#getAvailableLocales() getAvailableLocales()}.
   ...
   * this method returns null.
   *
   * @param countryCode the country(region) code string in the form of two upper-case letters
   * between 'A' (U+0041) and 'Z' (U+005A) or the UN M.49 area code in the form of three digit
   * letters between '0' (U+0030) and '9' (U+0039).
   * @param locale the desired locale
   * @return the name of the given country code for the specified locale, or null if it's not
   * available.
   * @throws NullPointerException if <code>countryCode</code> or <code>locale</code> is null
   * @throws IllegalArgumentException if <code>countryCode</code> is not in the form of two
   * upper-case letters or three digit letters, or <code>locale</code> isn't one of the locales
   * returned from {@link java.util.spi.LocaleServiceProvider#getAvailableLocales()
   * getAvailableLocales()}.
   ...
   * @throws IllegalArgumentException if <code>locale</code> isn't one of the locales returned from
   * {@link java.util.spi.LocaleServiceProvider#getAvailableLocales() getAvailableLocales()}.
