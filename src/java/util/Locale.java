...
public final class Locale implements Cloneable, Serializable {
   ...
   * characters in length.  See the <code>Locale</code> class description about valid language
   * values.
   ...
   * @return The Unicode locale type associated with the key, or null if the locale does not define
   * the key.
   ...
   * used by ResourceBundle.
   *
   * @return locale exnteions of this Locale, or {@code null} if no extensions are defined
   */
   ...
   * @throws MissingResourceException Throws MissingResourceException if three-letter language
   ...
   * @throws MissingResourceException Throws MissingResourceException if the three-letter country
   * abbreviation is not available for this locale.
   */
   ...
   *
   * @return the display name of the script code for the current default {@link
   ...
   * @param listPattern should create a MessageFormat taking 0-3 arguments and formatting them into
   * a list.
   * @param listCompositionPattern should take 2 arguments and is used by composeList.
   ...
   * @return if the list is three elements or shorter, the same list; otherwise, a new list of three
   * elements.
   */
  ...
  /**
   * @serialField language    String language subtag in lower case. (See <a
   * href="java/util/Locale.html#getLanguage()">getLanguage()</a>)
   * @serialField country     String country subtag in upper case. (See <a
   * href="java/util/Locale.html#getCountry()">getCountry()</a>)
   * @serialField variant     String variant subtags separated by LOWLINE characters. (See <a
   * href="java/util/Locale.html#getVariant()">getVariant()</a>)
   * @serialField hashcode    int deprecated, for forward compatibility only
   * @serialField script      String script subtag in title case (See <a
   * href="java/util/Locale.html#getScript()">getScript()</a>)
   * @serialField extensions  String canonical representation of extensions, that is, BCP47
   * extensions in alphabetical order followed by BCP47 private use subtags, all in lower case
   * letters separated by HYPHEN-MINUS characters. (See <a href="java/util/Locale.html#getExtensionKeys()">getExtensionKeys()</a>,
   ...
   *
   * @return an instance of <code>Locale</code> equivalent to the deserialized <code>Locale</code>.
   */
  ...
  public static final class LanguageRange {
     ...
     *
     * @param range a language range
     * @param weight a weight value between {@code MIN_WEIGHT} and {@code MAX_WEIGHT}
     * @throws NullPointerException if the given {@code range} is {@code null}
     * @throws IllegalArgumentException if the given {@code weight} is less than {@code MIN_WEIGHT}
     ...
     *
     * @param ranges a list of comma-separated language ranges or a list of language ranges in the
     * form of the "Accept-Language" header defined in <a href="http://tools.ietf.org/html/rfc2616">RFC
     * 2616</a>
     * @return a Language Priority List consisting of language ranges included in the given {@code
     * ranges} and their equivalent language ranges if available. The list is modifiable.
     * @throws NullPointerException if {@code ranges} is null
     * @throws IllegalArgumentException if a language range or a weight found in the given {@code
     ...
     * @return a Language Priority List with customization. The list is modifiable.
     * @throws NullPointerException if {@code ranges} is null
     * @throws IllegalArgumentException if a language range or a weight found in the given {@code
     * ranges} is ill-formed
     * @see #parse(String)
     ...
     * @param map a map containing information to customize language ranges
     * @return a new Language Priority List with customization. The list is modifiable.
     ...
     * @return {@code true} if this object's {@code range} and {@code weight} are the same as the
     * {@code obj}'s; {@code false} otherwise.
     */
    @Override
    public boolean equals(Object obj) {
      if (this == obj) {
   ...
   *
   * @param priorityList user's Language Priority List in which each language tag is sorted in
   * descending order based on priority or weight
   * @param locales {@code Locale} instances used for matching
   * @param mode filtering mode
   * @return a list of {@code Locale} instances for matching language tags sorted in descending
   * order based on priority or weight, or an empty list if nothing matches. The list is
   * modifiable.
   * @throws NullPointerException if {@code priorityList} or {@code locales} is {@code null}
   * @throws IllegalArgumentException if one or more extended language ranges are included in the
   * given list when {@link FilteringMode#REJECT_EXTENDED_RANGES} is specified
   * @since 1.8
   */
   ...
   * @param mode filtering mode
   * @return a list of matching language tags sorted in descending order based on priority or
   * weight, or an empty list if nothing matches. The list is modifiable.
   * @throws NullPointerException if {@code priorityList} or {@code tags} is {@code null}
   * @throws IllegalArgumentException if one or more extended language ranges are included in the
   * given list when {@link FilteringMode#REJECT_EXTENDED_RANGES} is specified
   * @since 1.8
   */
   ...
   * descending order based on priority or weight
   * @param locales {@code Locale} instances used for matching
   * @return the best matching <code>Locale</code> instance chosen based on priority or weight, or
   ...
   * @return the best matching language tag chosen based on priority or weight, or {@code null} if
   * nothing matches.
   * @throws NullPointerException if {@code priorityList} or {@code tags} is {@code null}
   * @since 1.8
   */
