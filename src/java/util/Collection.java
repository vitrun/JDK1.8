 ...
 * synchronization protocol.  If a {@code Collection} implementation has a specific synchronization
...
public interface Collection<E> extends Iterable<E> {
   ...
   * collection (<a href="#optional-restrictions">optional</a>)
   * @throws NullPointerException if the specified element is null and this collection does not
   * permit null elements (<a href="#optional-restrictions">optional</a>)
   */
   ...
   * incompatible with this collection (<a href="#optional-restrictions">optional</a>)
   * @throws NullPointerException if the specified collection contains one or more null elements and
   * this collection does not permit null elements (<a href="#optional-restrictions">optional</a>),
   ...
   * incompatible with the specified collection (<a href="#optional-restrictions">optional</a>)
   * @throws NullPointerException if this collection contains one or more null elements and the
   * specified collection does not support null elements (<a href="#optional-restrictions">optional</a>),
   * or if the specified collection is null
   * @see #remove(Object)
   * @see #contains(Object)
   */
   ...
   * Implementations may throw this exception if a matching element cannot be removed or if, in
   * general, removal is not supported.
   ...
   * incompatible with the specified collection (<a href="#optional-restrictions">optional</a>)
   * @throws NullPointerException if this collection contains one or more null elements and the
   * specified collection does not permit null elements (<a href="#optional-restrictions">optional</a>),
   * or if the specified collection is null
   * @see #remove(Object)
   * @see #contains(Object)
   */
   ...
   * spliterator from the collections's {@code Iterator}.  The spliterator inherits the
   * <em>fail-fast</em> properties of the collection's iterator. <p> The created {@code Spliterator}
   * reports {@link Spliterator#SIZED}.
   * @implNote The created {@code Spliterator} additionally reports {@link Spliterator#SUBSIZED}.
   *
   * <p>If a spliterator covers no elements then the reporting of additional characteristic values,
   * beyond that of {@code SIZED} and {@code SUBSIZED}, does not aid clients to control, specialize
   * or simplify computation. However, this does enable shared use of an immutable and empty
   * spliterator instance (see {@link Spliterators#emptySpliterator()}) for empty collections, and
