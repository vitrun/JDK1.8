...
public interface Map<K, V> {
   ...
   * @throws ClassCastException if the class of a replacement value prevents it from being stored in
   * this map
   ...
   * @throws ClassCastException if a replacement value is of an inappropriate type for this map (<a
   * href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
   * @throws NullPointerException if function or a replacement value is null, and this map does not
   * permit null keys or values (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
   * @throws IllegalArgumentException if some property of a replacement value prevents it from being
   * stored in this map (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
   * @throws ConcurrentModificationException if an entry is found to be removed during iteration
   ...
   * }</pre>
   *
   * <p>The default implementation makes no guarantees about synchronization or atomicity properties
   * of this method. Any implementation providing atomicity guarantees must override this method and
   * document its concurrency properties.
   * @since 1.8
   */
   ...
   * permit null keys or values (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
   * @throws IllegalArgumentException if some property of the specified key or value prevents it
   * from being stored in this map (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
   * @implSpec The default implementation is equivalent to, for this {@code map}:
   *
   * <pre> {@code
   * V v = map.get(key);
   ...
   * map (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
   * @throws ClassCastException if the key or value is of an inappropriate type for this map (<a
   * href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
   * @throws NullPointerException if the specified key or value is null, and this map does not
   * permit null keys or values (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
   ...
   * null values if oldValue is null unless newValue is also null.
   *
   * <p>The default implementation makes no guarantees about synchronization or atomicity properties
   * of this method. Any implementation providing atomicity guarantees must override this method and
   * document its concurrency properties.
   ...
   * <p>The default implementation makes no guarantees about synchronization or atomicity properties
   * of this method. Any implementation providing atomicity guarantees must override this method and
   * document its concurrency properties. In particular, all implementations of subinterface {@link
   * java.util.concurrent.ConcurrentMap} must document whether the function is applied once
   * atomically only if the value is not present.
   * @since 1.8
   */
   ...
   * or, if no existing value or a null value is associated with the key, to be associated with the
   * key
   ...
   * stored in this map (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
   * @throws NullPointerException if the specified key is null and this map does not support null
   * keys or the value or remappingFunction is null
   * @implSpec The default implementation is equivalent to performing the following steps for this
   * {@code map}, then returning the current value or {@code null} if absent:
   *
   * <pre> {@code
