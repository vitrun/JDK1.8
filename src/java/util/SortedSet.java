...
public interface SortedSet<E> extends Set<E> {
   ...
   *
   * @return the comparator used to order the elements in this set, or <tt>null</tt> if this set
   ...
   * @return a view of the portion of this set whose elements range from <tt>fromElement</tt>,
   * inclusive, to <tt>toElement</tt>, exclusive
   * @throws ClassCastException if <tt>fromElement</tt> and <tt>toElement</tt> cannot be compared to
   ...
   * <tt>fromElement</tt> or <tt>toElement</tt> cannot be compared to elements currently in the
   * set.
   * @throws NullPointerException if <tt>fromElement</tt> or <tt>toElement</tt> is null and this set
   * does not permit null elements
   * @throws IllegalArgumentException if <tt>fromElement</tt> is greater than <tt>toElement</tt>; or
   * if this set itself has a restricted range, and <tt>fromElement</tt> or <tt>toElement</tt> lies
   ...
   * <tt>toElement</tt>
   * @throws ClassCastException if <tt>toElement</tt> is not compatible with this set's comparator
   * (or, if the set has no comparator, if <tt>toElement</tt> does not implement {@link
   * Comparable}). Implementations may, but are not required to, throw this exception if
   * <tt>toElement</tt> cannot be compared to elements currently in the set.
   * @throws NullPointerException if <tt>toElement</tt> is null and this set does not permit null
   * elements
   ...
   * <tt>fromElement</tt>
   * @throws ClassCastException if <tt>fromElement</tt> is not compatible with this set's comparator
   * (or, if the set has no comparator, if <tt>fromElement</tt> does not implement {@link
   * Comparable}). Implementations may, but are not required to, throw this exception if
   * <tt>fromElement</tt> cannot be compared to elements currently in the set.
   * @throws NullPointerException if <tt>fromElement</tt> is null and this set does not permit null
   * elements
   * @throws IllegalArgumentException if this set itself has a restricted range, and
   ...
   * spliterator from the sorted set's {@code Iterator}.  The spliterator inherits the
   * <em>fail-fast</em> properties of the set's iterator.  The spliterator's comparator is the same
   * as the sorted set's comparator. <p> The created {@code Spliterator} additionally reports {@link
   * Spliterator#SIZED}.
