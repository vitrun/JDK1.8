...
public interface Comparator<T> {
   ...
   * @apiNote For example, to sort a collection of {@code String} based on the length and then
   * case-insensitive natural ordering, the comparator can be composed using following code,
   *
   * <pre>{@code
   ...
   * @implSpec This default implementation behaves as if {@code thenComparing(comparing(keyExtractor,
   * cmp))}.
   ...
   * @throws NullPointerException if the argument is null.
   * @implSpec This default implementation behaves as if {@code thenComparing(comparingInt(keyExtractor))}.
   ...
   * @throws NullPointerException if the argument is null.
   * @implSpec This default implementation behaves as if {@code thenComparing(comparingLong(keyExtractor))}.
   ...
   * @throws NullPointerException if the argument is null.
   * @implSpec This default implementation behaves as if {@code thenComparing(comparingDouble(keyExtractor))}.
   ...
   * @throws NullPointerException if either argument is null
   * @apiNote For example, to obtain a {@code Comparator} that compares {@code Person} objects by
