...
public interface Set<E> extends Collection<E> {
   ...
   * incompatible with this set (<a href="Collection.html#optional-restrictions">optional</a>)
   * @throws NullPointerException if the specified collection contains one or more null elements and
   * this set does not permit null elements (<a href="Collection.html#optional-restrictions">optional</a>),
   ...
   * @throws NullPointerException if the specified collection contains one or more null elements and
   * this set does not permit null elements, or if the specified collection is null
   ...
   * spliterator from the set's {@code Iterator}.  The spliterator inherits the <em>fail-fast</em>
   * properties of the set's iterator. <p> The created {@code Spliterator} additionally reports
