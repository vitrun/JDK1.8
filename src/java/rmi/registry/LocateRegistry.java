...
public final class LocateRegistry {
   ...
   * @param host host for the remote registry
   * @param port port on which the registry accepts requests
   * @param csf client-side <code>Socket</code> factory used to make connections to the registry.
   * If <code>csf</code> is null, then the default client-side <code>Socket</code> factory will be
   ...
   * @param port port on which the registry accepts requests
   * @param csf client-side <code>Socket</code> factory used to make connections to the registry
   * @param ssf server-side <code>ServerSocket</code> factory used to accept connections to the
   * registry
   * @return the registry
   * @throws RemoteException if the registry could not be exported
   * @since 1.2
