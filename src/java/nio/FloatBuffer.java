...
public abstract class FloatBuffer
   ...
   * @param offset The offset within the array of the first float to be written; must be
   * non-negative and no larger than <tt>dst.length</tt>
   * @param length The maximum number of floats to be written to the given array; must be
   * non-negative and no larger than <tt>dst.length - offset</tt>
   * @return This buffer
   * @throws BufferUnderflowException If there are fewer than <tt>length</tt> floats remaining in
   * this buffer
   * @throws IndexOutOfBoundsException If the preconditions on the <tt>offset</tt> and
   * <tt>length</tt> parameters do not hold
   */
   ...
   * @param offset The offset within the array of the first float to be read; must be non-negative
   * and no larger than <tt>array.length</tt>
   * @param length The number of floats to be read from the given array; must be non-negative and no
