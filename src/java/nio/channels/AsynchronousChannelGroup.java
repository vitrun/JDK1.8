...
public abstract class AsynchronousChannelGroup {
   ...
   *
   * @return {@code true} if this asynchronous channel group is shutdown or has been marked for
   * shutdown.
   */
   ...
   * @return {@code true} if the group has terminated; {@code false} if the timeout elapsed before
   * termination
