...
public abstract class SocketChannel
  ...
  /**
   * @throws ConnectionPendingException If a non-blocking connect operation is already in progress
   * on this channel
   ...
   *
   * @return <tt>true</tt> if, and only if, this channel's network socket is {@link #isOpen open}
   * and connected
   */
   ...
   * channel.
   *
   * @return <tt>true</tt> if, and only if, a connection operation has been initiated on this
   * channel but not yet completed by invoking the {@link #finishConnect finishConnect} method
   */
   ...
   * @return <tt>true</tt> if a connection was established, <tt>false</tt> if this channel is in
   ...
   * @throws ConnectionPendingException If a non-blocking connection operation is already in
   ...
   * will be closed.  </p>
   *
   * @return <tt>true</tt> if, and only if, this channel's socket is now connected
   * @throws NoConnectionPendingException If this channel is not connected and a connection
