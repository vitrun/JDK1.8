...
public interface MulticastChannel
   ...
   * InetAddress#isMulticastAddress multicast} address, or the group parameter is an address type
   ...
   * @throws UnsupportedOperationException If the channel's socket is not an Internet Protocol
   * socket
   * @throws ClosedChannelException If this channel is closed
   * @throws IOException If an I/O error occurs
   * @throws SecurityException If a security manager is set, and its {@link
   * SecurityManager#checkMulticast(InetAddress) checkMulticast} method denies access to the
   * multiast group
   */
   ...
   * @return The membership key
   * @throws IllegalArgumentException If the group parameter is not a {@link
   * InetAddress#isMulticastAddress multicast} address, the source parameter is not a unicast
   * address, the group parameter is an address type that is not supported by this channel, or the
   ...
   * @throws UnsupportedOperationException If the channel's socket is not an Internet Protocol
   * socket or source filtering is not supported
   * @throws ClosedChannelException If this channel is closed
   * @throws IOException If an I/O error occurs
   * @throws SecurityException If a security manager is set, and its {@link
   * SecurityManager#checkMulticast(InetAddress) checkMulticast} method denies access to the
