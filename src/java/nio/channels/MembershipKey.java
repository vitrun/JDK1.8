...
public abstract class MembershipKey {
   ...
   *
   * @return {@code true} if this membership key is valid, {@code false} otherwise
   */
   ...
   * @throws IllegalArgumentException If the {@code source} parameter is not a unicast address or is
   * not the same address type as the multicast group
   * @throws IllegalStateException If this membership key is source-specific or is no longer valid
   * @throws UnsupportedOperationException If the underlying operating system does not support
   * source filtering
   ...
   *
   * @return The source address if this membership key is source-specific, otherwise {@code null}
   */
