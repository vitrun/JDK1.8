...
public abstract class Selector implements Closeable {
   ...
   *
   * @return The number of keys, possibly zero, whose ready-operation sets were updated by the
   * selection operation
   * @throws IOException If an I/O error occurs
   * @throws ClosedSelectorException If this selector is closed
   */
   ...
   *
   * @param timeout If positive, block for up to <tt>timeout</tt> milliseconds, more or less, while
   * waiting for a channel to become ready; if zero, block indefinitely; must not be negative
