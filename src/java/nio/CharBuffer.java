...
public abstract class CharBuffer
   ...
   * <tt>array.length - offset</tt>. The new buffer's limit will be set to <tt>offset +
   * length</tt>.
   * @return The new char buffer
   ...
   * @param start The index of the first character to be used; must be non-negative and no larger
   * than <tt>csq.length()</tt>. The new buffer's position will be set to this value.
   * @param end The index of the character following the last character to be used; must be no
   * smaller than <tt>start</tt> and no larger than <tt>csq.length()</tt>. The new buffer's limit
   ...
   * @param offset The offset within the array of the first char to be written; must be non-negative
   * and no larger than <tt>dst.length</tt>
   * @param length The maximum number of chars to be written to the given array; must be
   * non-negative and no larger than <tt>dst.length - offset</tt>
   * @return This buffer
   * @throws BufferUnderflowException If there are fewer than <tt>length</tt> chars remaining in
   * this buffer
   * @throws IndexOutOfBoundsException If the preconditions on the <tt>offset</tt> and
   * <tt>length</tt> parameters do not hold
   */
   ...
   * @param offset The offset within the array of the first char to be read; must be non-negative
   * and no larger than <tt>array.length</tt>
   * @param length The number of chars to be read from the given array; must be non-negative and no
   ...
   * @param start The offset within the string of the first char to be read; must be non-negative
   * and no larger than <tt>string.length()</tt>
   * @param end The offset within the string of the last char to be read, plus one; must be
   ...
   * position.
   *
   * @param index The index of the character to be read, relative to the position; must be
   ...
   *
   * @param start The index, relative to the current position, of the first character in the
   * subsequence; must be non-negative and no larger than <tt>remaining()</tt>
   * @param end The index, relative to the current position, of the character following the last
   * character in the subsequence; must be no smaller than <tt>start</tt> and no larger than
   * <tt>remaining()</tt>
   * @return The new character buffer
   * @throws IndexOutOfBoundsException If the preconditions on <tt>start</tt> and <tt>end</tt> do
   * not hold
   */
   ...
   * characters <tt>"null"</tt> are appended to this character buffer.
   * @return This buffer
   * @throws BufferOverflowException If there is insufficient space in this buffer
   * @throws ReadOnlyBufferException If this buffer is read-only
   * @since 1.5
