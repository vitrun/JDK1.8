...
public interface WatchKey {
   ...
   *
   * @return {@code true} if the watch key is valid and has been reset, and {@code false} if the
   * watch key could not be reset because it is no longer {@link #isValid valid}
   */
  boolean reset();
