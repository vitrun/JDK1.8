...
public interface UserDefinedFileAttributeView
   ...
   * and it denies {@link RuntimePermission}<tt>("accessUserDefinedAttributes")</tt> or its {@link
   ...
   * @throws ArithmeticException If the size of the attribute is larger than {@link
   * Integer#MAX_VALUE}
   * @throws IOException If an I/O error occurs
   * @throws SecurityException In the case of the default provider, a security manager is installed,
   * and it denies {@link RuntimePermission}<tt>("accessUserDefinedAttributes")</tt> or its {@link
   ...
   * @throws IOException If an I/O error occurs or there is insufficient space in the destination
   * buffer for the attribute value
   * @throws SecurityException In the case of the default provider, a security manager is installed,
   * and it denies {@link RuntimePermission}<tt>("accessUserDefinedAttributes")</tt> or its {@link
   * SecurityManager#checkRead(String) checkRead} method denies read access to the file.
   * @see #size
