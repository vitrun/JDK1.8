...
public abstract class Charset
   ...
   * Registry</a>.
   *
   * @return <tt>true</tt> if, and only if, this charset is known by its implementor to be
   ...
   * @return A negative integer, zero, or a positive integer as this charset is less than, equal to,
   * or greater than the specified charset
   */
   ...
   *
   * @return <tt>true</tt> if, and only if, this charset is equal to the given object
   */
