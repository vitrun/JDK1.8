...
public abstract class Process {
   ...
   * @return the exit value of the subprocess represented by this {@code Process} object.  By
   * convention, the value {@code 0} indicates normal termination.
   * @throws IllegalThreadStateException if the subprocess represented by this {@code Process}
   ...
   *
   * @return the {@code Process} object representing the subprocess to be forcibly destroyed.
   * @since 1.8
   */
   ...
   * alive.
   *
   * @return {@code true} if the subprocess represented by this {@code Process} object has not yet
   * terminated.
   * @since 1.8
   */
