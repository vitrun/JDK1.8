...
public interface MemoryPoolMXBean extends PlatformManagedObject {
   ...
   *
   * @return a {@link MemoryUsage} object; or <tt>null</tt> if this pool not valid.
   */
   ...
   * {@link MemoryUsage#from MemoryUsage}.
   *
   * @return a {@link MemoryUsage} object representing the peak memory usage; or <tt>null</tt> if
   ...
   *
   * @return <tt>true</tt> if the memory pool is valid in the running Java virtual machine;
   ...
   *
   * @return an array of <tt>String</tt> objects, each is the name of a memory manager managing this
   * memory pool.
   */
   ...
   * @throws UnsupportedOperationException if this memory pool does not support a usage threshold.
   ...
   * @throws IllegalArgumentException if <tt>threshold</tt> is negative or greater than the maximum
   ...
   *
   * @return <tt>true</tt> if the memory usage of this memory pool reaches or exceeds the threshold
   ...
   *
   * @return <tt>true</tt> if this memory pool supports usage threshold; <tt>false</tt> otherwise.
   */
   ...
   * @throws UnsupportedOperationException if this memory pool does not support a collection usage
   * threshold.
   ...
   *
   * @return <tt>true</tt> if the memory usage of this memory pool reaches or exceeds the collection
   * usage threshold value in the most recent collection; <tt>false</tt> otherwise.
   * @throws UnsupportedOperationException if this memory pool does not support a usage threshold.
   */
   ...
   *
   * @return the number of times that the memory usage has reached or exceeded the collection usage
   * threshold.
   * @throws UnsupportedOperationException if this memory pool does not support a collection usage
   * threshold.
   * @see #isCollectionUsageThresholdSupported
   ...
   * {@link MemoryUsage#from MemoryUsage}.
   *
   * @return a {@link MemoryUsage} representing the memory usage of this memory pool after the Java
   * virtual machine most recently expended effort in recycling unused objects; <tt>null</tt> if
   ...
   *
   * @return <tt>true</tt> if this memory pool supports the collection usage threshold;
   * <tt>false</tt> otherwise.
   */
