...
public class SecurityManager {
   ...
   *
   * @deprecated This type of security checking is not recommended. It is recommended that the
   * <code>checkPermission</code> call be used instead.
   */
  @Deprecated
   ...
   *
   * @return the value of the <code>inCheck</code> field. This field should contain
   * <code>true</code> if a security check is in progress, <code>false</code> otherwise.
   ...
   *
   * @throws java.lang.SecurityException if a security manager already exists and its
   ...
   * </ol>
   *
   * @return the class loader of the most recent occurrence on the stack of a method from a class
   ...
   * </ol>
   *
   * @return the class  of the most recent occurrence on the stack of a method from a class defined
   * using a non-system class loader.
   * @see java.lang.ClassLoader#getSystemClassLoader() getSystemClassLoader
   * @see #checkPermission(java.security.Permission) checkPermission
   * @deprecated This type of security checking is not recommended. It is recommended that the
   * <code>checkPermission</code> call be used instead.
   ...
   * @return the depth on the stack frame of the first occurrence of a method from a class with the
   * specified name; <code>-1</code> if such a frame cannot be found.
   * @deprecated This type of security checking is not recommended. It is recommended that the
   * <code>checkPermission</code> call be used instead.
   */
  @Deprecated
   ...
   * </ol>
   *
   * @return the depth on the stack frame of the most recent occurrence of a method from a class
   * defined using a non-system class loader.
   * @see java.lang.ClassLoader#getSystemClassLoader() getSystemClassLoader
   * @see #checkPermission(java.security.Permission) checkPermission
   * @deprecated This type of security checking is not recommended. It is recommended that the
   ...
   * @return <code>true</code> if a method from a class with the specified name is on the execution
   ...
   *
   * @return <code>true</code> if a call to <code>currentClassLoader</code> has a non-null return
   * value.
   ...
   * <code>AccessControlContext</code> (e.g., is <code>null</code>), or is denied access to the
   ...
   * subprocess.
   * @throws NullPointerException if the <code>cmd</code> argument is <code>null</code>.
   ...
   * the library.
   * @throws NullPointerException if the <code>lib</code> argument is <code>null</code>.
   ...
   * @throws NullPointerException if the file descriptor argument is <code>null</code>.
   ...
   * @param context a system-dependent security context.
   * @throws SecurityException if the specified security context is not an instance of
   * <code>AccessControlContext</code> (e.g., is <code>null</code>), or does not have permission to
   ...
   * @throws NullPointerException if the <code>host</code> argument is <code>null</code>.
   * @see #checkPermission(java.security.Permission) checkPermission
   */
   ...
   * @throws SecurityException if the specified security context is not an instance of
   * <code>AccessControlContext</code> (e.g., is <code>null</code>), or does not have permission to
   * open a socket connection to the specified <code>host</code> and <code>port</code>.
   * @throws NullPointerException if the <code>host</code> argument is <code>null</code>.
   * @see java.lang.SecurityManager#getSecurityContext()
   * @see java.security.AccessControlContext#checkPermission(java.security.Permission)
   */
   ...
   * IP multicast.
   * @throws NullPointerException if the address argument is <code>null</code>.
   * @see #checkPermission(java.security.Permission) checkPermission
   * @since JDK1.1
   */
   ...
   * @throws NullPointerException if the <code>key</code> argument is <code>null</code>.
   ...
   * @return <code>true</code> if the calling thread is trusted to put up top-level windows;
   * <code>false</code> otherwise.
   * @throws NullPointerException if the <code>window</code> argument is <code>null</code>.
   * @see java.awt.Window
   * @see #checkPermission(java.security.Permission) checkPermission
   * @deprecated The dependency on {@code AWTPermission} creates an impediment to future
   * modularization of the Java platform. Users of this method should instead invoke {@link
   * #checkPermission} directly. This method will be changed in a future release to check the
   ...
   * exception.
   *
   * @throws SecurityException if the calling thread does not have permission to access the system
   * clipboard.
   * @see #checkPermission(java.security.Permission) checkPermission
   * @since JDK1.1
   * @deprecated The dependency on {@code AWTPermission} creates an impediment to future
   ...
   * exception.
   *
   * @throws SecurityException if the calling thread does not have permission to access the AWT
   * event queue.
   * @see #checkPermission(java.security.Permission) checkPermission
   * @since JDK1.1
   * @deprecated The dependency on {@code AWTPermission} creates an impediment to future
   ...
   * @throws SecurityException if the calling thread does not have permission to access the
   * specified package.
   * @throws NullPointerException if the package name argument is <code>null</code>.
   ...
   * @throws SecurityException if the caller does not have permission to access members.
   * @throws NullPointerException if the <code>clazz</code> argument is <code>null</code>.
   * @see java.lang.reflect.Member
   * @see #checkPermission(java.security.Permission) checkPermission
   * @since JDK1.1
   * @deprecated This method relies on the caller being at a stack depth of 4 which is error-prone
   * and cannot be enforced by the runtime. Users of this method should instead invoke {@link
   * #checkPermission} directly.  This method will be changed in a future release to check the
   * permission {@code java.security.AllPermission}.
   */
  @Deprecated
