...
public interface CookieStore {
   ...
   *
   * @param uri the uri this cookie associated with. if {@code null}, this cookie will not be
   ...
   *
   * @return an immutable list of URIs; return empty list if no cookie in this cookie store is
   * associated with an URI
   */
   ...
   *
   * @param uri the uri this cookie associated with. if {@code null}, the cookie to be removed is
   * not associated with an URI when added; if not {@code null}, the cookie to be removed is
   * associated with the given URI when added.
