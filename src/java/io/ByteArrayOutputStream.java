...
public class ByteArrayOutputStream extends OutputStream {
   ...
   * the preferred way to do this is via the <code>toString(String enc)</code> method, which takes
   * an encoding-name argument, or the <code>toString()</code> method, which uses the platform's
