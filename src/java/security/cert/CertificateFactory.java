...
public class CertificateFactory {
   ...
   *
   * @param type the name of the requested certificate type. See the CertificateFactory section in
   * the <a href= "{@docRoot}/../technotes/guides/security/StandardNames.html#CertificateFactory">
   ...
   * @throws CertificateException if no Provider supports a CertificateFactorySpi implementation for
   * the specified type.
   ...
   * the {@link Security#getProviders() Security.getProviders()} method.
   *
   * @param type the certificate type. See the CertificateFactory section in the <a href=
   * "{@docRoot}/../technotes/guides/security/StandardNames.html#CertificateFactory"> Java
   * Cryptography Architecture Standard Algorithm Name Documentation</a> for information about
   * standard certificate types.
   * @param provider the name of the provider.
   * @return a certificate factory object for the specified type.
   * @throws CertificateException if a CertificateFactorySpi implementation for the specified
