...
public class CertPathBuilder {
   ...
   *
   * @param algorithm the name of the requested {@code CertPathBuilder} algorithm.  See the
   * CertPathBuilder section in the <a href= "{@docRoot}/../technotes/guides/security/StandardNames.html#CertPathBuilder">
   * Java Cryptography Architecture Standard Algorithm Name Documentation</a> for information about
   * standard algorithm names.
   * @return a {@code CertPathBuilder} object that implements the specified algorithm.
   * @throws NoSuchAlgorithmException if no Provider supports a CertPathBuilderSpi implementation
   ...
   * @return a {@code CertPathBuilder} object that implements the specified algorithm.
   * @throws NoSuchAlgorithmException if a CertPathBuilderSpi implementation for the specified
   ...
   * to the desired type.
   *
   * @return the default {@code CertPathBuilder} type as specified by the {@code
   * certpathbuilder.type} security property, or the string {@literal "PKIX"} if no such property
   * exists.
