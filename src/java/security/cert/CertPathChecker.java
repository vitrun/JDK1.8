...
public interface CertPathChecker {
   ...
   * true}, certificates are presented from target to trust anchor (forward); if {@code false}, from
   * trust anchor to target (reverse).
   * @throws CertPathValidatorException if this {@code CertPathChecker} is unable to check
