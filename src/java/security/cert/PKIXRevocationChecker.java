 ...
 *
 * @see <a href="http://www.ietf.org/rfc/rfc2560.txt"><i>RFC&nbsp;2560: X.509 Internet Public Key
 * Infrastructure Online Certificate Status Protocol - OCSP</i></a>, <br><a
 * href="http://www.ietf.org/rfc/rfc5280.txt"><i>RFC&nbsp;5280: Internet X.509 Public Key
 * Infrastructure Certificate and Certificate Revocation List (CRL) Profile</i></a>
 * @since 1.8
 */
public abstract class PKIXRevocationChecker extends PKIXCertPathChecker {
   ...
   *
   * @param extensions a list of extensions. The list is copied to protect against subsequent
   * modification.
   */
   ...
   *
   * @return an unmodifiable list of extensions. The list is empty if no extensions have been
   * specified.
   */
   ...
   *
   * @param responses a map of OCSP responses. Each key is an {@code X509Certificate} that maps to
   * the corresponding DER-encoded OCSP response for that certificate. A deep copy of the map is
   * performed to protect against subsequent modification.
   */
   ...
   * the revocation status of the specified certificates when OCSP is used.
   *
   * @return a map of OCSP responses. Each key is an {@code X509Certificate} that maps to the
   * corresponding DER-encoded OCSP response for that certificate. A deep copy of the map is
   * returned to protect against subsequent modification. Returns an empty map if no responses have
   * been specified.
   */
   ...
   *
   * @param options a set of revocation options. The set is copied to protect against subsequent
   * modification.
   */
   ...
   *
   * @return an unmodifiable set of revocation options. The set is empty if no options have been
   * specified.
   */
   ...
   *
   * @return an unmodifiable list containing the ignored exceptions. The list is empty if no
