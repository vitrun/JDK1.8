...
public interface DomainCombiner {
   ...
   * @param assignedDomains an array of inherited ProtectionDomains. ProtectionDomains may be
   * inherited from a parent Thread, or from a privileged {@code AccessControlContext}. This
   * parameter may be {@code null} if there are no inherited ProtectionDomains.
