...
public interface Owner {
   ...
   * @throws NotOwnerException if the caller principal is not an owner of the ACL.
   */
   ...
   * @return true if the owner is removed, false if the owner is not part of the list of owners.
   * @throws NotOwnerException if the caller principal is not an owner of the ACL.
   * @throws LastOwnerException if there is only one owner left, so that deleteOwner would leave the
   * ACL owner-less.
   */
   ...
   *
   * @param owner the principal to be checked to determine whether or not it is an owner.
   * @return true if the passed principal is in the list of owners, false if not.
   */
