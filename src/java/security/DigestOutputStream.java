...
public class DigestOutputStream extends FilterOutputStream {
   ...
   * written.
   *
   * @param b the array containing the subarray to be used for updating and writing to the output
   * stream.
   * @param off the offset into {@code b} of the first byte to be updated and written.
   * @param len the number of bytes of data to be updated and written from {@code b}, starting at
   * offset {@code off}.
   * @throws IOException if an I/O error occurs.
