...
public interface ResultSet extends Wrapper, AutoCloseable {
   ...
   *
   * <P>The closing of a <code>ResultSet</code> object does <strong>not</strong> close the
   * <code>Blob</code>, <code>Clob</code> or <code>NClob</code> objects created by the
   * <code>ResultSet</code>. <code>Blob</code>, <code>Clob</code> or <code>NClob</code> objects
   * remain valid for at least the duration of the transaction in which they are created, unless
   * their <code>free</code> method is invoked. <p> When a <code>ResultSet</code> is closed, any
   * <code>ResultSetMetaData</code> instances that were created by calling the
   * <code>getMetaData</code> method remain accessible.
   *
   * <P><B>Note:</B> A <code>ResultSet</code> object is automatically closed by the
   ...
   * results. <p> Calling the method <code>close</code> on a <code>ResultSet</code> object that is
   ...
   *
   * <P>If the designated column has a datatype of CHAR or VARCHAR and contains a "0" or has a
   * datatype of BIT, TINYINT, SMALLINT, INTEGER or BIGINT and contains  a 0, a value of
   * <code>false</code> is returned.  If the designated column has a datatype of CHAR or VARCHAR and
   * contains a "1" or has a datatype of BIT, TINYINT, SMALLINT, INTEGER or BIGINT and contains  a
   * 1, a value of <code>true</code> is returned.
   *
   * @param columnIndex the first column is 1, the second is 2, ...
   * @return the column value; if the value is SQL <code>NULL</code>, the value returned is
   * <code>false</code>
   ...
   * ASCII characters; if the value is SQL <code>NULL</code>, the value returned is
   * <code>null</code>
   * @throws SQLException if the columnIndex is not valid; if a database access error occurs or this
   * method is called on a closed result set
   */
   ...
   * Unicode characters; if the value is SQL <code>NULL</code>, the value returned is
   * <code>null</code>
   * @throws SQLException if the columnIndex is not valid; if a database access error occurs or this
   * method is called on a closed result set
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this method
   ...
   * uninterpreted bytes; if the value is SQL <code>NULL</code>, the value returned is
   * <code>null</code>
   * @throws SQLException if the columnIndex is not valid; if a database access error occurs or this
   * method is called on a closed result set
   */
   ...
   * clause was not specified, then the label is the name of the column
   * @return a Java input stream that delivers the database column value as a stream of
   * uninterpreted bytes; if the value is SQL <code>NULL</code>, the result is <code>null</code>
   * @throws SQLException if the columnLabel is not valid; if a database access error occurs or this
   * method is called on a closed result set
   */
   ...
   * <code>columnLabel</code>, a database access error occurs or this method is called on a closed
   * result set
   */
   ...
   *
   * @param columnIndex the first column is 1, the second is 2, ...
   * @return a <code>java.io.Reader</code> object that contains the column value; if the value is
   ...
   * result set or the result set type is <code>TYPE_FORWARD_ONLY</code>
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this method
   * @since 1.2
   */
   ...
   * that the cursor will be positioned before the first row; a positive number indicates the row
   * number counting from the beginning of the result set; a negative number indicates the row
   * number counting from the end of the result set
   * @return <code>true</code> if the cursor is moved to a position in this <code>ResultSet</code>
   * object; <code>false</code> if the cursor is before the first row or after the last row
   * @throws SQLException if a database access error occurs; this method is called on a closed
   * result set or the result set type is <code>TYPE_FORWARD_ONLY</code>
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this method
   * @since 1.2
   ...
   * positive number moves the cursor forward; a negative number moves the cursor backward
   ...
   * @throws SQLException if a database access error occurs; this method is called on a closed
   * result set or the result set type is <code>TYPE_FORWARD_ONLY</code> and the fetch direction is
   ...
   *
   * @return <code>ResultSet.TYPE_FORWARD_ONLY</code>, <code>ResultSet.TYPE_SCROLL_INSENSITIVE</code>,
   ...
   * not the result set can detect updates. <p> <strong>Note:</strong> Support for the
   * <code>rowUpdated</code> method is optional with a result set concurrency of
   * <code>CONCUR_READ_ONLY</code>
   *
   * @return <code>true</code> if the current row is detected to have been visibly updated by the
   * owner or another; <code>false</code> otherwise
   * @throws SQLException if a database access error occurs or this method is called on a closed
   * result set
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this method
   ...
   * or not this <code>ResultSet</code> object can detect visible inserts. <p>
   * <strong>Note:</strong> Support for the <code>rowInserted</code> method is optional with a
   * result set concurrency of <code>CONCUR_READ_ONLY</code>
   *
   * @return <code>true</code> if the current row is detected to have been inserted;
   * <code>false</code> otherwise
   * @throws SQLException if a database access error occurs or this method is called on a closed
   * result set
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this method
   ...
   * whether or not this <code>ResultSet</code> object can detect deletions. <p>
   * <strong>Note:</strong> Support for the <code>rowDeleted</code> method is optional with a result
   * set concurrency of <code>CONCUR_READ_ONLY</code>
   *
   * @return <code>true</code> if the current row is detected to have been deleted by the owner or
   ...
   *
   * @param columnIndex the first column is 1, the second is 2, ...
   * @throws SQLException if the columnIndex is not valid; if a database access error occurs; the
   * result set concurrency is <code>CONCUR_READ_ONLY</code> or this method is called on a closed
   * result set
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this method
   * @since 1.2
   */
   ...
   * @param columnIndex the first column is 1, the second is 2, ...
   * @param x the new column value
   * @param scaleOrLength for an object of <code>java.math.BigDecimal</code> , this is the number of
   * digits after the decimal point. For Java Object types <code>InputStream</code> and
   * <code>Reader</code>, this is the length of the data in the stream or reader.  For all other
   ...
   * @param columnLabel the label for the column specified with the SQL AS clause.  If the SQL AS
   * clause was not specified, then the label is the name of the column
   * @throws SQLException if the columnLabel is not valid; if a database access error occurs; the
   * result set concurrency is <code>CONCUR_READ_ONLY</code> or this method is called on a closed
   * result set
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this method
   * @since 1.2
   ...
   *
   * @throws SQLException if a database access error occurs; the result set concurrency is
   * <code>CONCUR_READ_ONLY</code>, this method is called on a closed result set, if this method is
   * called when the cursor is not on the insert row, or if not all of non-nullable columns in the
   ...
   *
   * @throws SQLException if a database access error occurs; the result set concurrency is
   * <code>CONCUR_READ_ONLY</code>; this method is called on a closed result set or if this method
   ...
   *
   * @throws SQLException if a database access error occurs; this method is called on a closed
   * result set; the result set type is <code>TYPE_FORWARD_ONLY</code> or if this method is called
   ...
   *
   * @throws SQLException if a database access error occurs; this method is called on a closed
   * result set; the result set concurrency is <code>CONCUR_READ_ONLY</code> or if this method is
   ...
   *
   * @throws SQLException if a database access error occurs; this method is called on a closed
   * result set or the result set concurrency is <code>CONCUR_READ_ONLY</code>
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this method
   * @since 1.2
   */
   ...
   * <code>null</code>.
   *
   * @return the <code>Statement</code> object that produced this <code>ResultSet</code> object or
   ...
   *
   * @param columnIndex the first column is 1, the second is 2, ...
   * @param map a <code>java.util.Map</code> object that contains the mapping from SQL type names to
   ...
   *
   * @param columnIndex the first column is 1, the second is 2, ...
   * @return a <code>Blob</code> object representing the SQL <code>BLOB</code> value in the
   * specified column
   * @throws SQLException if the columnIndex is not valid; if a database access error occurs or this
   * method is called on a closed result set
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this method
   ...
   *
   * @param columnIndex the first column is 1, the second is 2, ...
   * @return a <code>Clob</code> object representing the SQL <code>CLOB</code> value in the
   * specified column
   * @throws SQLException if the columnIndex is not valid; if a database access error occurs or this
   * method is called on a closed result set
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this method
   ...
   *
   * @param columnIndex the first column is 1, the second is 2, ...
   * @return an <code>Array</code> object representing the SQL <code>ARRAY</code> value in the
   * specified column
   * @throws SQLException if the columnIndex is not valid; if a database access error occurs or this
   * method is called on a closed result set
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this method
   ...
   * @param columnLabel the label for the column specified with the SQL AS clause.  If the SQL AS
   * clause was not specified, then the label is the name of the column
   * @return a <code>Ref</code> object representing the SQL <code>REF</code> value in the specified
   * column
   * @throws SQLException if the columnLabel is not valid; if a database access error occurs or this
   * method is called on a closed result set
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this method
   ...
   * <code>NULL</code>, the value returned is <code>null</code> in the Java programming language
   * @throws SQLException if the columnIndex is not valid; if a database access error occurs; this
   * method is called on a closed result set or if a URL is malformed
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this method
   * @since 1.4
   */
   ...
   * @return the column value as a <code>java.net.URL</code> object; if the value is SQL
   * <code>NULL</code>, the value returned is <code>null</code> in the Java programming language
   * @throws SQLException if the columnLabel is not valid; if a database access error occurs; this
   * method is called on a closed result set or if a URL is malformed
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this method
   * @since 1.4
   */
   ...
   * @return the column value; if the value is a SQL <code>NULL</code> the value returned is
   * <code>null</code>
   * @throws SQLException if the columnIndex is not valid; if a database access error occurs or this
   * method is called on a closed result set
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this method
  ...
  /**
   * Retrieves whether this <code>ResultSet</code> object has been closed. A <code>ResultSet</code>
   ...
   * @throws SQLException if the columnIndex is not valid; if the driver does not support national
   * character sets;  if the driver can detect that a data conversion error could occur; this method
   * is called on a closed result set; the result set concurrency is <code>CONCUR_READ_ONLY</code>
   ...
   * @throws SQLException if the columnIndex is not valid; if the driver does not support national
   * character sets;  if the driver can detect that a data conversion error could occur; this method
   * is called on a closed result set; if a database access error occurs or the result set
   ...
   *
   * @param columnIndex the first column is 1, the second is 2, ...
   * @return a <code>NClob</code> object representing the SQL <code>NCLOB</code> value in the
   * specified column
   * @throws SQLException if the columnIndex is not valid; if the driver does not support national
   * character sets;  if the driver can detect that a data conversion error could occur; this method
   * is called on a closed result set or if a database access error occurs
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this method
   * @since 1.6
   */
   ...
   * @throws SQLException if the columnIndex is not valid; if a database access error occurs; this
   * method is called on a closed result set; the <code>java.xml.transform.Result</code>,
   * <code>Writer</code> or <code>OutputStream</code> has not been closed for the
   * <code>SQLXML</code> object; if there is an error processing the XML value or the result set
   * concurrency is <code>CONCUR_READ_ONLY</code>.  The <code>getCause</code> method of the
   * exception may provide a more detailed exception, for example, if the stream does not contain
   * valid XML.
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this method
   * @since 1.6
   */
  ...
  /**
   * Updates the designated column using the given input stream. The data will be read from the
   * stream as needed until end-of-stream is reached. <p> The updater methods are used to update
   * column values in the current row or the insert row.  The updater methods do not update the
   * underlying database; instead the <code>updateRow</code> or <code>insertRow</code> methods are
   * called to update the database.
   *
   * <P><B>Note:</B> Consult your JDBC driver documentation to determine if it might be more
   * efficient to use a version of <code>updateBlob</code> which takes a length parameter.
   *
   * @param columnIndex the first column is 1, the second is 2, ...
   * @param inputStream An object that contains the data to set the parameter value to.
   * @throws SQLException if the columnIndex is not valid; if a database access error occurs; the
   ...
   * @param scaleOrLength for an object of {@code java.math.BigDecimal} , this is the number of
   * digits after the decimal point. For Java Object types {@code InputStream} and {@code Reader},
   * this is the length of the data in the stream or reader.  For all other types, this value will
   * be ignored.
   * @throws SQLException if the columnIndex is not valid; if a database access error occurs; the
   * result set concurrency is {@code CONCUR_READ_ONLY} or this method is called on a closed result
   * set
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this method; if the
