...
public class Date extends java.util.Date {
   ...
   *
   * @param date milliseconds since January 1, 1970, 00:00:00 GMT not to exceed the milliseconds
   * representation for the year 8099. A negative number indicates the number of milliseconds before
   ...
   *
   * @param s a <code>String</code> object representing a date in in the format "yyyy-[m]m-[d]d".
   ...
   * @throws IllegalArgumentException if the date given is not in the JDBC date escape format
   * (yyyy-[m]m-[d]d)
   */
