...
public interface Blob {
   ...
   * <code>BLOB</code> value designated by this <code>Blob</code> object, starting with the byte at
   ...
   * @throws SQLException if there is an error accessing the <code>BLOB</code> or if start is less
   * than 1
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this method
   * @since 1.2
   */
   ...
   * @throws SQLException if there is an error accessing the <code>BLOB</code> value or if start is
   * less than 1
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this method
   * @since 1.2
   */
