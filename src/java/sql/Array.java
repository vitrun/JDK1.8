...
public interface Array {
   ...
   *
   * @return a <code>String</code> that is the database-specific name for a built-in base type; or
   ...
   *
   * @return a constant from the class {@link java.sql.Types} that is the type code for the elements
   * in the array designated by this <code>Array</code> object
   ...
   *
   * @return an array in the Java programming language that contains the ordered elements of the SQL
   ...
   * that primitive data type or an array of <code>Object</code>.
   *
   * @param map a <code>java.util.Map</code> object that contains mappings of SQL type names to
   ...
   * @return an array containing up to <code>count</code> consecutive elements of the SQL array,
   * beginning with element <code>index</code>
   * @throws SQLException if an error occurs while attempting to access the array
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this method
   * @since 1.2
   */
   ...
   * @param index the array index of the first element to retrieve; the first element is at index 1
   * @param count the number of successive SQL array elements to retrieve
   * @param map a <code>java.util.Map</code> object that contains SQL type names and the classes in
   * the Java programming language to which they are mapped
   * @return an array containing up to <code>count</code> consecutive elements of the SQL
   * <code>ARRAY</code> value designated by this <code>Array</code> object, beginning with element
   * <code>index</code>
   * @throws SQLException if an error occurs while attempting to access the array
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this method
   * @since 1.2
   ...
   *
   * @return a {@link ResultSet} object containing one row for each of the elements in the array
   * designated by this <code>Array</code> object, with the rows in ascending order based on the
   * indices.
   * @throws SQLException if an error occurs while attempting to access the array
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this method
   * @since 1.2
   ...
   * the order of the indices.
   *
   * @param map contains the mapping of SQL user-defined types to classes in the Java programming
   * language
   * @return a <code>ResultSet</code> object containing one row for each of the elements in the
   * array designated by this <code>Array</code> object, with the rows in ascending order based on
   * the indices.
   * @throws SQLException if an error occurs while attempting to access the array
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this method
   * @since 1.2
   ...
   * @param index the array index of the first element to retrieve; the first element is at index 1
   * @param count the number of successive SQL array elements to retrieve
   * @return a <code>ResultSet</code> object containing up to <code>count</code> consecutive
   * elements of the SQL array designated by this <code>Array</code> object, starting at index
   * <code>index</code>.
   * @throws SQLException if an error occurs while attempting to access the array
   * @throws SQLFeatureNotSupportedException if the JDBC driver does not support this method
   * @since 1.2
   ...
   * @param index the array index of the first element to retrieve; the first element is at index 1
   * @param count the number of successive SQL array elements to retrieve
   * @param map the <code>Map</code> object that contains the mapping of SQL type names to classes
