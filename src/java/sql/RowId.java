...
public interface RowId {
   ...
   *
   * @return an array of bytes, whose length is determined by the driver supplying the connection,
   * representing the value of the ROWID designated by this java.sql.RowId object.
   */
  byte[] getBytes();
   ...
   *
   * @return a String whose format is determined by the driver supplying the connection,
   * representing the value of the <code>ROWID</code> designated by this <code>java.sql.RowId</code>
   * object.
   */
  String toString();
