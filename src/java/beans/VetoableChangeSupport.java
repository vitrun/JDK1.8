...
public class VetoableChangeSupport implements Serializable {
   ...
   * }</pre>
   *
   * @return all of the <code>VetoableChangeListeners</code> added or an empty array if no listeners
   * have been added
  ...
  /**
   * @serialData Null terminated list of <code>VetoableChangeListeners</code>. <p> At serialization
   * time we skip non-serializable listeners and only serialize the serializable listeners.
   */
