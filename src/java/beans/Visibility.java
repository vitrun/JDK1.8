...
public interface Visibility {
   ...
   *
   * @return True if the bean absolutely needs a GUI available in order to get its work done.
   */
  boolean needsGui();
   ...
   *
   * @return true if the bean is currently avoiding use of the Gui. e.g. due to a call on
   * dontUseGui().
   */
  boolean avoidingGui();
