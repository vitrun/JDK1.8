...
public class PropertyChangeSupport implements Serializable {
   ...
   * no such listeners have been added, or if <code>propertyName</code> is null, an empty array is
   * returned.
   * @since 1.4
   */
  ...
  /**
   * @serialData Null terminated list of <code>PropertyChangeListeners</code>. <p> At serialization
