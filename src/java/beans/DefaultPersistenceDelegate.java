...
public class DefaultPersistenceDelegate extends PersistenceDelegate {
  ...
  public DefaultPersistenceDelegate(String[] constructorPropertyNames) {
    this.constructor =
        (constructorPropertyNames == null) ? EMPTY : constructorPropertyNames.clone();
  }
   ...
   * @return True if an equivalent copy of <code>newInstance</code> may be created by applying a
   * series of mutations to <code>oldInstance</code>.
   * @see #DefaultPersistenceDelegate(String[])
   */
   ...
   * @throws NullPointerException if {@code out} is {@code null} and this value is used in the
   * method
   * @see #DefaultPersistenceDelegate(String[])
   */
