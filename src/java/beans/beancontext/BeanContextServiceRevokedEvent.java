...
public class BeanContextServiceRevokedEvent extends BeanContextEvent {
   ...
   *
   * @param bcs the <code>BeanContextServices</code> from which this service is being revoked
   ...
   *
   * @return the <code>BeanContextServices</code> from which this service is being revoked
   */
   ...
   *
   * @return A <code>Class</code> reference to the service that is being revoked
   */
   ...
   * @return <code>true</code> if the service being revoked is of the same class as the specified
   * service
   */
