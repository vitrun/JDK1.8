...
public class DropTargetDragEvent extends DropTargetEvent {
   ...
   * @param cursorLocn The location of the "Drag" Cursor's hotspot in Component coordinates
   ...
   * <P>
   *
   * @param df the <code>DataFlavor</code> to test <P>
   ...
   * @throws InvalidDnDOperationException if the data associated with the drag operation is not
   * available
   * @since 1.5
   */
