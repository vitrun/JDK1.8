...
public final class PageAttributes implements Cloneable {
   ...
   * @param printQuality PrintQualityType.DRAFT, PrintQualityType.NORMAL, or PrintQualityType.HIGH
   * @param printerResolution an integer array of 3 elements. The first element must be greater than
   * 0. The second element must be must be greater than 0. The third element must be either
   ...
   * attribute is updated to the value chosen by the user.
   *
   * @return OrientationRequestedType.PORTRAIT or OrientationRequestedType.LANDSCAPE.
   */
   ...
   * @throws IllegalArgumentException if orientationRequested is not <code>3</code> or
   * <code>4</code>
   */
   ...
   * attribute is updated to the value chosen by the user.
   *
   * @return PrintQualityType.DRAFT, PrintQualityType.NORMAL, or PrintQualityType.HIGH
   */
   ...
   * @throws IllegalArgumentException if printQuality is not <code>3 </code>, <code>4</code>, or
   * <code>5</code>
   */
   ...
   *
   * @return an integer array of 3 elements. The first element must be greater than 0. The second
   * element must be must be greater than 0. The third element must be either <code>3</code> or
   * <code>4</code>.
   */
   ...
   * @throws IllegalArgumentException if printerResolution is less than or equal to 0.
   */
  public void setPrinterResolution(int printerResolution) {
   ...
   * @return whether obj is equal to this PageAttribute according to the above criteria.
   */
