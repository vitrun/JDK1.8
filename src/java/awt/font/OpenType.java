...
/**
 * The <code>OpenType</code> interface represents OpenType and TrueType fonts.  This interface makes
 * it possible to obtain <i>sfnt</i> tables from the font.  A particular <code>Font</code> object
 * can implement this interface. <p> For more information on TrueType and OpenType fonts, see the
 * OpenType specification. ( <a href="http://www.microsoft.com/typography/otspec/">http://www.microsoft.com/typography/otspec/</a>
 * ).
 */
public interface OpenType {
   ...
   * @return a <code>byte</code> array that is the table that contains the font data corresponding
   ...
   *
   * @param strSfntTag a four-character code as a <code>String</code>
   * @return a <code>byte</code> array that is the table that contains the font data corresponding
   * to the specified tag.
   */
   ...
   * @return a subset of the table corresponding to <code>sfntTag</code> and containing the bytes
   * starting at <code>offset</code> byte and including <code>count</code> bytes.
   */
   ...
   * @param offset index of first byte to return from table
   * @param count number of bytes to return from table
   * @return a subset of the table corresponding to <code>strSfntTag</code> and containing the bytes
   * starting at <code>offset</code> byte and including <code>count</code> bytes.
   */
