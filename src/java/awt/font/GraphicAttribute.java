...
public abstract class GraphicAttribute {
   ...
   *
   * @param alignment an int representing one of the <code>GraphicAttribute</code> alignment fields
   * @throws IllegalArgumentException if alignment is not one of the five defined values.
   */
   ...
   * <code>GraphicAttribute</code>. This can be null.
   * @return a <code>Shape</code> representing this graphic attribute, suitable for stroking or
   * filling.
   * @since 1.6
   */
   ...
   * location.
   *
   * @param graphics the {@link Graphics2D} into which to render the graphic
   ...
   * information.
   *
   * @return a {@link GlyphJustificationInfo} object that contains the justification information for
   * this <code>GraphicAttribute</code>.
   */
