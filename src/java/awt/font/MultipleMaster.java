...
public interface MultipleMaster {
   ...
   * @return a {@link Font} object that is an instance of <code>MultipleMaster</code> and is based
   * on the design axis values provided by <code>axes</code>.
   */
   ...
   *
   * @param glyphWidths an array of floats representing the desired width of each glyph in font
   * space
   * @param avgStemWidth the average stem width for the overall font in font space
   ...
   * @param italicAngle the angle at which the italics lean, in degrees counterclockwise from
   * vertical
   * @return a <code>Font</code> object that is an instance of <code>MultipleMaster</code> and is
   * based on the specified metric information.
   */
