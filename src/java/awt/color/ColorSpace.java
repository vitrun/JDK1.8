...
public abstract class ColorSpace implements java.io.Serializable {
   ...
   *
   * @param colorspace a specific color space identified by one of the predefined class constants
   ...
   *
   * @return <CODE>true</CODE> if this is a <CODE>CS_sRGB</CODE> color space, <code>false</code> if
   * it is not
   */
   ...
   * <p>
   *
   * @param colorvalue a float array with length of at least the number of components in this
   * ColorSpace
   * @return a float array of length 3
   * @throws ArrayIndexOutOfBoundsException if array length is not at least the number of components
   * in this ColorSpace
   */
   ...
   * primaries.
   *
   * @return the type constant that represents the type of this <CODE>ColorSpace</CODE>
   */
  public int getType() {
    return type;
  }
   ...
   * @throws IllegalArgumentException if <code>idx</code> is less than 0 or greater than
   * numComponents - 1
   */
