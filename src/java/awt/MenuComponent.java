...
public abstract class MenuComponent implements java.io.Serializable {
   ...
   *
   * @return the menu component containing this menu component, or <code>null</code> if this menu
   ...
   * @deprecated As of JDK version 1.1, replaced by {@link #dispatchEvent(AWTEvent) dispatchEvent}.
   */
  @Deprecated
   ...
   *
   * @return the <code>AccessibleContext</code> of this <code>MenuComponent</code>
   * @since 1.3
   */
  ...
  protected abstract class AccessibleAWTMenuComponent
     ...
     *
     * @return <code>AccessibleSelection</code> if supported by object; else return
     * <code>null</code>
     ...
     *
     * @return the index of this object in its parent; -1 if this object does not have an accessible
     * parent
     ...
     * @return the FontMetrics, if supported, the object; otherwise, <code>null</code>
     * @see #getFont
     */
     ...
     * bounds in the coordinate space of the screen; <code>null</code> if this object or its parent
     ...
     * Resizes this object.
     *
     * @param d - the <code>Dimension</code> specifying the new size of the object
     */
   ...
   * Gets the index of this object in its accessible parent.
   *
   * @return -1 if this object does not have an accessible parent; otherwise, the index of the child
