...
public class ShortLookupTable extends LookupTable {
   ...
   * @param data an array of short arrays representing a lookup table for each band
   */
   ...
   * if for any element <code>i</code> of <code>src</code>, {@code (src[i]&0xffff)-offset} is either
