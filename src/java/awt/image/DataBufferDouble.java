...
public final class DataBufferDouble extends DataBuffer {
   ...
   *
   * @param dataArray An array of <code>double</code>s to be used as the first and only bank of this
   ...
   * an associated image in video memory).
   *
   * @param dataArray An array of arrays of <code>double</code>s to be used as the banks of this
   * <code>DataBuffer</code>.
