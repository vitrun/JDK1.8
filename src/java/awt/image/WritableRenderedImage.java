...
public interface WritableRenderedImage extends RenderedImage {
   ...
   * @param tileX the X index of the tile.
   * @param tileY the Y index of the tile.
   * @return <code>true</code> if specified tile is checked out for writing; <code>false</code>
   * otherwise.
   */
   ...
   *
   * @return <code>true</code> if any tiles are checked out for writing; <code>false</code>
   * otherwise.
   */
