...
public class ImageCapabilities implements Cloneable {
   ...
   * accelerated.
   *
   * @return whether or not an image can be, or is, accelerated.  There are various
   * platform-specific ways to accelerate an image, including pixmaps, VRAM, AGP.  This is the
   * general acceleration method (as opposed to residing in system memory).
   */
   ...
   * its surfaces.
   *
   * @return whether or not a volatile image is subject to losing its surfaces at the whim of the
   * operating system.
   */
