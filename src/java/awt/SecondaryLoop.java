...
public interface SecondaryLoop {
   ...
   *
   * @return {@code true} after termination of the secondary loop, if the secondary loop was started
   * by this call, {@code false} otherwise
   */
   ...
   *
   * @return {@code true} if this loop was previously started and has not yet been finished with the
   * {@link #exit} method, {@code false} otherwise
   */
  public boolean exit();
