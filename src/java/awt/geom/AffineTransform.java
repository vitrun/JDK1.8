...
public class AffineTransform implements Cloneable, java.io.Serializable {
   ...
   * <code>AffineTransform</code> object. The length of the array is assumed to be at least 4. If
   * the length of the array is less than 6, only the first 4 values are taken. If the length of the
   ...
   * <code>ptSrc</code>
   * @return the <code>ptDst</code> after transforming <code>ptSrc</code> and storing the result in
   * <code>ptDst</code>.
   * @since 1.2
   */
