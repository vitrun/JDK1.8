...
public class MouseWheelEvent extends MouseEvent {
   ...
   * @param modifiers the modifier keys down during event (shift, ctrl, alt, meta)
   * @param x the horizontal <code>x</code> coordinate for the mouse location
   * @param y the vertical <code>y</code> coordinate for the mouse location
   * @param xAbs the absolute horizontal <code>x</code> coordinate for the mouse location
   * @param yAbs the absolute vertical <code>y</code> coordinate for the mouse location
   * @param clickCount the number of mouse clicks associated with the event
   * @param popupTrigger a boolean value, <code>true</code> if this event is a trigger for a
   * popup-menu
   * @param scrollType the type of scrolling which should take place in response to this event;
   * valid values are <code>WHEEL_UNIT_SCROLL</code> and <code>WHEEL_BLOCK_SCROLL</code>
   * @param scrollAmount for scrollType <code>WHEEL_UNIT_SCROLL</code>, the number of units to be
   * scrolled
   * @param wheelRotation the integer number of "clicks" by which the mouse wheel was rotated
   * @param preciseWheelRotation the double number of "clicks" by which the mouse wheel was rotated
   * @throws IllegalArgumentException if <code>source</code> is null
   * @see MouseEvent#MouseEvent(java.awt.Component, int, long, int, int, int, int, boolean)
   * @see MouseEvent#MouseEvent(java.awt.Component, int, long, int, int, int, int, int, int,
   * boolean, int)
   ...
   * </ul>
   *
   * @return either MouseWheelEvent.WHEEL_UNIT_SCROLL or MouseWheelEvent.WHEEL_BLOCK_SCROLL,
   ...
   *
   * @return number of units to scroll, or an undefined value if <code>getScrollType</code> returns
   ...
   *
   * @return negative values if the mouse wheel was rotated up or away from the user, and positive
   ...
   * </pre>
   *
   * @return the number of units to scroll based on the direction and amount of mouse wheel
