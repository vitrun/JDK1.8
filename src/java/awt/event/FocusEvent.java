...
public class FocusEvent extends ComponentEvent {
   ...
   * @param temporary Equals <code>true</code> if the focus change is temporary; <code>false</code>
   * otherwise
   * @param opposite The other Component involved in the focus change, or <code>null</code>
   ...
   *
   * @return <code>true</code> if the focus change is temporary; <code>false</code> otherwise
   */
