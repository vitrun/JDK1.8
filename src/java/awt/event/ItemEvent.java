...
public class ItemEvent extends AWTEvent {
   ...
   * @param stateChange An integer that indicates whether the item was selected or deselected. For
   * information on allowable values, see the class description for {@link ItemEvent}
   ...
   *
   * @return an integer that indicates whether the item was selected or deselected
   * @see #SELECTED
   * @see #DESELECTED
   */
