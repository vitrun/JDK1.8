...
public class WindowEvent extends ComponentEvent {
   ...
   * @param opposite The other window involved in the focus or activation change, or
   * <code>null</code>
   * @param oldState Previous state of the window for window state change event. See {@code
   * #getOldState()} for allowable values
   * @param newState New state of the window for window state change event. See {@code
   ...
   * @param source The <code>Window</code> object that originated the event
   * @param id An integer indicating the type of event. For information on allowable values, see the
   * class description for {@link WindowEvent}. It is expected that this constructor will not be
   * used for other then {@code WINDOW_ACTIVATED},{@code WINDOW_DEACTIVATED}, {@code
   * WINDOW_GAINED_FOCUS}, or {@code WINDOW_LOST_FOCUS}. {@code WindowEvent} types, because the
   * opposite <code>Window</code> of other event types will always be {@code null}.
   * @param opposite The other <code>Window</code> involved in the focus or activation change, or
   * <code>null</code>
   * @throws IllegalArgumentException if <code>source</code> is null
   * @see #getWindow()
   * @see #getID()
   ...
   * @param id An integer indicating the type of event. For information on allowable values, see the
   * class description for {@link WindowEvent}. It is expected that this constructor will not be
   * used for other then {@code WINDOW_STATE_CHANGED} {@code WindowEvent} types, because the
   * previous and new window states are meaningless for other event types.
   * @param oldState An integer representing the previous window state. See {@code #getOldState()}
   * for allowable values
   * @param newState An integer representing the new window state. See {@code #getNewState()} for
   * allowable values
   * @throws IllegalArgumentException if <code>source</code> is null
   * @see #getWindow()
   * @see #getID()
