...
public class Menu extends MenuItem implements MenuContainer, Accessible {
   ...
   * a tear-off menu.
   *
   * @param label the menu's label in the menu bar, or in another menu of which this menu is a
   * submenu.
   * @throws HeadlessException if GraphicsEnvironment.isHeadless() returns true.
   * @see java.awt.GraphicsEnvironment#isHeadless
   */
   ...
   * support tear-off menus, this value is silently ignored.
   *
   * @return <code>true</code> if this is a tear-off menu; <code>false</code> otherwise.
   */
   ...
   * @throws IllegalArgumentException if the value of <code>index</code> is less than zero
   ...
   * @throws IllegalArgumentException if the value of <code>index</code> is less than 0.
   ...
   *
   * @param item the item to be removed from the menu. If <code>item</code> is <code>null</code> or
   * is not in this menu, this method does nothing.
   */
...
////////////////
   ...
   *
   * @return an AccessibleAWTMenu that serves as the AccessibleContext of this Menu
   * @since 1.3
   */
